# Simplic.OxS.SDK.Organization.InternalOrganizationSDK

All URIs are relative to *https://dev-oxs.simplic.io/organization-api/v1*

| Method | HTTP request | Description |
|--------|--------------|-------------|
| [**InternalInternalOrganizationGetAllGet**](InternalOrganizationSDK.md#internalinternalorganizationgetallget) | **GET** /internal/InternalOrganization/get-all | Gets a list of organizations that belongs to the current user |
...
namespace Example
{
    public class InternalInternalOrganizationGetAllGetExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new InternalOrganizationSDK(config);
            ...
            {
                Debug.Print("Exception when calling InternalOrganizationSDK.InternalInternalOrganizationGetAllGet: " + e.Message);
...
{
    Debug.Print("Exception when calling InternalOrganizationSDK.InternalInternalOrganizationGetAllGetWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
