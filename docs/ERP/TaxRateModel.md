# Simplic.OxS.SDK.ERP.TaxRateModel
...
**UpdateDateTime** | **DateTime** | Gets or sets the date and time the tax rate is updated. | [optional] 
**UpdateUserId** | **Guid?** | Gets or sets the id of the user that updated the tax rate. | [optional] 
**UpdateUserName** | **string** | Gets or sets the name of the user that updated the tax rate. | [optional] 
