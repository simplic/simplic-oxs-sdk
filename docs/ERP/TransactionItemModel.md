...
**ValueOperator** | **ValueOperatorModel** |  | [optional] 
**AssignmentMode** | **AssignmentModeModel** |  | [optional] 
...
**TaxKey** | [**TaxKeyModel**](TaxKeyModel.md) |  | [optional] 
**CostCenters** | [**List&lt;CostCenterAssignmentModel&gt;**](CostCenterAssignmentModel.md) | Gets or sets the assigned cost centers with their respective percentages. | [optional] 
**CostObjects** | [**List&lt;CostCenterAssignmentModel&gt;**](CostCenterAssignmentModel.md) | Gets or sets the assigned cost objects with their respective percentages. | [optional] 
...
**GeneralLedgerAccount** | [**TransactionGeneralLedgerAccountModel**](TransactionGeneralLedgerAccountModel.md) |  | [optional] 
**BillingLine** | [**TransactionBillingLineModel**](TransactionBillingLineModel.md) |  | [optional] 
