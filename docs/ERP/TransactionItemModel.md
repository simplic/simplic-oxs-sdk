...
**CostCenters** | **Dictionary&lt;string, double&gt;** | Gets or sets the assigned cost centers with their respective percentages. | [optional] 
**CostObjects** | **Dictionary&lt;string, double&gt;** | Gets or sets the assigned cost objects with their respective percentages. | [optional] 
