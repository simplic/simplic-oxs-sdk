...
**CostCenters** | [**List&lt;ValidateItemCostCenterAssignmentRequest&gt;**](ValidateItemCostCenterAssignmentRequest.md) | Gets or sets the assigned cost centers given by ID with their respective percentages. | [optional] 
**CostObjects** | [**List&lt;ValidateItemCostCenterAssignmentRequest&gt;**](ValidateItemCostCenterAssignmentRequest.md) | Gets or sets the assigned cost objects given by ID with their respective percentages. | [optional] 
