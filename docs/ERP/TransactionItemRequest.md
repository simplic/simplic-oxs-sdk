...
**CostCenters** | [**List&lt;CostCenterAssignmentRequest&gt;**](CostCenterAssignmentRequest.md) | Gets or sets the assigned cost centers given by ID with their respective percentages. | [optional] 
**CostObjects** | [**List&lt;CostCenterAssignmentRequest&gt;**](CostCenterAssignmentRequest.md) | Gets or sets the assigned cost objects given by ID with their respective percentages. | [optional] 
