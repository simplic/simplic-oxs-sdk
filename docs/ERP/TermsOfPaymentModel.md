# Simplic.OxS.SDK.ERP.TermsOfPaymentModel
...
**CreateUserName** | **string** | Gets or sets the name of the user that created the terms of payment. | [optional] 
**UpdateDateTime** | **DateTime** | Gets or sets the date and time the terms of payment is updated. | [optional] 
**UpdateUserId** | **Guid?** | Gets or sets the id of the user that updated the terms of payment. | [optional] 
**UpdateUserName** | **string** | Gets or sets the name of the user that updated the terms of payment. | [optional] 
