# Simplic.OxS.SDK.ERP.TransactionTransactionSubtypeModel
...
**Code** | **string** | Gets or sets the code used to identify default transaction subtype documents. | [optional] 
