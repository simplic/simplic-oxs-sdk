# Simplic.OxS.SDK.Contact.ContactSDK

All URIs are relative to *https://dev-oxs.simplic.io/contact-api/v1*

| Method | HTTP request | Description |
|--------|--------------|-------------|
| [**ContactIdDelete**](ContactSDK.md#contactiddelete) | **DELETE** /Contact/{id} |  |
| [**ContactIdGet**](ContactSDK.md#contactidget) | **GET** /Contact/{id} |  |
| [**ContactIdPut**](ContactSDK.md#contactidput) | **PUT** /Contact/{id} |  |
| [**ContactPost**](ContactSDK.md#contactpost) | **POST** /Contact |  |
| [**ContactSearchGet**](ContactSDK.md#contactsearchget) | **GET** /Contact/search |  |
...
namespace Example
{
    public class ContactIdDeleteExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new ContactSDK(config);
            ...
            {
                Debug.Print("Exception when calling ContactSDK.ContactIdDelete: " + e.Message);
...
{
    Debug.Print("Exception when calling ContactSDK.ContactIdDeleteWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class ContactIdGetExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling ContactSDK.ContactIdGet: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling ContactSDK.ContactIdGetWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class ContactIdPutExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling ContactSDK.ContactIdPut: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling ContactSDK.ContactIdPutWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class ContactPostExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling ContactSDK.ContactPost: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling ContactSDK.ContactPostWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class ContactSearchGetExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling ContactSDK.ContactSearchGet: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling ContactSDK.ContactSearchGetWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
