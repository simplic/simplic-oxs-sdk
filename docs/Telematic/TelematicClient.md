...
|--------|--------------|-------------|
| [**AllCurrentWorkingTimes**](TelematicClient.md#telematicallcurrentworkingtimesget) | **GET** /Telematic/all-current-working-times |  |
...
| [**WorkingTimes**](TelematicClient.md#telematicworkingtimesget) | **GET** /Telematic/working-times |  |

<a id="telematicallcurrentworkingtimesget"></a>
# **AllCurrentWorkingTimes**
> List&lt;DtcoWorkingTimeResponse&gt; AllCurrentWorkingTimes ()
...
namespace Example
{
    public class AllCurrentWorkingTimesExample
    {
        public static void Main()
        {
            ...
            try
            {
                List<DtcoWorkingTimeResponse> result = apiInstance.AllCurrentWorkingTimes();
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling TelematicClient.AllCurrentWorkingTimes: " + e.Message);
...
#### Using the AllCurrentWorkingTimesWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.

```csharp
try
{
    ApiResponse<List<DtcoWorkingTimeResponse>> response = apiInstance.AllCurrentWorkingTimesWithHttpInfo();
...
{
    Debug.Print("Exception when calling TelematicClient.AllCurrentWorkingTimesWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="telematiccreatedtcoreadjobpost"></a>
# **CreateDtcoReadJob**
> void CreateDtcoReadJob (CreateDtcoReadJobRequest? createDtcoReadJobRequest = null)
...
namespace Example
{
    public class CreateDtcoReadJobExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            var apiInstance = new TelematicClient(config);
            var createDtcoReadJobRequest = new CreateDtcoReadJobRequest?(); // CreateDtcoReadJobRequest? |  (optional) 

            try
            {
                apiInstance.CreateDtcoReadJob(createDtcoReadJobRequest);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling TelematicClient.CreateDtcoReadJob: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the CreateDtcoReadJobWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.

```csharp
try
{
    apiInstance.CreateDtcoReadJobWithHttpInfo(createDtcoReadJobRequest);
}
catch (ApiException e)
{
    Debug.Print("Exception when calling TelematicClient.CreateDtcoReadJobWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
| Name | Type | Description | Notes |
|------|------|-------------|-------|
| **createDtcoReadJobRequest** | [**CreateDtcoReadJobRequest?**](CreateDtcoReadJobRequest?.md) |  | [optional]  |
...
<a id="telematicdeletedtcoreadjobdelete"></a>
# **DeleteDtcoReadJob**
> void DeleteDtcoReadJob (DeleteDtcoReadJobRequest? deleteDtcoReadJobRequest = null)
...
namespace Example
{
    public class DeleteDtcoReadJobExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            var apiInstance = new TelematicClient(config);
            var deleteDtcoReadJobRequest = new DeleteDtcoReadJobRequest?(); // DeleteDtcoReadJobRequest? |  (optional) 

            try
            {
                apiInstance.DeleteDtcoReadJob(deleteDtcoReadJobRequest);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling TelematicClient.DeleteDtcoReadJob: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the DeleteDtcoReadJobWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.

```csharp
try
{
    apiInstance.DeleteDtcoReadJobWithHttpInfo(deleteDtcoReadJobRequest);
}
catch (ApiException e)
{
    Debug.Print("Exception when calling TelematicClient.DeleteDtcoReadJobWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
| Name | Type | Description | Notes |
|------|------|-------------|-------|
| **deleteDtcoReadJobRequest** | [**DeleteDtcoReadJobRequest?**](DeleteDtcoReadJobRequest?.md) |  | [optional]  |
...
<a id="telematicworkingtimesget"></a>
# **WorkingTimes**
> List&lt;DtcoWorkingTimeResponse&gt; WorkingTimes (string driver, DateTime? from = null, DateTime? to = null)
...
namespace Example
{
    public class WorkingTimesExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            try
            {
                List<DtcoWorkingTimeResponse> result = apiInstance.WorkingTimes(driver, from, to);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling TelematicClient.WorkingTimes: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the WorkingTimesWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.

```csharp
try
{
    ApiResponse<List<DtcoWorkingTimeResponse>> response = apiInstance.WorkingTimesWithHttpInfo(driver, from, to);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling TelematicClient.WorkingTimesWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
