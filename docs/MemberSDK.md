# Simplic.OxS.SDK.Organization.MemberSDK

All URIs are relative to *https://dev-oxs.simplic.io/organization-api/v1*

| Method | HTTP request | Description |
|--------|--------------|-------------|
| [**MemberAcceptPost**](MemberSDK.md#memberacceptpost) | **POST** /Member/accept | Accept an invitation from an organization |
| [**MemberDeclinePost**](MemberSDK.md#memberdeclinepost) | **POST** /Member/decline | Decline an invitation from an organization |
| [**MemberDeleteInvitePost**](MemberSDK.md#memberdeleteinvitepost) | **POST** /Member/delete-invite | Deletes a member invite by id. |
| [**MemberGetAllGet**](MemberSDK.md#membergetallget) | **GET** /Member/get-all | Returns all memberships |
| [**MemberGetPendingInvitationsGet**](MemberSDK.md#membergetpendinginvitationsget) | **GET** /Member/get-pending-invitations | Returns all memberships pending invitations |
| [**MemberInviteMultiplePost**](MemberSDK.md#memberinvitemultiplepost) | **POST** /Member/invite-multiple | Invites a list of users by their mail address. |
| [**MemberInvitePost**](MemberSDK.md#memberinvitepost) | **POST** /Member/invite | Invites a user by their mail address. |
| [**MemberLeavePost**](MemberSDK.md#memberleavepost) | **POST** /Member/leave | Removes a member from an organization by the id of the membership. |
| [**MemberRemovePost**](MemberSDK.md#memberremovepost) | **POST** /Member/remove | Removes a member from an organization by the id of the membership. |
| [**MemberUpdateIdPut**](MemberSDK.md#memberupdateidput) | **PUT** /Member/update/{id} | Update user membership in organization |
...
namespace Example
{
    public class MemberAcceptPostExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new MemberSDK(config);
            ...
            {
                Debug.Print("Exception when calling MemberSDK.MemberAcceptPost: " + e.Message);
...
{
    Debug.Print("Exception when calling MemberSDK.MemberAcceptPostWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class MemberDeclinePostExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling MemberSDK.MemberDeclinePost: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling MemberSDK.MemberDeclinePostWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class MemberDeleteInvitePostExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling MemberSDK.MemberDeleteInvitePost: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling MemberSDK.MemberDeleteInvitePostWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class MemberGetAllGetExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling MemberSDK.MemberGetAllGet: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling MemberSDK.MemberGetAllGetWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class MemberGetPendingInvitationsGetExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling MemberSDK.MemberGetPendingInvitationsGet: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling MemberSDK.MemberGetPendingInvitationsGetWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class MemberInviteMultiplePostExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling MemberSDK.MemberInviteMultiplePost: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling MemberSDK.MemberInviteMultiplePostWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class MemberInvitePostExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling MemberSDK.MemberInvitePost: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling MemberSDK.MemberInvitePostWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class MemberLeavePostExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling MemberSDK.MemberLeavePost: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling MemberSDK.MemberLeavePostWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class MemberRemovePostExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling MemberSDK.MemberRemovePost: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling MemberSDK.MemberRemovePostWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class MemberUpdateIdPutExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling MemberSDK.MemberUpdateIdPut: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling MemberSDK.MemberUpdateIdPutWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
