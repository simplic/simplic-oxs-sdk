...
| [**Patch**](ConstructionSiteTypeClient.md#constructionsitetypeidpatch) | **PATCH** /ConstructionSiteType/{id} |  |
...
<a id="constructionsitetypeidpatch"></a>
# **Patch**
...
namespace Example
{
    public class PatchExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling ConstructionSiteTypeClient.Patch: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling ConstructionSiteTypeClient.PatchWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
