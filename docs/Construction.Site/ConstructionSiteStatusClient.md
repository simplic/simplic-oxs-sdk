...
| [**Patch**](ConstructionSiteStatusClient.md#constructionsitestatusidpatch) | **PATCH** /ConstructionSiteStatus/{id} |  |
...
<a id="constructionsitestatusidpatch"></a>
# **Patch**
...
namespace Example
{
    public class PatchExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling ConstructionSiteStatusClient.Patch: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling ConstructionSiteStatusClient.PatchWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
