...
| [**Export**](AIClient.md#apiaiexportdocumentidget) | **GET** /api/AI/export/{documentId} |  |
...
<a id="apiaiexportdocumentidget"></a>
# **Export**
...
namespace Example
{
    public class ExportExample
    {
        public static void Main()
        {
            ...
            try
            {
                DocumentAIState result = apiInstance.Export(documentId);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling AIClient.Export: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
try
{
    ApiResponse<DocumentAIState> response = apiInstance.ExportWithHttpInfo(documentId);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling AIClient.ExportWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
[**DocumentAIState**](DocumentAIState.md)
