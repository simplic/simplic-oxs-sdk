# Simplic.OxS.SDK.vehicle-temperature.ReportingSDK

All URIs are relative to *https://dev-oxs.simplic.io/vehicle-temperature-api/v1*

| Method | HTTP request | Description |
|--------|--------------|-------------|
| [**ReportingGenerateReportVehicleIdGet**](ReportingSDK.md#reportinggeneratereportvehicleidget) | **GET** /Reporting/generate-report/{vehicleId} |  |
| [**ReportingGetMapReportInstanceIdGet**](ReportingSDK.md#reportinggetmapreportinstanceidget) | **GET** /Reporting/get-map/{reportInstanceId} |  |
| [**ReportingGetRecipientsGet**](ReportingSDK.md#reportinggetrecipientsget) | **GET** /Reporting/get-recipients |  |
| [**ReportingSendReportPost**](ReportingSDK.md#reportingsendreportpost) | **POST** /Reporting/send-report |  |
...
namespace Example
{
    public class ReportingGenerateReportVehicleIdGetExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling ReportingSDK.ReportingGenerateReportVehicleIdGet: " + e.Message);
...
{
    Debug.Print("Exception when calling ReportingSDK.ReportingGenerateReportVehicleIdGetWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class ReportingGetMapReportInstanceIdGetExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling ReportingSDK.ReportingGetMapReportInstanceIdGet: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling ReportingSDK.ReportingGetMapReportInstanceIdGetWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class ReportingGetRecipientsGetExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling ReportingSDK.ReportingGetRecipientsGet: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling ReportingSDK.ReportingGetRecipientsGetWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class ReportingSendReportPostExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling ReportingSDK.ReportingSendReportPost: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling ReportingSDK.ReportingSendReportPostWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
