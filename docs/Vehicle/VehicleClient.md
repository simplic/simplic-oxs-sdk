...
| [**Migrate**](VehicleClient.md#vehiclemigratepost) | **POST** /Vehicle/migrate |  |
...
namespace Example
{
    public class MigrateExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling VehicleClient.Migrate: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
try
{
    apiInstance.MigrateWithHttpInfo();
}
catch (ApiException e)
{
    Debug.Print("Exception when calling VehicleClient.MigrateWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
