...
<a id="agorabeepost"></a>
# **Post**
> MeasurementResponseModel Post (PostAgoraBeeRequest? postAgoraBeeRequest = null)
...
namespace Example
{
    public class PostExample
    {
        public static void Main()
        {
            ...
            try
            {
                MeasurementResponseModel result = apiInstance.Post(postAgoraBeeRequest);
...
try
{
    ApiResponse<MeasurementResponseModel> response = apiInstance.PostWithHttpInfo(postAgoraBeeRequest);
