# Simplic.OxS.SDK.Logistics.GeofenceClient

All URIs are relative to *https://dev-oxs.simplic.io/logistics-api/v1*

| Method | HTTP request | Description |
|--------|--------------|-------------|
| [**GetByLocation**](GeofenceClient.md#geofencegetbylocationget) | **GET** /Geofence/get-by-location | Retrieves resources from a specific group and location. |
...
<a id="geofencegetbylocationget"></a>
# **GetByLocation**
> List&lt;GeofenceResponse&gt; GetByLocation (double? longitude = null, double? latitude = null, double? radiusInMeters = null)
...
namespace Example
{
    public class GetByLocationExample
    {
        public static void Main()
        {
            ...
            var radiusInMeters = 1.2D;  // double? |  (optional) 

            try
            {
                // Retrieves resources from a specific group and location.
                List<GeofenceResponse> result = apiInstance.GetByLocation(longitude, latitude, radiusInMeters);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling GeofenceClient.GetByLocation: " + e.Message);
...
{
    // Retrieves resources from a specific group and location.
    ApiResponse<List<GeofenceResponse>> response = apiInstance.GetByLocationWithHttpInfo(longitude, latitude, radiusInMeters);
...
{
    Debug.Print("Exception when calling GeofenceClient.GetByLocationWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
| **radiusInMeters** | **double?** |  | [optional]  |

### Return type

[**List&lt;GeofenceResponse&gt;**](GeofenceResponse.md)
