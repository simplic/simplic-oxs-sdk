# Simplic.OxS.SDK.Logistics.PatchLoadingSlotRequest
...
**Name** | **string** | Gets or sets the name of the loading slot.     This should be used as a short human readable identifier for the loading slot.   | 
...
**ResourceId** | **Guid** | Gets or sets the id of the resource this loading slot is assigned to. | 
