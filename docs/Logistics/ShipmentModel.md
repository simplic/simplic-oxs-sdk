...
**CreateDateTime** | **DateTime** | Gets or sets the create date time     This defines the point of time the shipment is created.   | [optional] 
**UpdateDateTime** | **DateTime** | Get or sets the update date time.     This defines the last point of time the shipment was updated.   | [optional] 
...
**ExternalNotes** | **string** | Gets or sets notes which are visible for external users (e.g. the driver, carrier). | [optional] 
