# Simplic.OxS.SDK.Ai.ClassifyTextAsyncResponse
...
------------ | ------------- | ------------- | -------------
**JobId** | **string** | Gets or sets the job id. Its the id to check the aws query. | 
**State** | **string** | Gets or sets the state of the job. e.g. processing, complete or failed. | 
