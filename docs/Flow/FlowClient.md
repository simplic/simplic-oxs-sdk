...
|--------|--------------|-------------|
| [**EditorTypes**](FlowClient.md#floweditortypesget) | **GET** /Flow/editor-types |  |
...
| [**Schedules**](FlowClient.md#flowschedulesget) | **GET** /Flow/schedules |  |
...
namespace Example
{
    public class EditorTypesExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling FlowClient.EditorTypes: " + e.Message);
...
#### Using the EditorTypesWithHttpInfo variant
...
{
    Debug.Print("Exception when calling FlowClient.EditorTypesWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class StateExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new FlowClient(config);
            var handleId = "handleId_example";  // Guid | 

            try
            {
                apiInstance.State(handleId);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling FlowClient.State: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the StateWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.

```csharp
try
{
    apiInstance.StateWithHttpInfo(handleId);
}
catch (ApiException e)
{
    Debug.Print("Exception when calling FlowClient.StateWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="flownameexecuteasyncpost"></a>
# **ExecuteAsync**
> FlowLogDocument ExecuteAsync (string name, ExecuteFlowRequest? executeFlowRequest = null)
...
namespace Example
{
    public class ExecuteAsyncExample
    {
        public static void Main()
        {
            ...
            var executeFlowRequest = new ExecuteFlowRequest?(); // ExecuteFlowRequest? |  (optional) 

            try
            {
                FlowLogDocument result = apiInstance.ExecuteAsync(name, executeFlowRequest);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling FlowClient.ExecuteAsync: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the ExecuteAsyncWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.

```csharp
try
{
    ApiResponse<FlowLogDocument> response = apiInstance.ExecuteAsyncWithHttpInfo(name, executeFlowRequest);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling FlowClient.ExecuteAsyncWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
|------|------|-------------|-------|
| **name** | **string** |  |  |
| **executeFlowRequest** | [**ExecuteFlowRequest?**](ExecuteFlowRequest?.md) |  | [optional]  |

### Return type

[**FlowLogDocument**](FlowLogDocument.md)
...
<a id="flownameexecutepost"></a>
# **Execute**
> void Execute (string name, ExecuteFlowRequest? executeFlowRequest = null)
...
namespace Example
{
    public class ExecuteExample
    {
        public static void Main()
        {
            ...
            try
            {
                apiInstance.Execute(name, executeFlowRequest);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling FlowClient.Execute: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
try
{
    apiInstance.ExecuteWithHttpInfo(name, executeFlowRequest);
}
catch (ApiException e)
{
    Debug.Print("Exception when calling FlowClient.ExecuteWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="flowschedulesget"></a>
# **Schedules**
> List&lt;GetScheduledFlowResponse&gt; Schedules (string? name = null)
...
namespace Example
{
    public class SchedulesExample
    {
        public static void Main()
        {
            ...
            try
            {
                List<GetScheduledFlowResponse> result = apiInstance.Schedules(name);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling FlowClient.Schedules: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the SchedulesWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.

```csharp
try
{
    ApiResponse<List<GetScheduledFlowResponse>> response = apiInstance.SchedulesWithHttpInfo(name);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling FlowClient.SchedulesWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
[**List&lt;GetScheduledFlowResponse&gt;**](GetScheduledFlowResponse.md)
