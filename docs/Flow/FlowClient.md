...
|--------|--------------|-------------|
| [**Debug**](FlowClient.md#flowdebugflowidget) | **GET** /Flow/debug/{flowId} |  |
| [**Execute**](FlowClient.md#flowexecuteflowidget) | **GET** /Flow/execute/{flowId} |  |
...
namespace Example
{
    public class DebugExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling FlowClient.Debug: " + e.Message);
...
{
    Debug.Print("Exception when calling FlowClient.DebugWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
