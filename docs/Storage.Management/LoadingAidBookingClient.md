# Simplic.OxS.SDK.Storage.Management.LoadingAidBookingClient
...
| [**Post**](LoadingAidBookingClient.md#loadingaidbookingidpost) | **POST** /LoadingAidBooking/{id} |  |
...
<a id="loadingaidbookingidpost"></a>
# **Post**
> List&lt;LoadingAidBookingAccountResponse&gt; Post (string id, LoadingAidBookingFromShipmentRequest? loadingAidBookingFromShipmentRequest = null)
...
namespace Example
{
    public class PostExample
    {
        public static void Main()
        {
            ...
            try
            {
                List<LoadingAidBookingAccountResponse> result = apiInstance.Post(id, loadingAidBookingFromShipmentRequest);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
try
{
    ApiResponse<List<LoadingAidBookingAccountResponse>> response = apiInstance.PostWithHttpInfo(id, loadingAidBookingFromShipmentRequest);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
