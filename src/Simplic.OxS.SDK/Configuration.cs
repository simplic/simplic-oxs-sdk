...
namespace Simplic.OxS.SDK
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration()
        {
            ...
            BasePath = "https://dev-oxs.simplic.io/vehicle-temperature-api/v1";
            ...
            {
                {
                    new Dictionary<string, object> {
                        {"url", "https://dev-oxs.simplic.io/vehicle-temperature-api/v1"},
        ...
        public Configuration(
            ...
            string basePath = "https://dev-oxs.simplic.io/vehicle-temperature-api/v1") : this()
        {
