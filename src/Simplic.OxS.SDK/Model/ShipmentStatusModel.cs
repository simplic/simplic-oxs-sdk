...
namespace Simplic.OxS.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ShipmentStatusModel")]
    public partial class ShipmentStatusModel : IEquatable<ShipmentStatusModel>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ShipmentStatusModel);
        }

        /// <summary>
        /// Returns true if ShipmentStatusModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ShipmentStatusModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShipmentStatusModel input)
        {
            if (input == null)
            {
                return false;
