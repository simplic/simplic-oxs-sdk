...
namespace Simplic.OxS.SDK.Model
{
    ...
    /// CreateTourRequest
    /// </summary>
    [DataContract(Name = "CreateTourRequest")]
    public partial class CreateTourRequest : IEquatable<CreateTourRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public CreateTourRequest(string number = default(string), string reference = default(string), Guid? resourceId = default(Guid?), Guid? startAddressId = default(Guid?), Guid? endAddressId = default(Guid?), DateTime? startDateTime = default(DateTime?), DateTime? endDateTime = default(DateTime?), DateTime? actualStartDateTime = default(DateTime?), DateTime? actualEndDateTime = default(DateTime?), DateTime? calculatedStartDateTime = default(DateTime?), DateTime? calculatedEndDateTime = default(DateTime?), string notes = default(string), List<Guid> tags = default(List<Guid>), List<CreateTourActionRequest> actions = default(List<CreateTourActionRequest>))
        {
            this.Number = number;
        ...
        public List<CreateTourActionRequest> Actions { get; set; }
        ...
        {
            return this.Equals(input as CreateTourRequest);
        }

        /// <summary>
        /// Returns true if CreateTourRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateTourRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateTourRequest input)
        {
            if (input == null)
            {
                return false;
