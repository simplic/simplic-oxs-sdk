...
namespace Simplic.OxS.SDK.Api
{
    ...
    public partial class ReportingSDK : IReportingSDK
    {
        ...
        /// <returns></returns>
        public ReportingSDK(Simplic.OxS.SDK.Client.Configuration configuration)
        {
        ...
        public ReportingSDK(Simplic.OxS.SDK.Client.ISynchronousClient client, Simplic.OxS.SDK.Client.IAsynchronousClient asyncClient, Simplic.OxS.SDK.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Simplic.OxS.SDK.Client.ApiResponse<TourReportingModel> localVarResponse = ReportingGetByTourIdGetWithHttpInfo(id);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TourReportingModel</returns>
        public Simplic.OxS.SDK.Client.ApiResponse<TourReportingModel> ReportingGetByTourIdGetWithHttpInfo(Guid id, int operationIndex = 0)
        {
        ...
        {
            Simplic.OxS.SDK.Client.ApiResponse<TourReportingModel> localVarResponse = await ReportingGetByTourIdGetWithHttpInfoAsync(id, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (TourReportingModel)</returns>
        public async System.Threading.Tasks.Task<Simplic.OxS.SDK.Client.ApiResponse<TourReportingModel>> ReportingGetByTourIdGetWithHttpInfoAsync(Guid id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
