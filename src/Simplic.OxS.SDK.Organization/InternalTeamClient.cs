...
namespace Simplic.OxS.SDK.Organization
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class InternalTeamClient : IInternalTeamClient
    {
        ...
        /// </summary>
        /// <returns></returns>
        public InternalTeamClient() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public InternalTeamClient(string basePath)
        {
        ...
        /// <returns></returns>
        public InternalTeamClient(Simplic.OxS.SDK.Organization.Configuration configuration)
        {
        ...
        public InternalTeamClient(Simplic.OxS.SDK.Organization.ISynchronousClient client, Simplic.OxS.SDK.Organization.IAsynchronousClient asyncClient, Simplic.OxS.SDK.Organization.IReadableConfiguration configuration)
        {
        ...
        {
            Simplic.OxS.SDK.Organization.ApiResponse<List<TeamModel>> localVarResponse = GetAllByUserWithHttpInfo(id);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of List&lt;TeamModel&gt;</returns>
        public Simplic.OxS.SDK.Organization.ApiResponse<List<TeamModel>> GetAllByUserWithHttpInfo(Guid? id = default(Guid?), int operationIndex = 0)
        {
        ...
        {
            Simplic.OxS.SDK.Organization.ApiResponse<List<TeamModel>> localVarResponse = await GetAllByUserWithHttpInfoAsync(id, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;TeamModel&gt;)</returns>
        public async System.Threading.Tasks.Task<Simplic.OxS.SDK.Organization.ApiResponse<List<TeamModel>>> GetAllByUserWithHttpInfoAsync(Guid? id = default(Guid?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
