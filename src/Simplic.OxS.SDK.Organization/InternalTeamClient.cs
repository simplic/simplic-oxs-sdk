...
namespace Simplic.OxS.SDK.Organization
{
    ...
    public class InternalTeamClient : IInternalTeamClient
    {
        ...
        public System.Threading.Tasks.Task<List<TeamModel>> GetAllByUserAsync(Guid? id = default(Guid?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            try
            {
        ...
        public System.Threading.Tasks.Task<Simplic.OxS.SDK.ApiResponse<List<TeamModel>>> GetAllByUserWithHttpInfoAsync(Guid? id = default(Guid?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            try
            {
