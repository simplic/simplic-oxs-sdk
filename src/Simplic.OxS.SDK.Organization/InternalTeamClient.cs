...
namespace Simplic.OxS.SDK.Organization
{
    ...
    public partial class InternalTeamClient : IInternalTeamClient
    {
        ...
        /// <returns></returns>
        public InternalTeamClient(Simplic.OxS.SDK.Configuration configuration)
        {
        ...
        public InternalTeamClient(Simplic.OxS.SDK.ISynchronousClient client, Simplic.OxS.SDK.IAsynchronousClient asyncClient, Simplic.OxS.SDK.IReadableConfiguration configuration)
        {
