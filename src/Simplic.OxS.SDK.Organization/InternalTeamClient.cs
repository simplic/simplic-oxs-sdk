...
//: Implementation
    ...
    public class InternalTeamClient : IInternalTeamClient
    {
        ...
        public List<TeamModel> GetAllByUser(Guid? id = default(Guid?))
        {
            try
            {
                return _internalClient.GetAllByUser(id);
            }
        ...
        /// <param name="id">Id of the user. (optional)</param>
        /// <returns>ApiResponse of List&lt;TeamModel&gt;</returns>
        public Simplic.OxS.SDK.ApiResponse<List<TeamModel>> GetAllByUserWithHttpInfo(Guid? id = default(Guid?))
        {
            try
            {
                return _internalClient.GetAllByUserWithHttpInfo(id);
            }
            catch (ApiException e)
            {
                throw new ApiException(e.ErrorCode, FormatErrorMessage(e.Message, e.ErrorCode), e.ErrorContent, e.Headers);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;TeamModel&gt;</returns>
        public System.Threading.Tasks.Task<List<TeamModel>> GetAllByUserAsync(Guid? id = default(Guid?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            try
            {
                return _internalClient.GetAllByUserAsync(id, cancellationToken: cancellationToken);
            }
            catch (ApiException e)
            {
                throw new ApiException(e.ErrorCode, FormatErrorMessage(e.Message, e.ErrorCode), e.ErrorContent, e.Headers);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;TeamModel&gt;)</returns>
        public System.Threading.Tasks.Task<Simplic.OxS.SDK.ApiResponse<List<TeamModel>>> GetAllByUserWithHttpInfoAsync(Guid? id = default(Guid?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            try
            {
                return _internalClient.GetAllByUserWithHttpInfoAsync(id, cancellationToken: cancellationToken);
            }
            catch (ApiException e)
            {
                throw new ApiException(e.ErrorCode, FormatErrorMessage(e.Message, e.ErrorCode), e.ErrorContent, e.Headers);
...
// ------------------------^ Custom ^------------------------------
    ...
    /// </summary>
    internal interface __IInternalTeamClientSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    internal interface __IInternalTeamClientAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    internal interface __IInternalTeamClient : __IInternalTeamClientSync, __IInternalTeamClientAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    internal /*partial*/ class __InternalTeamClient : __IInternalTeamClient
    {
        private Simplic.OxS.SDK.ExceptionFactory _exceptionFactory = (name, response) => null;
        ...
        */
        ...
        public Simplic.OxS.SDK.ApiResponse<List<TeamModel>> GetAllByUserWithHttpInfo(Guid? id = default(Guid?), int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "InternalTeamClient.InternalInternalTeamGetAllByUserGet";
            ...
            {
                Exception _exception = this.ExceptionFactory("InternalInternalTeamGetAllByUserGet", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        public Simplic.OxS.SDK.ApiResponse<TeamModel> GetWithHttpInfo(Guid id, int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "InternalTeamClient.InternalInternalTeamIdGet";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("InternalInternalTeamIdGet", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
