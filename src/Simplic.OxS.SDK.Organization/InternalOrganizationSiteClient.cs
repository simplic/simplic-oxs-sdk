...
namespace Simplic.OxS.SDK.Organization
{
    ...
    public class InternalOrganizationSiteClient : IInternalOrganizationSiteClient
    {
        ...
        public System.Threading.Tasks.Task<List<OrganizationSiteModel>> GetAllByOrganizationAsync(Guid? id = default(Guid?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            try
            {
        ...
        public System.Threading.Tasks.Task<Simplic.OxS.SDK.ApiResponse<List<OrganizationSiteModel>>> GetAllByOrganizationWithHttpInfoAsync(Guid? id = default(Guid?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            try
            {
