...
//: Implementation
    ...
    public class OrganizationLinkClient : IOrganizationLinkClient
    {
        ...
        public List<OrganizationLinkModel> GetLinked(string? module = default(string?), string? searchContains = default(string?))
        {
            try
            {
                return _internalClient.GetLinked(module, searchContains);
            }
        ...
        /// <param name="searchContains"> (optional)</param>
        /// <returns>ApiResponse of List&lt;OrganizationLinkModel&gt;</returns>
        public Simplic.OxS.SDK.ApiResponse<List<OrganizationLinkModel>> GetLinkedWithHttpInfo(string? module = default(string?), string? searchContains = default(string?))
        {
            try
            {
                return _internalClient.GetLinkedWithHttpInfo(module, searchContains);
            }
            catch (ApiException e)
            {
                throw new ApiException(e.ErrorCode, FormatErrorMessage(e.Message, e.ErrorCode), e.ErrorContent, e.Headers);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;OrganizationLinkModel&gt;</returns>
        public System.Threading.Tasks.Task<List<OrganizationLinkModel>> GetLinkedAsync(string? module = default(string?), string? searchContains = default(string?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            try
            {
                return _internalClient.GetLinkedAsync(module, searchContains, cancellationToken: cancellationToken);
            }
            catch (ApiException e)
            {
                throw new ApiException(e.ErrorCode, FormatErrorMessage(e.Message, e.ErrorCode), e.ErrorContent, e.Headers);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;OrganizationLinkModel&gt;)</returns>
        public System.Threading.Tasks.Task<Simplic.OxS.SDK.ApiResponse<List<OrganizationLinkModel>>> GetLinkedWithHttpInfoAsync(string? module = default(string?), string? searchContains = default(string?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            try
            {
                return _internalClient.GetLinkedWithHttpInfoAsync(module, searchContains, cancellationToken: cancellationToken);
            }
            catch (ApiException e)
            {
                throw new ApiException(e.ErrorCode, FormatErrorMessage(e.Message, e.ErrorCode), e.ErrorContent, e.Headers);
...
// ------------------------^ Custom ^------------------------------
    ...
    /// </summary>
    internal interface __IOrganizationLinkClientSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    internal interface __IOrganizationLinkClientAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    internal interface __IOrganizationLinkClient : __IOrganizationLinkClientSync, __IOrganizationLinkClientAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    internal /*partial*/ class __OrganizationLinkClient : __IOrganizationLinkClient
    {
        private Simplic.OxS.SDK.ExceptionFactory _exceptionFactory = (name, response) => null;
