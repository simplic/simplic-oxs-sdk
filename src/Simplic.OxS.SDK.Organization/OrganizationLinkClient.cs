...
namespace Simplic.OxS.SDK.Organization
{
    ...
    public class OrganizationLinkClient : IOrganizationLinkClient
    {
        ...
        public new List<OrganizationLinkModel> GetLinked(string? module = default(string?), string? searchContains = default(string?), int operationIndex = 0)
        {
            try
            {
        ...
        public new Simplic.OxS.SDK.ApiResponse<List<OrganizationLinkModel>> GetLinkedWithHttpInfo(string? module = default(string?), string? searchContains = default(string?), int operationIndex = 0)
        {
            try
            {
        ...
        public new System.Threading.Tasks.Task<List<OrganizationLinkModel>> GetLinkedAsync(string? module = default(string?), string? searchContains = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            try
            {
