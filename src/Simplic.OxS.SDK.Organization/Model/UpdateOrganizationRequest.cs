...
namespace Simplic.OxS.SDK.Organization
{
    ...
    public partial class UpdateOrganizationRequest : IEquatable<UpdateOrganizationRequest>, IValidatableObject
    {
        ...
        protected UpdateOrganizationRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateOrganizationRequest" /> class.
        /// </summary>
        ...
        public UpdateOrganizationRequest(AddressModelRequest address = default(AddressModelRequest), string name = default(string))
        {
            ...
            if (address == null)
            {
                throw new ArgumentNullException("address is a required property for UpdateOrganizationRequest and cannot be null");
            }
            this.Address = address;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for UpdateOrganizationRequest and cannot be null");
            }
            this.Name = name;
        }
