...
namespace Simplic.OxS.SDK.Organization
{
    ...
    public partial class UpdateOrganizationRequest : IValidatableObject
    {
        ...
        //[JsonConstructor]
        public UpdateOrganizationRequest(AddressModel address, string name)
        {
            Address = address;
            Name = name;
            OnCreated();
    ...
    public class UpdateOrganizationRequestJsonConverter : JsonConverter<UpdateOrganizationRequest>
    {
        ...
        public override UpdateOrganizationRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!address.IsSet)
                throw new ArgumentException("Property is required for class UpdateOrganizationRequest.", nameof(address));

            if (!name.IsSet)
                throw new ArgumentException("Property is required for class UpdateOrganizationRequest.", nameof(name));

            if (address.IsSet && address.Value == null)
                throw new ArgumentNullException(nameof(address), "Property is not nullable for class UpdateOrganizationRequest.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class UpdateOrganizationRequest.");

            //2return new UpdateOrganizationRequest(address.Value!, name.Value!);
            return new UpdateOrganizationRequest(address.Value!, name.Value!);
        }
        ...
        public override void Write(Utf8JsonWriter writer, UpdateOrganizationRequest updateOrganizationRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(ref writer, updateOrganizationRequest, jsonSerializerOptions);
        ...
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(ref Utf8JsonWriter writer, UpdateOrganizationRequest updateOrganizationRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (updateOrganizationRequest.Address == null)
                throw new ArgumentNullException(nameof(updateOrganizationRequest.Address), "Property is required for class UpdateOrganizationRequest.");
            ...
            JsonSerializer.Serialize(writer, updateOrganizationRequest.Address, jsonSerializerOptions);
