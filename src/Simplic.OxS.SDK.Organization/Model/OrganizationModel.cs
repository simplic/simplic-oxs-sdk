...
namespace Simplic.OxS.SDK.Organization
{
    ...
    public partial class OrganizationModel : IEquatable<OrganizationModel>, IValidatableObject
    {
        ...
        public OrganizationModel(Guid id = default(Guid), string name = default(string), AddressModel address = default(AddressModel), BillingAddressModel billingAddressModel = default(BillingAddressModel))
        {
            this.Id = id;
            this.Name = name;
