...
namespace Simplic.OxS.SDK.Organization
{
    ...
    /// </summary>
    [DataContract(Name = "AddressModelResponse")]
    public partial class AddressModelResponse : IEquatable<AddressModelResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddressModelResponse" /> class.
        /// </summary>
        ...
        public AddressModelResponse(string additional01 = default(string), string street = default(string), string houseNumber = default(string), string zipCode = default(string), string city = default(string), string countryIso = default(string), FederalStateModel federalState = default(FederalStateModel))
        {
        ...
        public FederalStateModel FederalState { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddressModelResponse {\n");
        ...
        {
            return this.Equals(input as AddressModelResponse);
        }

        /// <summary>
        /// Returns true if AddressModelResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AddressModelResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddressModelResponse input)
        {
            if (input == null)
            {
                return false;
