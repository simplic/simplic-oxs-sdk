...
namespace Simplic.OxS.SDK.Organization
{
    ...
    public partial class CreateOrganizationRequest : IEquatable<CreateOrganizationRequest>, IValidatableObject
    {
        ...
        /// <param name="dummy">Whether this organization is used for testing purposes.  This allows for deleting it later..</param>
        public CreateOrganizationRequest(AddressModelRequest address = default(AddressModelRequest), string name = default(string), bool dummy = default(bool))
        {
        ...
        /// <summary>
        /// Whether this organization is used for testing purposes.  This allows for deleting it later.
        /// </summary>
        /// <value>Whether this organization is used for testing purposes.  This allows for deleting it later.</value>
