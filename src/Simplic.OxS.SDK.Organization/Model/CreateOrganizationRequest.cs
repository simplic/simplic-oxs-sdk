...
namespace Simplic.OxS.SDK.Organization
{
    ...
    public partial class CreateOrganizationRequest : IValidatableObject
    {
        ...
        //[JsonConstructor]
        public CreateOrganizationRequest(AddressModel address, string name)
        {
            Address = address;
            Name = name;
            OnCreated();
    ...
    public class CreateOrganizationRequestJsonConverter : JsonConverter<CreateOrganizationRequest>
    {
        ...
        public override CreateOrganizationRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!address.IsSet)
                throw new ArgumentException("Property is required for class CreateOrganizationRequest.", nameof(address));

            if (!name.IsSet)
                throw new ArgumentException("Property is required for class CreateOrganizationRequest.", nameof(name));

            if (address.IsSet && address.Value == null)
                throw new ArgumentNullException(nameof(address), "Property is not nullable for class CreateOrganizationRequest.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class CreateOrganizationRequest.");

            //2return new CreateOrganizationRequest(address.Value!, name.Value!);
            return new CreateOrganizationRequest(address.Value!, name.Value!);
        }
        ...
        public override void Write(Utf8JsonWriter writer, CreateOrganizationRequest createOrganizationRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(ref writer, createOrganizationRequest, jsonSerializerOptions);
        ...
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(ref Utf8JsonWriter writer, CreateOrganizationRequest createOrganizationRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (createOrganizationRequest.Address == null)
                throw new ArgumentNullException(nameof(createOrganizationRequest.Address), "Property is required for class CreateOrganizationRequest.");
            ...
            JsonSerializer.Serialize(writer, createOrganizationRequest.Address, jsonSerializerOptions);
