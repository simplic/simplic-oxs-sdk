...
namespace Simplic.OxS.SDK.Organization
{
    ...
    {
        private __RoleClient _internalClient;
        private Simplic.OxS.SDK.ExceptionFactory _exceptionFactory = (name, response) => null;

        public RoleClient(string host, string? authorization = null)
        {
            if (authorization != null)
            {
                _internalClient = new __RoleClient(new Configuration
                {
        ...
        public RoleClient(Environment env, string? authorization = null)
            : this(
    ...
    public interface IRoleClientSync : IApiAccessor
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>List&lt;MemberRoleModel&gt;</returns>
        List<MemberRoleModel> GetAll(int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of List&lt;MemberRoleModel&gt;</returns>
        ApiResponse<List<MemberRoleModel>> GetAllWithHttpInfo(int operationIndex = 0);
    ...
    public interface IRoleClientAsync : IApiAccessor
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;MemberRoleModel&gt;</returns>
        System.Threading.Tasks.Task<List<MemberRoleModel>> GetAllAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;MemberRoleModel&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<MemberRoleModel>>> GetAllWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    internal partial class __RoleClient : IRoleClient
    {
        ...
        /// </summary>
        /// <returns></returns>
        public __RoleClient() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public __RoleClient(string basePath)
        {
        ...
        /// <returns></returns>
        public __RoleClient(Simplic.OxS.SDK.Configuration configuration)
        {
        ...
        public __RoleClient(Simplic.OxS.SDK.ISynchronousClient client, Simplic.OxS.SDK.IAsynchronousClient asyncClient, Simplic.OxS.SDK.IReadableConfiguration configuration)
        {
        ...
        public List<MemberRoleModel> GetAll(int operationIndex = 0)
        {
            Simplic.OxS.SDK.ApiResponse<List<MemberRoleModel>> localVarResponse = GetAllWithHttpInfo();
        ...
        public Simplic.OxS.SDK.ApiResponse<List<MemberRoleModel>> GetAllWithHttpInfo(int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "RoleClient.RoleGetAllGet";
            ...
            var localVarResponse = this.Client.Get<List<MemberRoleModel>>("/Role/get-all", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("RoleGetAllGet", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;MemberRoleModel&gt;</returns>
        public async System.Threading.Tasks.Task<List<MemberRoleModel>> GetAllAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Simplic.OxS.SDK.ApiResponse<List<MemberRoleModel>> localVarResponse = await GetAllWithHttpInfoAsync(operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;MemberRoleModel&gt;)</returns>
        public async System.Threading.Tasks.Task<Simplic.OxS.SDK.ApiResponse<List<MemberRoleModel>>> GetAllWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<List<MemberRoleModel>>("/Role/get-all", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
