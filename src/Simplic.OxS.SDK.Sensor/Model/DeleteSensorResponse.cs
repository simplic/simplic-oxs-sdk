...
namespace Simplic.OxS.SDK.Sensor
{
    ...
    /// </summary>
    [DataContract(Name = "DeleteSensorResponse")]
    public partial class DeleteSensorResponse : IEquatable<DeleteSensorResponse>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteSensorResponse" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeleteSensorResponse {\n");
        ...
        {
            return this.Equals(input as DeleteSensorResponse);
        }

        /// <summary>
        /// Returns true if DeleteSensorResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DeleteSensorResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeleteSensorResponse input)
        {
            if (input == null)
            {
                return false;
