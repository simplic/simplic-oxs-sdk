...
namespace Simplic.OxS.SDK.Sensor
{
    ...
    /// PatchSensorRequest
    /// </summary>
    [DataContract(Name = "PatchSensorRequest")]
    public partial class PatchSensorRequest : IEquatable<PatchSensorRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PatchSensorRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PatchSensorRequest {\n");
        ...
        {
            return this.Equals(input as PatchSensorRequest);
        }

        /// <summary>
        /// Returns true if PatchSensorRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PatchSensorRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PatchSensorRequest input)
        {
            if (input == null)
            {
                return false;
