...
namespace Simplic.OxS.SDK.TimeSlot
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateTimeSlotBookingRequest")]
    public partial class UpdateTimeSlotBookingRequest : IEquatable<UpdateTimeSlotBookingRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public UpdateTimeSlotBookingRequest(string bookedByName = default(string), string loadNumber = default(string), string deliveryNumber = default(string), string referenceNumber = default(string), string tractorUnit = default(string), string trailer = default(string), string driver = default(string), string notes = default(string))
        {
        ...
        {
            return this.Equals(input as UpdateTimeSlotBookingRequest);
        }

        /// <summary>
        /// Returns true if UpdateTimeSlotBookingRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateTimeSlotBookingRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateTimeSlotBookingRequest input)
        {
            if (input == null)
            {
                return false;
