...
namespace Simplic.OxS.SDK.TimeSlot
{
    ...
    /// </summary>
    public partial class UpdateTimeSlotBookingRequest : IValidatableObject
    {
        ...
        /// </summary>
        [JsonConstructor]
        public UpdateTimeSlotBookingRequest()
        {

        }

        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateTimeSlotBookingRequest" /> class.
        /// </summary>
        ...
        //[JsonConstructor]
        public UpdateTimeSlotBookingRequest(Option<string> bookedByName = default, Option<string> deliveryNumber = default, Option<string> driver = default, Option<string> loadNumber = default, Option<string> notes = default, Option<string> referenceNumber = default, Option<string> tractorUnit = default, Option<string> trailer = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateTimeSlotBookingRequest {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="UpdateTimeSlotBookingRequest" />
    /// </summary>
    public class UpdateTimeSlotBookingRequestJsonConverter : JsonConverter<UpdateTimeSlotBookingRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="UpdateTimeSlotBookingRequest" />
        /// </summary>
        ...
        public override UpdateTimeSlotBookingRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            //2return new UpdateTimeSlotBookingRequest(bookedByName, deliveryNumber, driver, loadNumber, notes, referenceNumber, tractorUnit, trailer);
            return new UpdateTimeSlotBookingRequest(bookedByName, deliveryNumber, driver, loadNumber, notes, referenceNumber, tractorUnit, trailer);
        }

        /// <summary>
        /// Serializes a <see cref="UpdateTimeSlotBookingRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="updateTimeSlotBookingRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, UpdateTimeSlotBookingRequest updateTimeSlotBookingRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(ref writer, updateTimeSlotBookingRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="UpdateTimeSlotBookingRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="updateTimeSlotBookingRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(ref Utf8JsonWriter writer, UpdateTimeSlotBookingRequest updateTimeSlotBookingRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (updateTimeSlotBookingRequest.BookedByNameOption.IsSet)
                if (updateTimeSlotBookingRequest.BookedByNameOption.Value != null)
                {
                    writer.WriteString("bookedByName", updateTimeSlotBookingRequest.BookedByName);
                    //var __value = updateTimeSlotBookingRequest.BookedByNameOption.Value;
                    //writer.WriteString("bookedByName", __value);
                }
                else
                    writer.WriteNull("bookedByName");

            if (updateTimeSlotBookingRequest.DeliveryNumberOption.IsSet)
                if (updateTimeSlotBookingRequest.DeliveryNumberOption.Value != null)
                {
                    writer.WriteString("deliveryNumber", updateTimeSlotBookingRequest.DeliveryNumber);
                    //var __value = updateTimeSlotBookingRequest.DeliveryNumberOption.Value;
                    //writer.WriteString("deliveryNumber", __value);
                }
                else
                    writer.WriteNull("deliveryNumber");

            if (updateTimeSlotBookingRequest.DriverOption.IsSet)
                if (updateTimeSlotBookingRequest.DriverOption.Value != null)
                {
                    writer.WriteString("driver", updateTimeSlotBookingRequest.Driver);
                    //var __value = updateTimeSlotBookingRequest.DriverOption.Value;
                    //writer.WriteString("driver", __value);
                }
                else
                    writer.WriteNull("driver");

            if (updateTimeSlotBookingRequest.LoadNumberOption.IsSet)
                if (updateTimeSlotBookingRequest.LoadNumberOption.Value != null)
                {
                    writer.WriteString("loadNumber", updateTimeSlotBookingRequest.LoadNumber);
                    //var __value = updateTimeSlotBookingRequest.LoadNumberOption.Value;
                    //writer.WriteString("loadNumber", __value);
                }
                else
                    writer.WriteNull("loadNumber");

            if (updateTimeSlotBookingRequest.NotesOption.IsSet)
                if (updateTimeSlotBookingRequest.NotesOption.Value != null)
                {
                    writer.WriteString("notes", updateTimeSlotBookingRequest.Notes);
                    //var __value = updateTimeSlotBookingRequest.NotesOption.Value;
                    //writer.WriteString("notes", __value);
                }
                else
                    writer.WriteNull("notes");

            if (updateTimeSlotBookingRequest.ReferenceNumberOption.IsSet)
                if (updateTimeSlotBookingRequest.ReferenceNumberOption.Value != null)
                {
                    writer.WriteString("referenceNumber", updateTimeSlotBookingRequest.ReferenceNumber);
                    //var __value = updateTimeSlotBookingRequest.ReferenceNumberOption.Value;
                    //writer.WriteString("referenceNumber", __value);
                }
                else
                    writer.WriteNull("referenceNumber");

            if (updateTimeSlotBookingRequest.TractorUnitOption.IsSet)
                if (updateTimeSlotBookingRequest.TractorUnitOption.Value != null)
                {
                    writer.WriteString("tractorUnit", updateTimeSlotBookingRequest.TractorUnit);
                    //var __value = updateTimeSlotBookingRequest.TractorUnitOption.Value;
                    //writer.WriteString("tractorUnit", __value);
                }
                else
                    writer.WriteNull("tractorUnit");

            if (updateTimeSlotBookingRequest.TrailerOption.IsSet)
                if (updateTimeSlotBookingRequest.TrailerOption.Value != null)
                {
                    writer.WriteString("trailer", updateTimeSlotBookingRequest.Trailer);
                    //var __value = updateTimeSlotBookingRequest.TrailerOption.Value;
