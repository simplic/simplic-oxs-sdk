...
namespace Simplic.OxS.SDK.TimeSlot
{
    ...
    /// </summary>
    [DataContract(Name = "CreateTimeSlotBookingRequest")]
    public partial class CreateTimeSlotBookingRequest : IEquatable<CreateTimeSlotBookingRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public CreateTimeSlotBookingRequest(string bookedByName = default(string), string loadNumber = default(string), string deliveryNumber = default(string), string referenceNumber = default(string), string tractorUnit = default(string), string trailer = default(string), string driver = default(string), string notes = default(string))
        {
        ...
        {
            return this.Equals(input as CreateTimeSlotBookingRequest);
        }

        /// <summary>
        /// Returns true if CreateTimeSlotBookingRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateTimeSlotBookingRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateTimeSlotBookingRequest input)
        {
            if (input == null)
            {
                return false;
