...
namespace Simplic.OxS.SDK.TimeSlot
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateTimeSlotRequest")]
    public partial class UpdateTimeSlotRequest : IEquatable<UpdateTimeSlotRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public UpdateTimeSlotRequest(DateTime start = default(DateTime), DateTime end = default(DateTime), Guid siteId = default(Guid), string location = default(string), DateTime? timeOfArrival = default(DateTime?), DateTime? loadingStartTime = default(DateTime?), DateTime? loadingEndTime = default(DateTime?))
        {
            this.Start = start;
            this.End = end;
            this.SiteId = siteId;
        ...
        {
            return this.Equals(input as UpdateTimeSlotRequest);
        }

        /// <summary>
        /// Returns true if UpdateTimeSlotRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateTimeSlotRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateTimeSlotRequest input)
        {
            if (input == null)
            {
                return false;
