...
namespace Simplic.OxS.SDK.TimeSlot
{
    ...
    /// </summary>
    public partial class CreateSiteRequest : IValidatableObject
    {
        ...
        //[JsonConstructor]
        public CreateSiteRequest(Option<SiteAddressModel> adress = default, Option<List<SiteAssignment>> assignments = default, Option<string> logoUrl = default, Option<string> name = default, Option<Guid> organizationSiteId = default)
        {
            AdressOption = adress;
    ...
    /// <summary>
    /// A Json converter for type <see cref="CreateSiteRequest" />
    /// </summary>
    public class CreateSiteRequestJsonConverter : JsonConverter<CreateSiteRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="CreateSiteRequest" />
        /// </summary>
        ...
        public override CreateSiteRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (adress.IsSet && adress.Value == null)
                throw new ArgumentNullException(nameof(adress), "Property is not nullable for class CreateSiteRequest.");

            //2return new CreateSiteRequest(adress, assignments, logoUrl, name, organizationSiteId);
            return new CreateSiteRequest(adress, assignments, logoUrl, name, organizationSiteId);
        }

        /// <summary>
        /// Serializes a <see cref="CreateSiteRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="createSiteRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CreateSiteRequest createSiteRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(ref writer, createSiteRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CreateSiteRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="createSiteRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(ref Utf8JsonWriter writer, CreateSiteRequest createSiteRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (createSiteRequest.AdressOption.IsSet && createSiteRequest.Adress == null)
                throw new ArgumentNullException(nameof(createSiteRequest.Adress), "Property is required for class CreateSiteRequest.");

            if (createSiteRequest.AdressOption.IsSet)
            {
                writer.WritePropertyName("adress");
                JsonSerializer.Serialize(writer, createSiteRequest.Adress, jsonSerializerOptions);
            }
            if (createSiteRequest.AssignmentsOption.IsSet)
                if (createSiteRequest.AssignmentsOption.Value != null)
                {
                    writer.WritePropertyName("assignments");
                    JsonSerializer.Serialize(writer, createSiteRequest.Assignments, jsonSerializerOptions);
                }
                else
                    writer.WriteNull("assignments");
            if (createSiteRequest.LogoUrlOption.IsSet)
                if (createSiteRequest.LogoUrlOption.Value != null)
                {
                    writer.WriteString("logoUrl", createSiteRequest.LogoUrl);
                    //var __value = createSiteRequest.LogoUrlOption.Value;
                    //writer.WriteString("logoUrl", __value);
                }
                else
                    writer.WriteNull("logoUrl");

            if (createSiteRequest.NameOption.IsSet)
                if (createSiteRequest.NameOption.Value != null)
                {
                    writer.WriteString("name", createSiteRequest.Name);
                    //var __value = createSiteRequest.NameOption.Value;
                    //writer.WriteString("name", __value);
                }
                else
                    writer.WriteNull("name");

            if (createSiteRequest.OrganizationSiteIdOption.IsSet)
                if (createSiteRequest.OrganizationSiteIdOption.Value != null)
                {
                    writer.WriteString("organizationSiteId", createSiteRequest.OrganizationSiteIdOption!.Value);
                    //var __value = createSiteRequest.OrganizationSiteIdOption.Value;
