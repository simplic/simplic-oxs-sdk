...
namespace Simplic.OxS.SDK.TimeSlot
{
    ...
    /// SiteAssignment
    /// </summary>
    [DataContract(Name = "SiteAssignment")]
    public partial class SiteAssignment : IEquatable<SiteAssignment>, IValidatableObject
    {
        /// <summary>
        ...
        public SiteAssignment(Guid organizationId = default(Guid), Guid? organizationSiteId = default(Guid?))
        {
        ...
        {
            return this.Equals(input as SiteAssignment);
        }

        /// <summary>
        /// Returns true if SiteAssignment instances are equal
        /// </summary>
        /// <param name="input">Instance of SiteAssignment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SiteAssignment input)
        {
            if (input == null)
            {
                return false;
