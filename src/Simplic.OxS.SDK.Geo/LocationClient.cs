...
namespace Simplic.OxS.SDK.Geo
{
    ...
    {
        private __LocationClient _internalClient;
        private Simplic.OxS.SDK.ExceptionFactory _exceptionFactory = (name, response) => null;

        public LocationClient(string host, string? authorization = null)
        {
            if (authorization != null)
            {
                _internalClient = new __LocationClient(new Configuration
                {
        ...
        public LocationClient(Environment env, string? authorization = null)
            : this(
    ...
    public interface ILocationClientSync : IApiAccessor
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>LocationResponse</returns>
        LocationResponse SearchAddress(RequestGeoLocation? requestGeoLocation = default(RequestGeoLocation?), int operationIndex = 0);
    ...
    public interface ILocationClientAsync : IApiAccessor
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of LocationResponse</returns>
        System.Threading.Tasks.Task<LocationResponse> SearchAddressAsync(RequestGeoLocation? requestGeoLocation = default(RequestGeoLocation?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    internal partial class __LocationClient : ILocationClient
    {
        ...
        /// </summary>
        /// <returns></returns>
        public __LocationClient() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public __LocationClient(string basePath)
        {
        ...
        /// <returns></returns>
        public __LocationClient(Simplic.OxS.SDK.Configuration configuration)
        {
        ...
        public __LocationClient(Simplic.OxS.SDK.ISynchronousClient client, Simplic.OxS.SDK.IAsynchronousClient asyncClient, Simplic.OxS.SDK.IReadableConfiguration configuration)
        {
        ...
        public LocationResponse SearchAddress(RequestGeoLocation? requestGeoLocation = default(RequestGeoLocation?), int operationIndex = 0)
        {
            Simplic.OxS.SDK.ApiResponse<LocationResponse> localVarResponse = SearchAddressWithHttpInfo(requestGeoLocation);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of LocationResponse</returns>
        public async System.Threading.Tasks.Task<LocationResponse> SearchAddressAsync(RequestGeoLocation? requestGeoLocation = default(RequestGeoLocation?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Simplic.OxS.SDK.ApiResponse<LocationResponse> localVarResponse = await SearchAddressWithHttpInfoAsync(requestGeoLocation, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (LocationResponse)</returns>
        public async System.Threading.Tasks.Task<Simplic.OxS.SDK.ApiResponse<LocationResponse>> SearchAddressWithHttpInfoAsync(RequestGeoLocation? requestGeoLocation = default(RequestGeoLocation?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<LocationResponse>("/Location/search-address", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
