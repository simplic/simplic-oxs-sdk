...
namespace Simplic.OxS.SDK.Geo
{
    ...
    public partial class RoutingResponse : IEquatable<RoutingResponse>, IValidatableObject
    {
        ...
        public RoutingResponse(double totalDistance = default(double), double totalTollDistance = default(double), int travelTime = default(int), double totalTollCosts = default(double), List<WaypointModel> waypoints = default(List<WaypointModel>))
        {
