...
namespace Simplic.OxS.SDK.Geo
{
    ...
    public partial class RequestRoute : IEquatable<RequestRoute>, IValidatableObject
    {
        ...
        /// <param name="returnWaypoints">returnWaypoints.</param>
        public RequestRoute(Traffic? traffic = default(Traffic?), List<WaypointModel> waypoints = default(List<WaypointModel>), bool returnWaypoints = default(bool))
        {
        ...
        /// <summary>
        /// Gets or Sets ReturnWaypoints
        /// </summary>
        [DataMember(Name = "returnWaypoints", EmitDefaultValue = true)]
        public bool ReturnWaypoints { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ReturnWaypoints: ").Append(ReturnWaypoints).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(RequestRoute input)
        {
            ...
            return 
                ...
                (
                    this.ReturnWaypoints == input.ReturnWaypoints ||
                    this.ReturnWaypoints.Equals(input.ReturnWaypoints)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.ReturnWaypoints.GetHashCode();
                return hashCode;
            }
        }
