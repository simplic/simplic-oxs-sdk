...
//: Implementation
    ...
    {
        private __LLMClient _internalClient;
        private Simplic.OxS.SDK.ExceptionFactory _exceptionFactory = (name, response) => null;

        public LLMClient(string host, string? authorization = null)
        {
            if (authorization != null)
            {
                _internalClient = new __LLMClient(new Configuration
                {
        ...
        public LLMClient(Environment env, string? authorization = null)
            : this(
...
// ------------------------^ Custom ^------------------------------
    ...
    /// </summary>
    internal interface __ILLMClientSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    internal interface __ILLMClientAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    internal interface __ILLMClient : __ILLMClientSync, __ILLMClientAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    internal /*partial*/ class __LLMClient : __ILLMClient
    {
        private Simplic.OxS.SDK.ExceptionFactory _exceptionFactory = (name, response) => null;

        /*
        /// <summary>
        /// Initializes a new instance of the <see cref="__LLMClient"/> class.
        /// </summary>
        /// <returns></returns>
        public __LLMClient() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public __LLMClient(string basePath)
        {
        ...
        */
        ...
        /// <returns></returns>
        public __LLMClient(Simplic.OxS.SDK.Configuration configuration)
        {
        ...
        public __LLMClient(Simplic.OxS.SDK.ISynchronousClient client, Simplic.OxS.SDK.IAsynchronousClient asyncClient, Simplic.OxS.SDK.IReadableConfiguration configuration)
        {
        ...
        public Simplic.OxS.SDK.ApiResponse<List<LLMTypeModel>> GetEffortsWithHttpInfo(string? model = default(string?), int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<List<LLMTypeModel>>("/LLM/get-efforts", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
