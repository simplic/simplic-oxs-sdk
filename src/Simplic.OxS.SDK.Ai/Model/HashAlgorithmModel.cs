...
namespace Simplic.OxS.SDK.Ai
{
    ...
    public partial class HashAlgorithmModel : IEquatable<HashAlgorithmModel>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HashAlgorithmModel {\n");
        ...
        {
            return this.Equals(input as HashAlgorithmModel);
        }

        /// <summary>
        /// Returns true if HashAlgorithmModel instances are equal
        /// </summary>
        /// <param name="input">Instance of HashAlgorithmModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HashAlgorithmModel input)
        {
            if (input == null)
            {
                return false;
