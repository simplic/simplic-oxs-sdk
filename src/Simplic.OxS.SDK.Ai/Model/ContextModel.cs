...
namespace Simplic.OxS.SDK.Ai
{
    ...
    public partial class ContextModel : IEquatable<ContextModel>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as ContextModel);
        }

        /// <summary>
        /// Returns true if ContextModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ContextModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContextModel input)
        {
            if (input == null)
            {
                return false;
