...
namespace Simplic.OxS.SDK.Ai
{
    ...
    public partial class TextClassificationModelDefinition : IEquatable<TextClassificationModelDefinition>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TextClassificationModelDefinition {\n");
        ...
        {
            return this.Equals(input as TextClassificationModelDefinition);
        }

        /// <summary>
        /// Returns true if TextClassificationModelDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of TextClassificationModelDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TextClassificationModelDefinition input)
        {
            if (input == null)
            {
                return false;
