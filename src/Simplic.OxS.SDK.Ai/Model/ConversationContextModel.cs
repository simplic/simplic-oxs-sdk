...
namespace Simplic.OxS.SDK.Ai
{
    ...
    public partial class ConversationContextModel : IEquatable<ConversationContextModel>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as ConversationContextModel);
        }

        /// <summary>
        /// Returns true if ConversationContextModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ConversationContextModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConversationContextModel input)
        {
            if (input == null)
            {
                return false;
