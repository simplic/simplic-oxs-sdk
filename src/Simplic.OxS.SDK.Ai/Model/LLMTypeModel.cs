...
namespace Simplic.OxS.SDK.Ai
{
    ...
    public partial class LLMTypeModel : IEquatable<LLMTypeModel>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as LLMTypeModel);
        }

        /// <summary>
        /// Returns true if LLMTypeModel instances are equal
        /// </summary>
        /// <param name="input">Instance of LLMTypeModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LLMTypeModel input)
        {
            if (input == null)
            {
                return false;
