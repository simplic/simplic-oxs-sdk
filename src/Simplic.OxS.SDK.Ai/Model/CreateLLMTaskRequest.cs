...
namespace Simplic.OxS.SDK.Ai
{
    ...
    public partial class CreateLLMTaskRequest : IEquatable<CreateLLMTaskRequest>, IValidatableObject
    {
        ...
        public CreateLLMTaskRequest(string name = default(string), string reason = default(string), string requires = default(string), LLMTaskDefinitionDto definition = default(LLMTaskDefinitionDto), List<string> optionalSubtask = default(List<string>))
        {
            this.Name = name;
            this.Reason = reason;
        ...
        public LLMTaskDefinitionDto Definition { get; set; }

        /// <summary>
        /// Gets or Sets OptionalSubtask
        /// </summary>
