...
namespace Simplic.OxS.SDK.Ai
{
    ...
    public partial class DataSetModel : IEquatable<DataSetModel>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as DataSetModel);
        }

        /// <summary>
        /// Returns true if DataSetModel instances are equal
        /// </summary>
        /// <param name="input">Instance of DataSetModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DataSetModel input)
        {
            if (input == null)
            {
                return false;
