...
namespace Simplic.OxS.SDK.ERP
{
    ...
    /// TransactionSubtype
    /// </summary>
    [DataContract(Name = "TransactionSubtype")]
    public partial class TransactionSubtype : IEquatable<TransactionSubtype>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionSubtype" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionSubtype {\n");
        ...
        {
            return this.Equals(input as TransactionSubtype);
        }

        /// <summary>
        /// Returns true if TransactionSubtype instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionSubtype to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionSubtype input)
        {
            if (input == null)
            {
                return false;
