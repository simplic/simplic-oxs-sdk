...
namespace Simplic.OxS.SDK.ERP
{
    ...
    /// TransactionAddress
    /// </summary>
    [DataContract(Name = "TransactionAddress")]
    public partial class TransactionAddress : IEquatable<TransactionAddress>, IValidatableObject
    {
        /// <summary>
        ...
        public TransactionAddress(Guid id = default(Guid), string number = default(string), string name = default(string), string street = default(string), string zipcode = default(string), string district = default(string), string federalState = default(string), string country = default(string), string countryIso = default(string), string city = default(string), double? latitude = default(double?), double? longitude = default(double?))
        {
            this.Id = id;
            this.Number = number;
            this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionAddress {\n");
        ...
        {
            return this.Equals(input as TransactionAddress);
        }

        /// <summary>
        /// Returns true if TransactionAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionAddress input)
        {
            if (input == null)
            {
                return false;
