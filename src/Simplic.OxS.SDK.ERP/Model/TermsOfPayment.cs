...
namespace Simplic.OxS.SDK.ERP
{
    ...
    /// TermsOfPayment
    /// </summary>
    [DataContract(Name = "TermsOfPayment")]
    public partial class TermsOfPayment : IEquatable<TermsOfPayment>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TermsOfPayment" /> class.
        /// </summary>
        ...
        public TermsOfPayment(Guid id = default(Guid), Guid organizationId = default(Guid), bool isDeleted = default(bool), DateTime createDateTime = default(DateTime), Guid? createUserId = default(Guid?), string createUserName = default(string), DateTime updateDateTime = default(DateTime), Guid? updateUserId = default(Guid?), string updateUserName = default(string), int number = default(int), string name = default(string), double cashDiscount = default(double), int cashDiscountDays = default(int), int paymentDeadlineDays = default(int), List<string> states = default(List<string>), string formattedText = default(string))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TermsOfPayment {\n");
        ...
        {
            return this.Equals(input as TermsOfPayment);
        }

        /// <summary>
        /// Returns true if TermsOfPayment instances are equal
        /// </summary>
        /// <param name="input">Instance of TermsOfPayment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TermsOfPayment input)
        {
            if (input == null)
            {
                return false;
