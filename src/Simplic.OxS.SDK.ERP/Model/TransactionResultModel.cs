...
namespace Simplic.OxS.SDK.ERP
{
    ...
    public partial class TransactionResultModel : IEquatable<TransactionResultModel>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionResultModel {\n");
        ...
        {
            return this.Equals(input as TransactionResultModel);
        }

        /// <summary>
        /// Returns true if TransactionResultModel instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionResultModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionResultModel input)
        {
            if (input == null)
            {
                return false;
