...
{
    /// <summary>
    /// Represents a request to convert a draft transaction to a regular transaction.
    /// </summary>
    [DataContract(Name = "ConvertDraftTransactionRequest")]
    public partial class ConvertDraftTransactionRequest : IEquatable<ConvertDraftTransactionRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConvertDraftTransactionRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ConvertDraftTransactionRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConvertDraftTransactionRequest" /> class.
        /// </summary>
        ...
        public ConvertDraftTransactionRequest(Guid targetTypeId = default(Guid), Guid? targetSubtypeId = default(Guid?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConvertDraftTransactionRequest {\n");
        ...
        {
            return this.Equals(input as ConvertDraftTransactionRequest);
        }

        /// <summary>
        /// Returns true if ConvertDraftTransactionRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ConvertDraftTransactionRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConvertDraftTransactionRequest input)
        {
            if (input == null)
            {
                return false;
