...
{
    /// <summary>
    /// TransactionItemGroupTermsOfPayment
    /// </summary>
    [DataContract(Name = "TransactionItemGroupTermsOfPayment")]
    public partial class TransactionItemGroupTermsOfPayment : IEquatable<TransactionItemGroupTermsOfPayment>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionItemGroupTermsOfPayment" /> class.
        /// </summary>
        ...
        public TransactionItemGroupTermsOfPayment(Guid id = default(Guid), Guid organizationId = default(Guid), bool isDeleted = default(bool), DateTime createDateTime = default(DateTime), Guid? createUserId = default(Guid?), string createUserName = default(string), DateTime updateDateTime = default(DateTime), Guid? updateUserId = default(Guid?), string updateUserName = default(string), int number = default(int), string name = default(string), double cashDiscount = default(double), int cashDiscountDays = default(int), int paymentDeadlineDays = default(int), List<string> states = default(List<string>), string formattedText = default(string), double total = default(double))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionItemGroupTermsOfPayment {\n");
        ...
        {
            return this.Equals(input as TransactionItemGroupTermsOfPayment);
        }

        /// <summary>
        /// Returns true if TransactionItemGroupTermsOfPayment instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionItemGroupTermsOfPayment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionItemGroupTermsOfPayment input)
        {
            if (input == null)
            {
                return false;
