...
namespace Simplic.OxS.SDK.ERP
{
    ...
    public partial class TaxGroupModel : IEquatable<TaxGroupModel>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>Gets or sets the date and time the tax group is created.</value>
        [DataMember(Name = "createDateTime", EmitDefaultValue = false)]
        public DateTime CreateDateTime { get; set; }

        /// <summary>
        /// Gets or sets the id of the user that created the tax group.
        /// </summary>
        /// <value>Gets or sets the id of the user that created the tax group.</value>
        [DataMember(Name = "createUserId", EmitDefaultValue = true)]
        public Guid? CreateUserId { get; set; }

        /// <summary>
        /// Gets or sets the name of the user that created the tax group.
        /// </summary>
        /// <value>Gets or sets the name of the user that created the tax group.</value>
        [DataMember(Name = "createUserName", EmitDefaultValue = true)]
        public string CreateUserName { get; set; }

        /// <summary>
        /// Gets or sets the date and time the tax group is updated.
        /// </summary>
        /// <value>Gets or sets the date and time the tax group is updated.</value>
        [DataMember(Name = "updateDateTime", EmitDefaultValue = false)]
        public DateTime UpdateDateTime { get; set; }

        /// <summary>
        /// Gets or sets the id of the user that updated the tax group.
        /// </summary>
        /// <value>Gets or sets the id of the user that updated the tax group.</value>
        [DataMember(Name = "updateUserId", EmitDefaultValue = true)]
        public Guid? UpdateUserId { get; set; }

        /// <summary>
        /// Gets or sets the name of the user that updated the tax group.
        /// </summary>
        /// <value>Gets or sets the name of the user that updated the tax group.</value>
