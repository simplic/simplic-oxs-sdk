...
namespace Simplic.OxS.SDK.ERP
{
    ...
    public partial class CurrencyModel : IEquatable<CurrencyModel>, IValidatableObject
    {
        ...
        public CurrencyModel(Guid id = default(Guid), bool isDeleted = default(bool), int number = default(int), string name = default(string), string shortName = default(string), string symbol = default(string), DateTime createDateTime = default(DateTime), Guid? createUserId = default(Guid?), string createUserName = default(string), DateTime updateDateTime = default(DateTime), Guid? updateUserId = default(Guid?), string updateUserName = default(string))
        {
            this.Id = id;
