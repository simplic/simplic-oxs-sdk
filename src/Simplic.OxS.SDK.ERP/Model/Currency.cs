...
namespace Simplic.OxS.SDK.ERP
{
    ...
    public partial class Currency : IEquatable<Currency>, IValidatableObject
    {
        ...
        public Currency(Guid id = default(Guid), Guid organizationId = default(Guid), bool isDeleted = default(bool), int number = default(int), string name = default(string), string shortName = default(string))
        {
            this.Id = id;
