...
namespace Simplic.OxS.SDK.ERP
{
    ...
    public partial class TransactionSubtypeReportModel : IEquatable<TransactionSubtypeReportModel>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionSubtypeReportModel {\n");
        ...
        {
            return this.Equals(input as TransactionSubtypeReportModel);
        }

        /// <summary>
        /// Returns true if TransactionSubtypeReportModel instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionSubtypeReportModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionSubtypeReportModel input)
        {
            if (input == null)
            {
                return false;
