...
namespace Simplic.OxS.SDK.ERP
{
    ...
    public partial class UpdateSplitConfigurationRequest : IEquatable<UpdateSplitConfigurationRequest>, IValidatableObject
    {
        ...
        public UpdateSplitConfigurationRequest(string number = default(string), string name = default(string), List<SplitDefinition> splitDefinitions = default(List<SplitDefinition>))
        {
            this.Number = number;
            this.Name = name;
