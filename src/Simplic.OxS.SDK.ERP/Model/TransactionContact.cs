...
namespace Simplic.OxS.SDK.ERP
{
    ...
    public partial class TransactionContact : IEquatable<TransactionContact>, IValidatableObject
    {
        ...
        public TransactionContact(Guid id = default(Guid), string accountNumber = default(string), string companyName = default(string), string firstName = default(string), string lastName = default(string), Guid? taxGroupId = default(Guid?), TransactionAddress address = default(TransactionAddress))
        {
            this.Id = id;
