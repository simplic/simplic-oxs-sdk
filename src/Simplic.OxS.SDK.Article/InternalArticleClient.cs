...
namespace Simplic.OxS.SDK.Article
{
    ...
    public class InternalArticleClient : IInternalArticleClient
    {
        ...
        public System.Threading.Tasks.Task<ArticleModel> GetByIdAsync(Guid? id = default(Guid?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            try
            {
        ...
        public System.Threading.Tasks.Task<Simplic.OxS.SDK.ApiResponse<ArticleModel>> GetByIdWithHttpInfoAsync(Guid? id = default(Guid?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            try
            {
