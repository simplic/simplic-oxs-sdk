...
//: Implementation
    ...
    public class InternalArticleClient : IInternalArticleClient
    {
        ...
        /// <param name="id"> (optional)</param>
        /// <returns>ApiResponse of ArticleModel</returns>
        public Simplic.OxS.SDK.ApiResponse<ArticleModel> GetByIdWithHttpInfo(Guid? id = default(Guid?))
        {
            try
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ArticleModel</returns>
        public System.Threading.Tasks.Task<ArticleModel> GetByIdAsync(Guid? id = default(Guid?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            try
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ArticleModel)</returns>
        public System.Threading.Tasks.Task<Simplic.OxS.SDK.ApiResponse<ArticleModel>> GetByIdWithHttpInfoAsync(Guid? id = default(Guid?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            try
            {
...
// ------------------------^ Custom ^------------------------------
    ...
    /// </summary>
    internal interface __IInternalArticleClientSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    internal interface __IInternalArticleClientAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    internal interface __IInternalArticleClient : __IInternalArticleClientSync, __IInternalArticleClientAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    internal /*partial*/ class __InternalArticleClient : __IInternalArticleClient
    {
        private Simplic.OxS.SDK.ExceptionFactory _exceptionFactory = (name, response) => null;
        ...
        */
        ...
        public Simplic.OxS.SDK.ApiResponse<ArticleModel> GetByIdWithHttpInfo(Guid? id = default(Guid?), int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "InternalArticleClient.InternalInternalArticleGetByIdGet";
            ...
            {
                Exception _exception = this.ExceptionFactory("InternalInternalArticleGetByIdGet", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
