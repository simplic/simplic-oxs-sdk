...
namespace Simplic.OxS.SDK.Article
{
    ...
    public partial class InternalArticleClient : IInternalArticleClient
    {
        ...
        /// <returns></returns>
        public InternalArticleClient(Simplic.OxS.SDK.Configuration configuration)
        {
        ...
        public InternalArticleClient(Simplic.OxS.SDK.ISynchronousClient client, Simplic.OxS.SDK.IAsynchronousClient asyncClient, Simplic.OxS.SDK.IReadableConfiguration configuration)
        {
