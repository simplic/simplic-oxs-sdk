...
namespace Simplic.OxS.SDK.Article
{
    ...
    public class InternalQuantityUnitClient : IInternalQuantityUnitClient
    {
        ...
        public new QuantityUnitModel GetById(Guid? id = default(Guid?), int operationIndex = 0)
        {
            try
            {
        ...
        public new Simplic.OxS.SDK.ApiResponse<QuantityUnitModel> GetByIdWithHttpInfo(Guid? id = default(Guid?), int operationIndex = 0)
        {
            try
            {
        ...
        public new System.Threading.Tasks.Task<QuantityUnitModel> GetByIdAsync(Guid? id = default(Guid?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            try
            {
        ...
        public new System.Threading.Tasks.Task<Simplic.OxS.SDK.ApiResponse<QuantityUnitModel>> GetByIdWithHttpInfoAsync(Guid? id = default(Guid?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            try
            {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    internal partial class __InternalQuantityUnitClient : IInternalQuantityUnitClient
    {
        private Simplic.OxS.SDK.ExceptionFactory _exceptionFactory = (name, response) => null;
        ...
        public Simplic.OxS.SDK.ApiResponse<QuantityUnitModel> GetByIdWithHttpInfo(Guid? id = default(Guid?), int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "InternalQuantityUnitClient.GetById";
