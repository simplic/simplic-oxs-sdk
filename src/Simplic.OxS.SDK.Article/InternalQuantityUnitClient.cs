...
namespace Simplic.OxS.SDK.Article
{
    ...
    public class InternalQuantityUnitClient : IInternalQuantityUnitClient
    {
        ...
        public System.Threading.Tasks.Task<QuantityUnitModel> GetByIdAsync(Guid? id = default(Guid?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            try
            {
        ...
        public System.Threading.Tasks.Task<Simplic.OxS.SDK.ApiResponse<QuantityUnitModel>> GetByIdWithHttpInfoAsync(Guid? id = default(Guid?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            try
            {
