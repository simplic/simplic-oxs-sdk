...
namespace Simplic.OxS.SDK.Article
{
    ...
    /// ArticleGroupModel
    /// </summary>
    public partial class ArticleGroupModel : IValidatableObject
    {
        ...
        //[JsonConstructor]
        public ArticleGroupModel(Option<DateTime> createDateTime = default, Option<Guid> createUserId = default, Option<string> createUserName = default, Option<Guid> id = default, Option<bool> isDeleted = default, Option<string> name = default, Option<string> number = default, Option<Guid> organizationId = default, Option<DateTime> updateDateTime = default, Option<Guid> updateUserId = default, Option<string> updateUserName = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="ArticleGroupModel" />
    /// </summary>
    public class ArticleGroupModelJsonConverter : JsonConverter<ArticleGroupModel>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="ArticleGroupModel" />
        /// </summary>
        ...
        public override ArticleGroupModel Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (createDateTime.IsSet && createDateTime.Value == null)
                throw new ArgumentNullException(nameof(createDateTime), "Property is not nullable for class ArticleGroupModel.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class ArticleGroupModel.");

            if (isDeleted.IsSet && isDeleted.Value == null)
                throw new ArgumentNullException(nameof(isDeleted), "Property is not nullable for class ArticleGroupModel.");

            if (organizationId.IsSet && organizationId.Value == null)
                throw new ArgumentNullException(nameof(organizationId), "Property is not nullable for class ArticleGroupModel.");

            if (updateDateTime.IsSet && updateDateTime.Value == null)
                throw new ArgumentNullException(nameof(updateDateTime), "Property is not nullable for class ArticleGroupModel.");

            //2return new ArticleGroupModel(createDateTime, createUserId, createUserName, id, isDeleted, name, number, organizationId, updateDateTime, updateUserId, updateUserName);
            return new ArticleGroupModel(createDateTime, createUserId, createUserName, id, isDeleted, name, number, organizationId, updateDateTime, updateUserId, updateUserName);
        }

        /// <summary>
        /// Serializes a <see cref="ArticleGroupModel" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="articleGroupModel"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ArticleGroupModel articleGroupModel, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(ref writer, articleGroupModel, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ArticleGroupModel" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="articleGroupModel"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(ref Utf8JsonWriter writer, ArticleGroupModel articleGroupModel, JsonSerializerOptions jsonSerializerOptions)
        {
            if (articleGroupModel.CreateDateTimeOption.IsSet)
                writer.WriteString("createDateTime", articleGroupModel.CreateDateTimeOption!.Value.ToString(CreateDateTimeFormat));

            if (articleGroupModel.CreateUserIdOption.IsSet)
                if (articleGroupModel.CreateUserIdOption.Value != null)
                {
                    writer.WriteString("createUserId", articleGroupModel.CreateUserIdOption!.Value);
                    //var __value = articleGroupModel.CreateUserIdOption.Value;
                    //writer.WriteString("createUserId", __value);
                }
                else
                    writer.WriteNull("createUserId");

            if (articleGroupModel.CreateUserNameOption.IsSet)
                if (articleGroupModel.CreateUserNameOption.Value != null)
                {
                    writer.WriteString("createUserName", articleGroupModel.CreateUserName);
                    //var __value = articleGroupModel.CreateUserNameOption.Value;
                    //writer.WriteString("createUserName", __value);
                }
                else
                    writer.WriteNull("createUserName");

            if (articleGroupModel.IdOption.IsSet)
                writer.WriteString("id", articleGroupModel.IdOption!.Value);

            if (articleGroupModel.IsDeletedOption.IsSet)
                writer.WriteBoolean("isDeleted", articleGroupModel.IsDeletedOption!.Value);

            if (articleGroupModel.NameOption.IsSet)
                if (articleGroupModel.NameOption.Value != null)
                {
                    writer.WriteString("name", articleGroupModel.Name);
                    //var __value = articleGroupModel.NameOption.Value;
                    //writer.WriteString("name", __value);
                }
                else
                    writer.WriteNull("name");

            if (articleGroupModel.NumberOption.IsSet)
                if (articleGroupModel.NumberOption.Value != null)
                {
                    writer.WriteString("number", articleGroupModel.Number);
                    //var __value = articleGroupModel.NumberOption.Value;
                    //writer.WriteString("number", __value);
                }
                else
                    writer.WriteNull("number");

            if (articleGroupModel.OrganizationIdOption.IsSet)
                writer.WriteString("organizationId", articleGroupModel.OrganizationIdOption!.Value);

            if (articleGroupModel.UpdateDateTimeOption.IsSet)
                writer.WriteString("updateDateTime", articleGroupModel.UpdateDateTimeOption!.Value.ToString(UpdateDateTimeFormat));

            if (articleGroupModel.UpdateUserIdOption.IsSet)
                if (articleGroupModel.UpdateUserIdOption.Value != null)
                {
                    writer.WriteString("updateUserId", articleGroupModel.UpdateUserIdOption!.Value);
                    //var __value = articleGroupModel.UpdateUserIdOption.Value;
                    //writer.WriteString("updateUserId", __value);
                }
                else
                    writer.WriteNull("updateUserId");

            if (articleGroupModel.UpdateUserNameOption.IsSet)
                if (articleGroupModel.UpdateUserNameOption.Value != null)
                {
                    writer.WriteString("updateUserName", articleGroupModel.UpdateUserName);
                    //var __value = articleGroupModel.UpdateUserNameOption.Value;
