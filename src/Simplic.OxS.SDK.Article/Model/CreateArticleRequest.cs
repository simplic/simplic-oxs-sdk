...
namespace Simplic.OxS.SDK.Article
{
    ...
    /// </summary>
    [DataContract(Name = "CreateArticleRequest")]
    public partial class CreateArticleRequest : IEquatable<CreateArticleRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public CreateArticleRequest(string shortName = default(string), string fullName = default(string), string number = default(string), Guid? taxRateId = default(Guid?), string ean = default(string), Guid? articleGroupId = default(Guid?), Guid? quantityUnitId = default(Guid?))
        {
        ...
        {
            return this.Equals(input as CreateArticleRequest);
        }

        /// <summary>
        /// Returns true if CreateArticleRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateArticleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateArticleRequest input)
        {
            if (input == null)
            {
                return false;
