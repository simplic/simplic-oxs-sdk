...
namespace Simplic.OxS.SDK.Telematic
{
    ...
    public partial class OutgoingAttachmentResponse : IEquatable<OutgoingAttachmentResponse>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OutgoingAttachmentResponse {\n");
        ...
        {
            return this.Equals(input as OutgoingAttachmentResponse);
        }

        /// <summary>
        /// Returns true if OutgoingAttachmentResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of OutgoingAttachmentResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OutgoingAttachmentResponse input)
        {
            if (input == null)
            {
                return false;
