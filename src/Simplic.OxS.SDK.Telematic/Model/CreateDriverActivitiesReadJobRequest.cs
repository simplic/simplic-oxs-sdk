...
namespace Simplic.OxS.SDK.Telematic
{
    ...
    public partial class CreateDriverActivitiesReadJobRequest : IEquatable<CreateDriverActivitiesReadJobRequest>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as CreateDriverActivitiesReadJobRequest);
        }

        /// <summary>
        /// Returns true if CreateDriverActivitiesReadJobRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateDriverActivitiesReadJobRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateDriverActivitiesReadJobRequest input)
        {
            if (input == null)
            {
                return false;
