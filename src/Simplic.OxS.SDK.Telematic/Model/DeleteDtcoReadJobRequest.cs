...
namespace Simplic.OxS.SDK.Telematic
{
    ...
    public partial class DeleteDtcoReadJobRequest : IEquatable<DeleteDtcoReadJobRequest>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeleteDtcoReadJobRequest {\n");
        ...
        {
            return this.Equals(input as DeleteDtcoReadJobRequest);
        }

        /// <summary>
        /// Returns true if DeleteDtcoReadJobRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DeleteDtcoReadJobRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeleteDtcoReadJobRequest input)
        {
            if (input == null)
            {
                return false;
