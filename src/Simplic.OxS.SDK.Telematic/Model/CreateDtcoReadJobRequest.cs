...
namespace Simplic.OxS.SDK.Telematic
{
    ...
    public partial class CreateDtcoReadJobRequest : IEquatable<CreateDtcoReadJobRequest>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateDtcoReadJobRequest {\n");
        ...
        {
            return this.Equals(input as CreateDtcoReadJobRequest);
        }

        /// <summary>
        /// Returns true if CreateDtcoReadJobRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateDtcoReadJobRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateDtcoReadJobRequest input)
        {
            if (input == null)
            {
                return false;
