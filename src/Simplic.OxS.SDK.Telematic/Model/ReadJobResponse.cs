...
namespace Simplic.OxS.SDK.Telematic
{
    ...
    public partial class ReadJobResponse : IEquatable<ReadJobResponse>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReadJobResponse {\n");
        ...
        {
            return this.Equals(input as ReadJobResponse);
        }

        /// <summary>
        /// Returns true if ReadJobResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ReadJobResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReadJobResponse input)
        {
            if (input == null)
            {
                return false;
