...
namespace Simplic.OxS.SDK.Telematic
{
    ...
    public partial class DeleteDriverActivitiesReadJobRequest : IEquatable<DeleteDriverActivitiesReadJobRequest>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeleteDriverActivitiesReadJobRequest {\n");
        ...
        {
            return this.Equals(input as DeleteDriverActivitiesReadJobRequest);
        }

        /// <summary>
        /// Returns true if DeleteDriverActivitiesReadJobRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DeleteDriverActivitiesReadJobRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeleteDriverActivitiesReadJobRequest input)
        {
            if (input == null)
            {
                return false;
