...
namespace Simplic.OxS.SDK.Telematic
{
    ...
    public partial class CreateWorkflowStepRequest : IEquatable<CreateWorkflowStepRequest>, IValidatableObject
    {
        ...
        public CreateWorkflowStepRequest(string name = default(string), List<WorkflowStepLocalizationModel> localizations = default(List<WorkflowStepLocalizationModel>), List<WorkflowStepDataFieldModel> dataFields = default(List<WorkflowStepDataFieldModel>), int stepOrder = default(int))
        {
            this.Name = name;
