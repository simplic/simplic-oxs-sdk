...
namespace Simplic.OxS.SDK.Telematic
{
    ...
    /// </summary>
    public partial class CreateEmploymentConfigurationRequest : IValidatableObject
    {
        ...
        /// </summary>
        [JsonConstructor]
        public CreateEmploymentConfigurationRequest()
        {
        ...
        //[JsonConstructor]
        public CreateEmploymentConfigurationRequest(Option<List<string>> activeServices = default, Option<Guid> employmentId = default, Option<string> externalDriverIdentifier = default, Option<string> matchCode = default, Option<string> providerName = default, Option<DateTime> validFrom = default, Option<DateTime> validTo = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="CreateEmploymentConfigurationRequest" />
    /// </summary>
    public class CreateEmploymentConfigurationRequestJsonConverter : JsonConverter<CreateEmploymentConfigurationRequest>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="CreateEmploymentConfigurationRequest" />
        /// </summary>
        ...
        public override CreateEmploymentConfigurationRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (employmentId.IsSet && employmentId.Value == null)
                throw new ArgumentNullException(nameof(employmentId), "Property is not nullable for class CreateEmploymentConfigurationRequest.");

            if (validFrom.IsSet && validFrom.Value == null)
                throw new ArgumentNullException(nameof(validFrom), "Property is not nullable for class CreateEmploymentConfigurationRequest.");

            if (validTo.IsSet && validTo.Value == null)
                throw new ArgumentNullException(nameof(validTo), "Property is not nullable for class CreateEmploymentConfigurationRequest.");

            //2return new CreateEmploymentConfigurationRequest(activeServices, employmentId, externalDriverIdentifier, matchCode, providerName, validFrom, validTo);
            return new CreateEmploymentConfigurationRequest(activeServices, employmentId, externalDriverIdentifier, matchCode, providerName, validFrom, validTo);
        }

        /// <summary>
        /// Serializes a <see cref="CreateEmploymentConfigurationRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="createEmploymentConfigurationRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CreateEmploymentConfigurationRequest createEmploymentConfigurationRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(ref writer, createEmploymentConfigurationRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CreateEmploymentConfigurationRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="createEmploymentConfigurationRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(ref Utf8JsonWriter writer, CreateEmploymentConfigurationRequest createEmploymentConfigurationRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (createEmploymentConfigurationRequest.ActiveServicesOption.IsSet)
                if (createEmploymentConfigurationRequest.ActiveServicesOption.Value != null)
                {
                    writer.WritePropertyName("activeServices");
                    JsonSerializer.Serialize(writer, createEmploymentConfigurationRequest.ActiveServices, jsonSerializerOptions);
                }
                else
                    writer.WriteNull("activeServices");
            if (createEmploymentConfigurationRequest.EmploymentIdOption.IsSet)
                writer.WriteString("employmentId", createEmploymentConfigurationRequest.EmploymentIdOption!.Value);

            if (createEmploymentConfigurationRequest.ExternalDriverIdentifierOption.IsSet)
                if (createEmploymentConfigurationRequest.ExternalDriverIdentifierOption.Value != null)
                {
                    writer.WriteString("externalDriverIdentifier", createEmploymentConfigurationRequest.ExternalDriverIdentifier);
                    //var __value = createEmploymentConfigurationRequest.ExternalDriverIdentifierOption.Value;
                    //writer.WriteString("externalDriverIdentifier", __value);
                }
                else
                    writer.WriteNull("externalDriverIdentifier");

            if (createEmploymentConfigurationRequest.MatchCodeOption.IsSet)
                if (createEmploymentConfigurationRequest.MatchCodeOption.Value != null)
                {
                    writer.WriteString("matchCode", createEmploymentConfigurationRequest.MatchCode);
                    //var __value = createEmploymentConfigurationRequest.MatchCodeOption.Value;
                    //writer.WriteString("matchCode", __value);
                }
                else
                    writer.WriteNull("matchCode");

            if (createEmploymentConfigurationRequest.ProviderNameOption.IsSet)
                if (createEmploymentConfigurationRequest.ProviderNameOption.Value != null)
                {
                    writer.WriteString("providerName", createEmploymentConfigurationRequest.ProviderName);
                    //var __value = createEmploymentConfigurationRequest.ProviderNameOption.Value;
                    //writer.WriteString("providerName", __value);
                }
                else
                    writer.WriteNull("providerName");

            if (createEmploymentConfigurationRequest.ValidFromOption.IsSet)
                writer.WriteString("validFrom", createEmploymentConfigurationRequest.ValidFromOption!.Value.ToString(ValidFromFormat));

            if (createEmploymentConfigurationRequest.ValidToOption.IsSet)
                writer.WriteString("validTo", createEmploymentConfigurationRequest.ValidToOption!.Value.ToString(ValidToFormat));
        }
    }
}
