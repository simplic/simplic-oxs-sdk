...
namespace Simplic.OxS.SDK.Telematic
{
    ...
    public partial class PatchDataFieldRequest : IEquatable<PatchDataFieldRequest>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PatchDataFieldRequest {\n");
        ...
        {
            return this.Equals(input as PatchDataFieldRequest);
        }

        /// <summary>
        /// Returns true if PatchDataFieldRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PatchDataFieldRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PatchDataFieldRequest input)
        {
            if (input == null)
            {
                return false;
