...
{
    /// <summary>
    /// Represents a request to patch a telematic workflow.
    /// </summary>
    ...
    public partial class PatchWorkflowRequest : IEquatable<PatchWorkflowRequest>, IValidatableObject
    {
        ...
        public PatchWorkflowRequest(string name = default(string), string value = default(string), string description = default(string), List<WorkflowStepAssignmentSet> steps = default(List<WorkflowStepAssignmentSet>))
        {
            this.Name = name;
            this.Value = value;
