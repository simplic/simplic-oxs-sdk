...
namespace Simplic.OxS.SDK.Telematic
{
    ...
    public partial class ImportVehiclesRequest : IEquatable<ImportVehiclesRequest>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ImportVehiclesRequest {\n");
        ...
        {
            return this.Equals(input as ImportVehiclesRequest);
        }

        /// <summary>
        /// Returns true if ImportVehiclesRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ImportVehiclesRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ImportVehiclesRequest input)
        {
            if (input == null)
            {
                return false;
