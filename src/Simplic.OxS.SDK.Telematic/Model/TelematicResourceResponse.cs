...
namespace Simplic.OxS.SDK.Telematic
{
    ...
    public partial class TelematicResourceResponse : IEquatable<TelematicResourceResponse>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TelematicResourceResponse {\n");
        ...
        {
            return this.Equals(input as TelematicResourceResponse);
        }

        /// <summary>
        /// Returns true if TelematicResourceResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TelematicResourceResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TelematicResourceResponse input)
        {
            if (input == null)
            {
                return false;
