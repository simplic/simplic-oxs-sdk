...
namespace Simplic.OxS.SDK.Telematic
{
    ...
    public partial class OpeningHoursResponse : IEquatable<OpeningHoursResponse>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OpeningHoursResponse {\n");
        ...
        {
            return this.Equals(input as OpeningHoursResponse);
        }

        /// <summary>
        /// Returns true if OpeningHoursResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of OpeningHoursResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OpeningHoursResponse input)
        {
            if (input == null)
            {
                return false;
