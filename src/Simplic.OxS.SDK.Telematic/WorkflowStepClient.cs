...
/// </summary>
public interface IWorkflowStepClient
{
    /// <summary>
...
//: Implementation
    ...
    /// Client to interact with the API endpoints of the telematic service.
    /// </summary>
    public class WorkflowStepClient : IWorkflowStepClient
    {
        private __WorkflowStepClient _internalClient;
        private Simplic.OxS.SDK.ExceptionFactory _exceptionFactory = (name, response) => null;

        public WorkflowStepClient(string host, string? authorization = null)
        {
            if (authorization != null)
            {
                _internalClient = new __WorkflowStepClient(new Configuration
                {
        ...
        public WorkflowStepClient(Environment env, string? authorization = null)
            : this(
        ...
        public WorkflowStepResponse Patch(Guid id, PatchWorkflowStepRequest? patchWorkflowStepRequest = default(PatchWorkflowStepRequest?))
        {
            try
            {
                return _internalClient.Patch(id, patchWorkflowStepRequest);
            }
            catch (ApiException e)
            {
                throw new ApiException(e.ErrorCode, FormatErrorMessage(e.Message, e.ErrorCode), e.ErrorContent, e.Headers);
        ...
        public Simplic.OxS.SDK.ApiResponse<WorkflowStepResponse> PatchWithHttpInfo(Guid id, PatchWorkflowStepRequest? patchWorkflowStepRequest = default(PatchWorkflowStepRequest?))
        {
            try
            {
                return _internalClient.PatchWithHttpInfo(id, patchWorkflowStepRequest);
            }
            catch (ApiException e)
            {
                throw new ApiException(e.ErrorCode, FormatErrorMessage(e.Message, e.ErrorCode), e.ErrorContent, e.Headers);
        ...
        public System.Threading.Tasks.Task<WorkflowStepResponse> PatchAsync(Guid id, PatchWorkflowStepRequest? patchWorkflowStepRequest = default(PatchWorkflowStepRequest?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            try
            {
                return _internalClient.PatchAsync(id, patchWorkflowStepRequest, cancellationToken: cancellationToken);
            }
            catch (ApiException e)
            {
                throw new ApiException(e.ErrorCode, FormatErrorMessage(e.Message, e.ErrorCode), e.ErrorContent, e.Headers);
        ...
        public System.Threading.Tasks.Task<Simplic.OxS.SDK.ApiResponse<WorkflowStepResponse>> PatchWithHttpInfoAsync(Guid id, PatchWorkflowStepRequest? patchWorkflowStepRequest = default(PatchWorkflowStepRequest?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            try
            {
                return _internalClient.PatchWithHttpInfoAsync(id, patchWorkflowStepRequest, cancellationToken: cancellationToken);
            }
            catch (ApiException e)
            {
                throw new ApiException(e.ErrorCode, FormatErrorMessage(e.Message, e.ErrorCode), e.ErrorContent, e.Headers);
        ...
        public WorkflowStepResponse Post(CreateWorkflowStepRequest? createWorkflowStepRequest = default(CreateWorkflowStepRequest?))
        {
            try
            {
                return _internalClient.Post(createWorkflowStepRequest);
            }
            catch (ApiException e)
            {
                throw new ApiException(e.ErrorCode, FormatErrorMessage(e.Message, e.ErrorCode), e.ErrorContent, e.Headers);
        ...
        public Simplic.OxS.SDK.ApiResponse<WorkflowStepResponse> PostWithHttpInfo(CreateWorkflowStepRequest? createWorkflowStepRequest = default(CreateWorkflowStepRequest?))
        {
            try
            {
                return _internalClient.PostWithHttpInfo(createWorkflowStepRequest);
            }
            catch (ApiException e)
            {
                throw new ApiException(e.ErrorCode, FormatErrorMessage(e.Message, e.ErrorCode), e.ErrorContent, e.Headers);
        ...
        public System.Threading.Tasks.Task<WorkflowStepResponse> PostAsync(CreateWorkflowStepRequest? createWorkflowStepRequest = default(CreateWorkflowStepRequest?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            try
            {
                return _internalClient.PostAsync(createWorkflowStepRequest, cancellationToken: cancellationToken);
            }
            catch (ApiException e)
            {
                throw new ApiException(e.ErrorCode, FormatErrorMessage(e.Message, e.ErrorCode), e.ErrorContent, e.Headers);
        ...
        public System.Threading.Tasks.Task<Simplic.OxS.SDK.ApiResponse<WorkflowStepResponse>> PostWithHttpInfoAsync(CreateWorkflowStepRequest? createWorkflowStepRequest = default(CreateWorkflowStepRequest?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            try
            {
                return _internalClient.PostWithHttpInfoAsync(createWorkflowStepRequest, cancellationToken: cancellationToken);
            }
            catch (ApiException e)
            {
                throw new ApiException(e.ErrorCode, FormatErrorMessage(e.Message, e.ErrorCode), e.ErrorContent, e.Headers);
...
// ------------------------^ Custom ^------------------------------
    ...
    /// </summary>
    internal interface __IWorkflowStepClientSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    internal interface __IWorkflowStepClientAsync : IApiAccessor
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (WorkflowStepResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<WorkflowStepResponse>> PostWithHttpInfoAsync(CreateWorkflowStepRequest? createWorkflowStepRequest = default(CreateWorkflowStepRequest?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    internal interface __IWorkflowStepClient : __IWorkflowStepClientSync, __IWorkflowStepClientAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    internal /*partial*/ class __WorkflowStepClient : __IWorkflowStepClient
    {
        private Simplic.OxS.SDK.ExceptionFactory _exceptionFactory = (name, response) => null;

        /*
        /// <summary>
        /// Initializes a new instance of the <see cref="__WorkflowStepClient"/> class.
        /// </summary>
        /// <returns></returns>
        public __WorkflowStepClient() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public __WorkflowStepClient(string basePath)
        {
        ...
        */
        ...
        /// <returns></returns>
        public __WorkflowStepClient(Simplic.OxS.SDK.Configuration configuration)
        {
        ...
        public __WorkflowStepClient(Simplic.OxS.SDK.ISynchronousClient client, Simplic.OxS.SDK.IAsynchronousClient asyncClient, Simplic.OxS.SDK.IReadableConfiguration configuration)
        {
        ...
        public Simplic.OxS.SDK.ApiResponse<Object> DeleteWithHttpInfo(Guid id, int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "WorkflowStepClient.WorkflowStepIdDelete";
            ...
            var localVarResponse = this.Client.Delete<Object>("/WorkflowStep/{id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("WorkflowStepIdDelete", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        public async System.Threading.Tasks.Task<Simplic.OxS.SDK.ApiResponse<Object>> DeleteWithHttpInfoAsync(Guid id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<Object>("/WorkflowStep/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        {
            Simplic.OxS.SDK.ApiResponse<WorkflowStepResponse> localVarResponse = GetWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        public Simplic.OxS.SDK.ApiResponse<WorkflowStepResponse> GetWithHttpInfo(Guid id, int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "WorkflowStepClient.WorkflowStepIdGet";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<WorkflowStepResponse>("/WorkflowStep/{id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("WorkflowStepIdGet", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of WorkflowStepResponse</returns>
        public async System.Threading.Tasks.Task<WorkflowStepResponse> GetAsync(Guid id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Simplic.OxS.SDK.ApiResponse<WorkflowStepResponse> localVarResponse = await GetWithHttpInfoAsync(id, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (WorkflowStepResponse)</returns>
        public async System.Threading.Tasks.Task<Simplic.OxS.SDK.ApiResponse<WorkflowStepResponse>> GetWithHttpInfoAsync(Guid id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<WorkflowStepResponse>("/WorkflowStep/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        {
            Simplic.OxS.SDK.ApiResponse<WorkflowStepResponse> localVarResponse = PatchWithHttpInfo(id, patchWorkflowStepRequest);
            return localVarResponse.Data;
        }
        ...
        public Simplic.OxS.SDK.ApiResponse<WorkflowStepResponse> PatchWithHttpInfo(Guid id, PatchWorkflowStepRequest? patchWorkflowStepRequest = default(PatchWorkflowStepRequest?), int operationIndex = 0)
        {
            ...
            localVarRequestOptions.PathParameters.Add("id", Simplic.OxS.SDK.ClientUtils.ParameterToString(id)); // path parameter
            localVarRequestOptions.Data = patchWorkflowStepRequest;

            localVarRequestOptions.Operation = "WorkflowStepClient.WorkflowStepIdPatch";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Patch<WorkflowStepResponse>("/WorkflowStep/{id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("WorkflowStepIdPatch", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of WorkflowStepResponse</returns>
        public async System.Threading.Tasks.Task<WorkflowStepResponse> PatchAsync(Guid id, PatchWorkflowStepRequest? patchWorkflowStepRequest = default(PatchWorkflowStepRequest?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Simplic.OxS.SDK.ApiResponse<WorkflowStepResponse> localVarResponse = await PatchWithHttpInfoAsync(id, patchWorkflowStepRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (WorkflowStepResponse)</returns>
        public async System.Threading.Tasks.Task<Simplic.OxS.SDK.ApiResponse<WorkflowStepResponse>> PatchWithHttpInfoAsync(Guid id, PatchWorkflowStepRequest? patchWorkflowStepRequest = default(PatchWorkflowStepRequest?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PatchAsync<WorkflowStepResponse>("/WorkflowStep/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        {
            Simplic.OxS.SDK.ApiResponse<WorkflowStepResponse> localVarResponse = PostWithHttpInfo(createWorkflowStepRequest);
            return localVarResponse.Data;
        }
        ...
        public Simplic.OxS.SDK.ApiResponse<WorkflowStepResponse> PostWithHttpInfo(CreateWorkflowStepRequest? createWorkflowStepRequest = default(CreateWorkflowStepRequest?), int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Data = createWorkflowStepRequest;

            localVarRequestOptions.Operation = "WorkflowStepClient.WorkflowStepPost";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<WorkflowStepResponse>("/WorkflowStep", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("WorkflowStepPost", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of WorkflowStepResponse</returns>
        public async System.Threading.Tasks.Task<WorkflowStepResponse> PostAsync(CreateWorkflowStepRequest? createWorkflowStepRequest = default(CreateWorkflowStepRequest?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Simplic.OxS.SDK.ApiResponse<WorkflowStepResponse> localVarResponse = await PostWithHttpInfoAsync(createWorkflowStepRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (WorkflowStepResponse)</returns>
        public async System.Threading.Tasks.Task<Simplic.OxS.SDK.ApiResponse<WorkflowStepResponse>> PostWithHttpInfoAsync(CreateWorkflowStepRequest? createWorkflowStepRequest = default(CreateWorkflowStepRequest?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<WorkflowStepResponse>("/WorkflowStep", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
