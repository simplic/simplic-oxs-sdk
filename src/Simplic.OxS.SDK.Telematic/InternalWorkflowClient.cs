...
/// </summary>
public interface IInternalWorkflowClient
{
    /// <summary>
...
//: Implementation
    ...
    /// Client to interact with the API endpoints of the telematic service.
    /// </summary>
    public class InternalWorkflowClient : IInternalWorkflowClient
    {
        private __InternalWorkflowClient _internalClient;
        private Simplic.OxS.SDK.ExceptionFactory _exceptionFactory = (name, response) => null;

        public InternalWorkflowClient(string host, string? authorization = null)
        {
            if (authorization != null)
            {
                _internalClient = new __InternalWorkflowClient(new Configuration
                {
        ...
        public InternalWorkflowClient(Environment env, string? authorization = null)
            : this(
...
// ------------------------^ Custom ^------------------------------
    ...
    /// </summary>
    internal interface __IInternalWorkflowClientSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    internal interface __IInternalWorkflowClientAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    internal interface __IInternalWorkflowClient : __IInternalWorkflowClientSync, __IInternalWorkflowClientAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    internal /*partial*/ class __InternalWorkflowClient : __IInternalWorkflowClient
    {
        private Simplic.OxS.SDK.ExceptionFactory _exceptionFactory = (name, response) => null;

        /*
        /// <summary>
        /// Initializes a new instance of the <see cref="__InternalWorkflowClient"/> class.
        /// </summary>
        /// <returns></returns>
        public __InternalWorkflowClient() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public __InternalWorkflowClient(string basePath)
        {
        ...
        */
        ...
        /// <returns></returns>
        public __InternalWorkflowClient(Simplic.OxS.SDK.Configuration configuration)
        {
        ...
        public __InternalWorkflowClient(Simplic.OxS.SDK.ISynchronousClient client, Simplic.OxS.SDK.IAsynchronousClient asyncClient, Simplic.OxS.SDK.IReadableConfiguration configuration)
        {
