...
namespace Simplic.OxS.SDK.Storage.Management
{
    ...
    public partial class Booking : IEquatable<Booking>, IValidatableObject
    {
        ...
        public Booking(Guid id = default(Guid), Guid organizationId = default(Guid), bool isDeleted = default(bool), Guid customerId = default(Guid), Guid locationId = default(Guid), bool isExternalDriver = default(bool), string driverExt = default(string), Guid? driverId = default(Guid?), bool isExternalTractorUnit = default(bool), string tractorUnitExt = default(string), Guid? tractorUnitId = default(Guid?), bool isUnknownCarrier = default(bool), string carrierExt = default(string), Guid? carrierId = default(Guid?), DateTime date = default(DateTime), Guid signatureUrl = default(Guid), Guid? signatureUrlUser = default(Guid?), string nameUser = default(string), string ecoNumber = default(string), string deliveryNote = default(string), List<LoadingAid> loadingAids = default(List<LoadingAid>), List<Guid> images = default(List<Guid>))
        {
            this.Id = id;
