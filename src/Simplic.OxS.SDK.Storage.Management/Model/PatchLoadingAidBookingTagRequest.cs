...
{
    /// <summary>
    /// PatchLoadingAidBookingTagRequest
    /// </summary>
    [DataContract(Name = "PatchLoadingAidBookingTagRequest")]
    public partial class PatchLoadingAidBookingTagRequest : IEquatable<PatchLoadingAidBookingTagRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PatchLoadingAidBookingTagRequest" /> class.
        /// </summary>
        ...
        public PatchLoadingAidBookingTagRequest(string displayName = default(string), string displayKey = default(string), string internalName = default(string), string hexColor = default(string), List<string> functions = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PatchLoadingAidBookingTagRequest {\n");
        ...
        {
            return this.Equals(input as PatchLoadingAidBookingTagRequest);
        }

        /// <summary>
        /// Returns true if PatchLoadingAidBookingTagRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PatchLoadingAidBookingTagRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PatchLoadingAidBookingTagRequest input)
        {
            if (input == null)
            {
                return false;
