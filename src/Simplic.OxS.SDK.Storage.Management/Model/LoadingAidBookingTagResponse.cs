...
{
    /// <summary>
    /// LoadingAidBookingTagResponse
    /// </summary>
    [DataContract(Name = "LoadingAidBookingTagResponse")]
    public partial class LoadingAidBookingTagResponse : IEquatable<LoadingAidBookingTagResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as LoadingAidBookingTagResponse);
        }

        /// <summary>
        /// Returns true if LoadingAidBookingTagResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of LoadingAidBookingTagResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LoadingAidBookingTagResponse input)
        {
            if (input == null)
            {
                return false;
