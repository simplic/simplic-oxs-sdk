...
namespace Simplic.OxS.SDK.Storage.Management
{
    ...
    public partial class PatchBookingRequest : IEquatable<PatchBookingRequest>, IValidatableObject
    {
        ...
        public List<PatchLoadingAidRequest> LoadingAids { get; set; }
