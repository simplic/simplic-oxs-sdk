...
{
    /// <summary>
    /// PatchLoadingAidBookingHeadAccountRequest
    /// </summary>
    [DataContract(Name = "PatchLoadingAidBookingHeadAccountRequest")]
    public partial class PatchLoadingAidBookingHeadAccountRequest : IEquatable<PatchLoadingAidBookingHeadAccountRequest>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as PatchLoadingAidBookingHeadAccountRequest);
        }

        /// <summary>
        /// Returns true if PatchLoadingAidBookingHeadAccountRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PatchLoadingAidBookingHeadAccountRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PatchLoadingAidBookingHeadAccountRequest input)
        {
            if (input == null)
            {
                return false;
