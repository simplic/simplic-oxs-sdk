...
{
    /// <summary>
    /// PatchLoadingAidBookingAccountRequest
    /// </summary>
    [DataContract(Name = "PatchLoadingAidBookingAccountRequest")]
    public partial class PatchLoadingAidBookingAccountRequest : IEquatable<PatchLoadingAidBookingAccountRequest>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as PatchLoadingAidBookingAccountRequest);
        }

        /// <summary>
        /// Returns true if PatchLoadingAidBookingAccountRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PatchLoadingAidBookingAccountRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PatchLoadingAidBookingAccountRequest input)
        {
            if (input == null)
            {
                return false;
