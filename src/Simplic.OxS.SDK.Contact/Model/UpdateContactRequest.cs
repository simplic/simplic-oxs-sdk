...
using OpenAPIDateConverter = Simplic.OxS.SDK.Contact.OpenAPIDateConverter;
...
namespace Simplic.OxS.SDK.Contact
{
    ...
    public partial class UpdateContactRequest : IEquatable<UpdateContactRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public UpdateContactRequest(AddressModel address = default(AddressModel), string matchCode = default(string), List<string> functions = default(List<string>))
        {
        ...
        {
            return this.Equals(input as UpdateContactRequest);
        }

        /// <summary>
        /// Returns true if UpdateContactRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateContactRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateContactRequest input)
        {
            if (input == null)
            {
                return false;
