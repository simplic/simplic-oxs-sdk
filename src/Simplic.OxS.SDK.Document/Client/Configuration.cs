...
namespace Simplic.OxS.SDK.Document.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration()
        {
            ...
            BasePath = "https://dev-oxs.simplic.io/document-api/v1";
            ...
            {
                {
                    new Dictionary<string, object> {
                        {"url", "https://dev-oxs.simplic.io/document-api/v1"},
        ...
        public Configuration(
            ...
            string basePath = "https://dev-oxs.simplic.io/document-api/v1") : this()
        {
        ...
        {
            string report = "C# SDK (Simplic.OxS.SDK.Document) Debug Report:\n";
