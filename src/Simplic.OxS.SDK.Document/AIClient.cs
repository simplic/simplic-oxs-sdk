...
namespace Simplic.OxS.SDK.Document
{
    ...
    /// </summary>
    public interface IAIClientSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAIClientAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAIClient : IAIClientSync, IAIClientAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    internal partial class __AIClient : IAIClient
    {
        private Simplic.OxS.SDK.ExceptionFactory _exceptionFactory = (name, response) => null;
