...
namespace Simplic.OxS.SDK.Construction.Site
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateConstructionSiteRequest")]
    public partial class UpdateConstructionSiteRequest : IEquatable<UpdateConstructionSiteRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember(Name = "contactPersonContactId", EmitDefaultValue = false)]
        ...
        {
            return this.Equals(input as UpdateConstructionSiteRequest);
        }

        /// <summary>
        /// Returns true if UpdateConstructionSiteRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateConstructionSiteRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateConstructionSiteRequest input)
        {
            if (input == null)
            {
                return false;
