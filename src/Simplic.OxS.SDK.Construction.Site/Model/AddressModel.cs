...
namespace Simplic.OxS.SDK.Construction.Site
{
    ...
    public class AddressModelJsonConverter : JsonConverter<AddressModel>
    {
        ...
        public override AddressModel Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            //2return new AddressModel(additional01, additional02, city, companyName, contactId, countryIso, district, federalState, firstName, houseNumber, lastName, latitude, longitude, street, zipcode);
            return new AddressModel(additional01, additional02, city, companyName, contactId, countryIso, district, federalState, firstName, houseNumber, lastName, latitude, longitude, street, zipcode);
        }
