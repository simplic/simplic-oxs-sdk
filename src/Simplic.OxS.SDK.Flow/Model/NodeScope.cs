...
namespace Simplic.OxS.SDK.Flow
{
    ...
    /// NodeScope
    /// </summary>
    [DataContract(Name = "NodeScope")]
    public partial class NodeScope : IEquatable<NodeScope>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as NodeScope);
        }

        /// <summary>
        /// Returns true if NodeScope instances are equal
        /// </summary>
        /// <param name="input">Instance of NodeScope to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NodeScope input)
        {
            if (input == null)
            {
                return false;
