...
namespace Simplic.OxS.SDK.Flow
{
    ...
    /// AwsCredentials
    /// </summary>
    [DataContract(Name = "AwsCredentials")]
    public partial class AwsCredentials : IEquatable<AwsCredentials>, IValidatableObject
    {
        /// <summary>
        ...
        public AwsCredentials(string key = default(string), string secret = default(string))
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for AwsCredentials and cannot be null");
            }
            this.Key = key;
            // to ensure "secret" is required (not null)
            if (secret == null)
            {
                throw new ArgumentNullException("secret is a required property for AwsCredentials and cannot be null");
            }
            this.Secret = secret;
        }
