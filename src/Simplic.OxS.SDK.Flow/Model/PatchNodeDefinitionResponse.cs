...
{
    /// <summary>
    /// PatchNodeDefinitionResponse
    /// </summary>
    [DataContract(Name = "PatchNodeDefinitionResponse")]
    public partial class PatchNodeDefinitionResponse : IEquatable<PatchNodeDefinitionResponse>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PatchNodeDefinitionResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PatchNodeDefinitionResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PatchNodeDefinitionResponse" /> class.
        /// </summary>
        ...
        public PatchNodeDefinitionResponse(Guid id = default(Guid), string definitionId = default(string), TypeEnum type = default(TypeEnum), string eventName = default(string), string displayName = default(string), string displayKey = default(string), string description = default(string), string category = default(string), string markdown = default(string), NodeDefinitionTarget target = default(NodeDefinitionTarget), string deploymentHook = default(string), CustomDataInPinTemplateDefinition customDataInPinTemplate = default(CustomDataInPinTemplateDefinition), CustomFlowOutPinTemplateDefinition customFlowOutPinTemplate = default(CustomFlowOutPinTemplateDefinition), List<DataInPinDefinition> dataInPins = default(List<DataInPinDefinition>), List<DataOutPinDefinition> dataOutPins = default(List<DataOutPinDefinition>), List<FlowOutPinDefinition> flowOutPins = default(List<FlowOutPinDefinition>), NodePackageResponse package = default(NodePackageResponse))
        {
            ...
            if (markdown == null)
            {
                throw new ArgumentNullException("markdown is a required property for PatchNodeDefinitionResponse and cannot be null");
            }
            ...
            if (package == null)
            {
                throw new ArgumentNullException("package is a required property for PatchNodeDefinitionResponse and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PatchNodeDefinitionResponse {\n");
        ...
        {
            return this.Equals(input as PatchNodeDefinitionResponse);
        }

        /// <summary>
        /// Returns true if PatchNodeDefinitionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PatchNodeDefinitionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PatchNodeDefinitionResponse input)
        {
            if (input == null)
            {
                return false;
