...
{
    /// <summary>
    /// PutNodeDefinitionRequest
    /// </summary>
    [DataContract(Name = "PutNodeDefinitionRequest")]
    public partial class PutNodeDefinitionRequest : IEquatable<PutNodeDefinitionRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PutNodeDefinitionRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PutNodeDefinitionRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PutNodeDefinitionRequest" /> class.
        /// </summary>
        ...
        public PutNodeDefinitionRequest(string id = default(string), NodeDefinitionType type = default(NodeDefinitionType), string eventName = default(string), string displayName = default(string), string displayKey = default(string), string description = default(string), string markdown = default(string), NodeDefinitionTarget target = default(NodeDefinitionTarget), CustomDataInPinTemplateDefinition customDataInPinTemplate = default(CustomDataInPinTemplateDefinition), CustomFlowOutPinTemplateDefinition customFlowOutPinTemplate = default(CustomFlowOutPinTemplateDefinition), List<DataInPinDefinition> dataInPins = default(List<DataInPinDefinition>), List<DataOutPinDefinition> dataOutPins = default(List<DataOutPinDefinition>), List<FlowOutPinDefinition> flowOutPins = default(List<FlowOutPinDefinition>), NodePackageRequest package = default(NodePackageRequest))
        {
            ...
            if (markdown == null)
            {
                throw new ArgumentNullException("markdown is a required property for PutNodeDefinitionRequest and cannot be null");
            }
            ...
            if (package == null)
            {
                throw new ArgumentNullException("package is a required property for PutNodeDefinitionRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PutNodeDefinitionRequest {\n");
        ...
        {
            return this.Equals(input as PutNodeDefinitionRequest);
        }

        /// <summary>
        /// Returns true if PutNodeDefinitionRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PutNodeDefinitionRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PutNodeDefinitionRequest input)
        {
            if (input == null)
            {
                return false;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if (this.Markdown != null && this.Markdown.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Markdown, length must be greater than 1.", new [] { "Markdown" });
            }
