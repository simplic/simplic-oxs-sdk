...
{
    /// <summary>
    /// PostNodeDefinitionRequest
    /// </summary>
    [DataContract(Name = "PostNodeDefinitionRequest")]
    public partial class PostNodeDefinitionRequest : IEquatable<PostNodeDefinitionRequest>, IValidatableObject
    {
        ...
        public PostNodeDefinitionRequest(string id = default(string), NodeDefinitionType type = default(NodeDefinitionType), string eventName = default(string), string displayName = default(string), string displayKey = default(string), string description = default(string), string markdown = default(string), NodeDefinitionTarget target = default(NodeDefinitionTarget), CustomDataInPinTemplateDefinition customDataInPinTemplate = default(CustomDataInPinTemplateDefinition), CustomFlowOutPinTemplateDefinition customFlowOutPinTemplate = default(CustomFlowOutPinTemplateDefinition), List<DataInPinDefinition> dataInPins = default(List<DataInPinDefinition>), List<DataOutPinDefinition> dataOutPins = default(List<DataOutPinDefinition>), List<FlowOutPinDefinition> flowOutPins = default(List<FlowOutPinDefinition>), NodePackageRequest package = default(NodePackageRequest))
        {
            ...
            if (markdown == null)
            {
                throw new ArgumentNullException("markdown is a required property for PostNodeDefinitionRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as PostNodeDefinitionRequest);
        }

        /// <summary>
        /// Returns true if PostNodeDefinitionRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PostNodeDefinitionRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostNodeDefinitionRequest input)
        {
            if (input == null)
            {
                return false;
