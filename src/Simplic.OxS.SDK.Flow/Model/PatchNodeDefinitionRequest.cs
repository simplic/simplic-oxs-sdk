...
{
    /// <summary>
    /// PatchNodeDefinitionRequest
    /// </summary>
    [DataContract(Name = "PatchNodeDefinitionRequest")]
    public partial class PatchNodeDefinitionRequest : IEquatable<PatchNodeDefinitionRequest>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// </summary>
        [DataMember(Name = "markdown", EmitDefaultValue = true)]
        ...
        public PatchNodePackageRequest Package { get; set; }
        ...
        {
            return this.Equals(input as PatchNodeDefinitionRequest);
        }

        /// <summary>
        /// Returns true if PatchNodeDefinitionRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PatchNodeDefinitionRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PatchNodeDefinitionRequest input)
        {
            if (input == null)
            {
                return false;
