...
namespace Simplic.OxS.SDK.Flow
{
    ...
    public partial class PostFlowResponse : IEquatable<PostFlowResponse>, IValidatableObject
    {
        ...
        public PostFlowResponse(Guid id = default(Guid), string name = default(string), string description = default(string), List<NodeInstance> nodes = default(List<NodeInstance>), List<FlowVariableInstance> variables = default(List<FlowVariableInstance>))
        {
            this.Id = id;
            this.Name = name;
