...
{
    /// <summary>
    /// PutNodeDefinitionResponse
    /// </summary>
    [DataContract(Name = "PutNodeDefinitionResponse")]
    public partial class PutNodeDefinitionResponse : IEquatable<PutNodeDefinitionResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PutNodeDefinitionResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PutNodeDefinitionResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PutNodeDefinitionResponse" /> class.
        /// </summary>
        ...
        public PutNodeDefinitionResponse(string id = default(string), string type = default(string), string eventName = default(string), string name = default(string), string description = default(string), string markdown = default(string), string target = default(string), CustomDataInPinTemplateDefinition customDataInPinTemplate = default(CustomDataInPinTemplateDefinition), CustomFlowOutPinTemplateDefinition customFlowOutPinTemplate = default(CustomFlowOutPinTemplateDefinition), List<DataInPinDefinition> dataInPins = default(List<DataInPinDefinition>), List<DataOutPinDefinition> dataOutPins = default(List<DataOutPinDefinition>), List<FlowOutPinDefinition> flowOutPins = default(List<FlowOutPinDefinition>), PackageResponse package = default(PackageResponse))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for PutNodeDefinitionResponse and cannot be null");
            }
            this.Id = id;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for PutNodeDefinitionResponse and cannot be null");
            }
            this.Type = type;
            // to ensure "markdown" is required (not null)
            if (markdown == null)
            {
                throw new ArgumentNullException("markdown is a required property for PutNodeDefinitionResponse and cannot be null");
            }
            this.Markdown = markdown;
            // to ensure "target" is required (not null)
            if (target == null)
            {
                throw new ArgumentNullException("target is a required property for PutNodeDefinitionResponse and cannot be null");
            }
            this.Target = target;
            // to ensure "package" is required (not null)
            if (package == null)
            {
                throw new ArgumentNullException("package is a required property for PutNodeDefinitionResponse and cannot be null");
            }
        ...
        {
            return this.Equals(input as PutNodeDefinitionResponse);
        }

        /// <summary>
        /// Returns true if PutNodeDefinitionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PutNodeDefinitionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PutNodeDefinitionResponse input)
        {
            if (input == null)
            {
                return false;
