...
namespace Simplic.OxS.SDK.Vehicle
{
    ...
    public class InternalVehicleClient : IInternalVehicleClient
    {
        ...
        public new VehicleModel Get(Guid? id = default(Guid?), int operationIndex = 0)
        {
            try
            {
        ...
        public new Simplic.OxS.SDK.ApiResponse<VehicleModel> GetWithHttpInfo(Guid? id = default(Guid?), int operationIndex = 0)
        {
            try
            {
        ...
        public new System.Threading.Tasks.Task<VehicleModel> GetAsync(Guid? id = default(Guid?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            try
            {
        ...
        public new System.Threading.Tasks.Task<Simplic.OxS.SDK.ApiResponse<VehicleModel>> GetWithHttpInfoAsync(Guid? id = default(Guid?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            try
            {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    internal partial class __InternalVehicleClient : IInternalVehicleClient
    {
        private Simplic.OxS.SDK.ExceptionFactory _exceptionFactory = (name, response) => null;
