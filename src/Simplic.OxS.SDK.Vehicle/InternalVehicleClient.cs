...
namespace Simplic.OxS.SDK.Vehicle
{
    ...
    public partial class InternalVehicleClient : IInternalVehicleClient
    {
        ...
        /// <returns></returns>
        public InternalVehicleClient(Simplic.OxS.SDK.Configuration configuration)
        {
        ...
        public InternalVehicleClient(Simplic.OxS.SDK.ISynchronousClient client, Simplic.OxS.SDK.IAsynchronousClient asyncClient, Simplic.OxS.SDK.IReadableConfiguration configuration)
        {
