...
namespace Simplic.OxS.SDK.Vehicle
{
    ...
    /// VehicleApiKeyModel
    /// </summary>
    [DataContract(Name = "VehicleApiKeyModel")]
    public partial class VehicleApiKeyModel : IEquatable<VehicleApiKeyModel>, IValidatableObject
    {
        /// <summary>
        ...
        public VehicleApiKeyModel(Guid id = default(Guid), bool isDeleted = default(bool), DateTime createDateTime = default(DateTime), Guid? createUserId = default(Guid?), string createUserName = default(string), DateTime updateDateTime = default(DateTime), Guid? updateUserId = default(Guid?), string updateUserName = default(string), Guid vehicleId = default(Guid), string apiKey = default(string))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as VehicleApiKeyModel);
        }

        /// <summary>
        /// Returns true if VehicleApiKeyModel instances are equal
        /// </summary>
        /// <param name="input">Instance of VehicleApiKeyModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VehicleApiKeyModel input)
        {
            if (input == null)
            {
                return false;
