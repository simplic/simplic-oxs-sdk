...
namespace Simplic.OxS.SDK.Vehicle
{
    ...
    /// </summary>
    public partial class CreateVehicleRequest : IValidatableObject
    {
    ...
    /// <summary>
    /// A Json converter for type <see cref="CreateVehicleRequest" />
    /// </summary>
    public class CreateVehicleRequestJsonConverter : JsonConverter<CreateVehicleRequest>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="CreateVehicleRequest" />
        /// </summary>
        ...
        public override CreateVehicleRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (additionalTechnicalData.IsSet && additionalTechnicalData.Value == null)
                throw new ArgumentNullException(nameof(additionalTechnicalData), "Property is not nullable for class CreateVehicleRequest.");

            if (department.IsSet && department.Value == null)
                throw new ArgumentNullException(nameof(department), "Property is not nullable for class CreateVehicleRequest.");

            if (registrationCertificate.IsSet && registrationCertificate.Value == null)
                throw new ArgumentNullException(nameof(registrationCertificate), "Property is not nullable for class CreateVehicleRequest.");

            if (registrationDocumentLocation.IsSet && registrationDocumentLocation.Value == null)
                throw new ArgumentNullException(nameof(registrationDocumentLocation), "Property is not nullable for class CreateVehicleRequest.");

            if (registrationPlate.IsSet && registrationPlate.Value == null)
                throw new ArgumentNullException(nameof(registrationPlate), "Property is not nullable for class CreateVehicleRequest.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class CreateVehicleRequest.");

            if (toll.IsSet && toll.Value == null)
                throw new ArgumentNullException(nameof(toll), "Property is not nullable for class CreateVehicleRequest.");

            if (vehicleTypeSubType.IsSet && vehicleTypeSubType.Value == null)
                throw new ArgumentNullException(nameof(vehicleTypeSubType), "Property is not nullable for class CreateVehicleRequest.");

            //2return new CreateVehicleRequest(additionalTechnicalData, department, dispositionSortingKey, fuelTankCapacity, isSystemVehicle, loadingSlots, location, matchCode, mileage, mileageDate, operatingHours, qrCode, registrationCertificate, registrationDocument, registrationDocumentLocation, registrationPlate, remark, status, toll, usableUntil, vehicleRegistration, vehicleTypeSubType, yearOfManufacturing);
            return new CreateVehicleRequest(additionalTechnicalData, department, dispositionSortingKey, fuelTankCapacity, isSystemVehicle, loadingSlots, location, matchCode, mileage, mileageDate, operatingHours, qrCode, registrationCertificate, registrationDocument, registrationDocumentLocation, registrationPlate, remark, status, toll, usableUntil, vehicleRegistration, vehicleTypeSubType, yearOfManufacturing);
        }

        /// <summary>
        /// Serializes a <see cref="CreateVehicleRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="createVehicleRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CreateVehicleRequest createVehicleRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(ref writer, createVehicleRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CreateVehicleRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="createVehicleRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(ref Utf8JsonWriter writer, CreateVehicleRequest createVehicleRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (createVehicleRequest.AdditionalTechnicalDataOption.IsSet && createVehicleRequest.AdditionalTechnicalData == null)
                throw new ArgumentNullException(nameof(createVehicleRequest.AdditionalTechnicalData), "Property is required for class CreateVehicleRequest.");

            if (createVehicleRequest.DepartmentOption.IsSet && createVehicleRequest.Department == null)
                throw new ArgumentNullException(nameof(createVehicleRequest.Department), "Property is required for class CreateVehicleRequest.");

            if (createVehicleRequest.RegistrationCertificateOption.IsSet && createVehicleRequest.RegistrationCertificate == null)
                throw new ArgumentNullException(nameof(createVehicleRequest.RegistrationCertificate), "Property is required for class CreateVehicleRequest.");

            if (createVehicleRequest.RegistrationDocumentLocationOption.IsSet && createVehicleRequest.RegistrationDocumentLocation == null)
                throw new ArgumentNullException(nameof(createVehicleRequest.RegistrationDocumentLocation), "Property is required for class CreateVehicleRequest.");

            if (createVehicleRequest.RegistrationPlateOption.IsSet && createVehicleRequest.RegistrationPlate == null)
                throw new ArgumentNullException(nameof(createVehicleRequest.RegistrationPlate), "Property is required for class CreateVehicleRequest.");

            if (createVehicleRequest.StatusOption.IsSet && createVehicleRequest.Status == null)
                throw new ArgumentNullException(nameof(createVehicleRequest.Status), "Property is required for class CreateVehicleRequest.");

            if (createVehicleRequest.TollOption.IsSet && createVehicleRequest.Toll == null)
                throw new ArgumentNullException(nameof(createVehicleRequest.Toll), "Property is required for class CreateVehicleRequest.");

            if (createVehicleRequest.VehicleTypeSubTypeOption.IsSet && createVehicleRequest.VehicleTypeSubType == null)
                throw new ArgumentNullException(nameof(createVehicleRequest.VehicleTypeSubType), "Property is required for class CreateVehicleRequest.");

            if (createVehicleRequest.AdditionalTechnicalDataOption.IsSet)
            {
                writer.WritePropertyName("additionalTechnicalData");
                JsonSerializer.Serialize(writer, createVehicleRequest.AdditionalTechnicalData, jsonSerializerOptions);
            }
            if (createVehicleRequest.DepartmentOption.IsSet)
            {
                writer.WritePropertyName("department");
                JsonSerializer.Serialize(writer, createVehicleRequest.Department, jsonSerializerOptions);
            }
            if (createVehicleRequest.DispositionSortingKeyOption.IsSet)
                if (createVehicleRequest.DispositionSortingKeyOption.Value != null)
                {
                    writer.WriteString("dispositionSortingKey", createVehicleRequest.DispositionSortingKey);
                    //var __value = createVehicleRequest.DispositionSortingKeyOption.Value;
                    //writer.WriteString("dispositionSortingKey", __value);
                }
                else
                    writer.WriteNull("dispositionSortingKey");

            if (createVehicleRequest.FuelTankCapacityOption.IsSet)
                if (createVehicleRequest.FuelTankCapacityOption.Value != null)
                {
                    writer.WriteNumber("fuelTankCapacity", createVehicleRequest.FuelTankCapacityOption!.Value);
                    //var __value = createVehicleRequest.FuelTankCapacityOption.Value;
                    //writer.WriteString("fuelTankCapacity", __value);
                }
                else
                    writer.WriteNull("fuelTankCapacity");

            if (createVehicleRequest.IsSystemVehicleOption.IsSet)
                if (createVehicleRequest.IsSystemVehicleOption.Value != null)
                {
                    writer.WriteBoolean("isSystemVehicle", createVehicleRequest.IsSystemVehicleOption!.Value);
                    //var __value = createVehicleRequest.IsSystemVehicleOption.Value;
                    //writer.WriteString("isSystemVehicle", __value);
                }
                else
                    writer.WriteNull("isSystemVehicle");

            if (createVehicleRequest.LoadingSlotsOption.IsSet)
                if (createVehicleRequest.LoadingSlotsOption.Value != null)
                {
                    writer.WritePropertyName("loadingSlots");
                    JsonSerializer.Serialize(writer, createVehicleRequest.LoadingSlots, jsonSerializerOptions);
                }
                else
                    writer.WriteNull("loadingSlots");
            if (createVehicleRequest.LocationOption.IsSet)
                if (createVehicleRequest.LocationOption.Value != null)
                {
                    writer.WriteString("location", createVehicleRequest.Location);
                    //var __value = createVehicleRequest.LocationOption.Value;
                    //writer.WriteString("location", __value);
                }
                else
                    writer.WriteNull("location");

            if (createVehicleRequest.MatchCodeOption.IsSet)
                if (createVehicleRequest.MatchCodeOption.Value != null)
                {
                    writer.WriteString("matchCode", createVehicleRequest.MatchCode);
                    //var __value = createVehicleRequest.MatchCodeOption.Value;
                    //writer.WriteString("matchCode", __value);
                }
                else
                    writer.WriteNull("matchCode");

            if (createVehicleRequest.MileageOption.IsSet)
                if (createVehicleRequest.MileageOption.Value != null)
                {
                    writer.WriteNumber("mileage", createVehicleRequest.MileageOption!.Value);
                    //var __value = createVehicleRequest.MileageOption.Value;
                    //writer.WriteString("mileage", __value);
                }
                else
                    writer.WriteNull("mileage");

            if (createVehicleRequest.MileageDateOption.IsSet)
                if (createVehicleRequest.MileageDateOption.Value != null)
                {
                    writer.WriteString("mileageDate", createVehicleRequest.MileageDateOption!.Value.ToString(MileageDateFormat));
                    //var __value = createVehicleRequest.MileageDateOption.Value;
                    //writer.WriteString("mileageDate", __value);
                }
                else
                    writer.WriteNull("mileageDate");

            if (createVehicleRequest.OperatingHoursOption.IsSet)
                if (createVehicleRequest.OperatingHoursOption.Value != null)
                {
                    writer.WriteNumber("operatingHours", createVehicleRequest.OperatingHoursOption!.Value);
                    //var __value = createVehicleRequest.OperatingHoursOption.Value;
                    //writer.WriteString("operatingHours", __value);
                }
                else
                    writer.WriteNull("operatingHours");

            if (createVehicleRequest.QrCodeOption.IsSet)
                if (createVehicleRequest.QrCodeOption.Value != null)
                {
                    writer.WriteString("qrCode", createVehicleRequest.QrCode);
                    //var __value = createVehicleRequest.QrCodeOption.Value;
                    //writer.WriteString("qrCode", __value);
                }
                else
                    writer.WriteNull("qrCode");

            if (createVehicleRequest.RegistrationCertificateOption.IsSet)
            {
                writer.WritePropertyName("registrationCertificate");
                JsonSerializer.Serialize(writer, createVehicleRequest.RegistrationCertificate, jsonSerializerOptions);
            }
            if (createVehicleRequest.RegistrationDocumentOption.IsSet)
                if (createVehicleRequest.RegistrationDocumentOption.Value != null)
                {
                    writer.WriteString("registrationDocument", createVehicleRequest.RegistrationDocument);
                    //var __value = createVehicleRequest.RegistrationDocumentOption.Value;
                    //writer.WriteString("registrationDocument", __value);
                }
                else
                    writer.WriteNull("registrationDocument");

            if (createVehicleRequest.RegistrationDocumentLocationOption.IsSet)
            {
                writer.WritePropertyName("registrationDocumentLocation");
                JsonSerializer.Serialize(writer, createVehicleRequest.RegistrationDocumentLocation, jsonSerializerOptions);
            }
            if (createVehicleRequest.RegistrationPlateOption.IsSet)
            {
                writer.WritePropertyName("registrationPlate");
                JsonSerializer.Serialize(writer, createVehicleRequest.RegistrationPlate, jsonSerializerOptions);
            }
            if (createVehicleRequest.RemarkOption.IsSet)
                if (createVehicleRequest.RemarkOption.Value != null)
                {
                    writer.WriteString("remark", createVehicleRequest.Remark);
                    //var __value = createVehicleRequest.RemarkOption.Value;
                    //writer.WriteString("remark", __value);
                }
                else
                    writer.WriteNull("remark");

            if (createVehicleRequest.StatusOption.IsSet)
            {
                writer.WritePropertyName("status");
                JsonSerializer.Serialize(writer, createVehicleRequest.Status, jsonSerializerOptions);
            }
            if (createVehicleRequest.TollOption.IsSet)
            {
                writer.WritePropertyName("toll");
                JsonSerializer.Serialize(writer, createVehicleRequest.Toll, jsonSerializerOptions);
            }
            if (createVehicleRequest.UsableUntilOption.IsSet)
                if (createVehicleRequest.UsableUntilOption.Value != null)
                {
                    writer.WriteString("usableUntil", createVehicleRequest.UsableUntilOption!.Value.ToString(UsableUntilFormat));
                    //var __value = createVehicleRequest.UsableUntilOption.Value;
                    //writer.WriteString("usableUntil", __value);
                }
                else
                    writer.WriteNull("usableUntil");

            if (createVehicleRequest.VehicleRegistrationOption.IsSet)
                if (createVehicleRequest.VehicleRegistrationOption.Value != null)
                {
                    writer.WriteString("vehicleRegistration", createVehicleRequest.VehicleRegistration);
                    //var __value = createVehicleRequest.VehicleRegistrationOption.Value;
                    //writer.WriteString("vehicleRegistration", __value);
                }
                else
                    writer.WriteNull("vehicleRegistration");

            if (createVehicleRequest.VehicleTypeSubTypeOption.IsSet)
            {
                writer.WritePropertyName("vehicleTypeSubType");
                JsonSerializer.Serialize(writer, createVehicleRequest.VehicleTypeSubType, jsonSerializerOptions);
            }
            if (createVehicleRequest.YearOfManufacturingOption.IsSet)
                if (createVehicleRequest.YearOfManufacturingOption.Value != null)
                {
                    writer.WriteString("yearOfManufacturing", createVehicleRequest.YearOfManufacturingOption!.Value.ToString(YearOfManufacturingFormat));
                    //var __value = createVehicleRequest.YearOfManufacturingOption.Value;
