...
namespace Simplic.OxS.SDK.Vehicle
{
    ...
    /// VehicleStatusModel
    /// </summary>
    [DataContract(Name = "VehicleStatusModel")]
    public partial class VehicleStatusModel : IEquatable<VehicleStatusModel>, IValidatableObject
    {
        /// <summary>
        ...
        public VehicleStatusModel(string name = default(string), bool? isSelectable = default(bool?), Guid organizationId = default(Guid), bool isDeleted = default(bool), Guid id = default(Guid), DateTime createDateTime = default(DateTime), Guid? createUserId = default(Guid?), string createUserName = default(string), DateTime updateDateTime = default(DateTime), Guid? updateUserId = default(Guid?), string updateUserName = default(string))
        {
            this.Name = name;
        ...
        {
            return this.Equals(input as VehicleStatusModel);
        }

        /// <summary>
        /// Returns true if VehicleStatusModel instances are equal
        /// </summary>
        /// <param name="input">Instance of VehicleStatusModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VehicleStatusModel input)
        {
            if (input == null)
            {
                return false;
