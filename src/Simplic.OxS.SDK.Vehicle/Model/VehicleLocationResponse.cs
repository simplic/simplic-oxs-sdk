...
namespace Simplic.OxS.SDK.Vehicle
{
    ...
    /// </summary>
    [DataContract(Name = "VehicleLocationResponse")]
    public partial class VehicleLocationResponse : IEquatable<VehicleLocationResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VehicleLocationResponse" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VehicleLocationResponse {\n");
        ...
        {
            return this.Equals(input as VehicleLocationResponse);
        }

        /// <summary>
        /// Returns true if VehicleLocationResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of VehicleLocationResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VehicleLocationResponse input)
        {
            if (input == null)
            {
                return false;
