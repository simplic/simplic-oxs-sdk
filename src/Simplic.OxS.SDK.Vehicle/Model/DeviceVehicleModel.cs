...
namespace Simplic.OxS.SDK.Vehicle
{
    ...
    /// DeviceVehicleModel
    /// </summary>
    [DataContract(Name = "DeviceVehicleModel")]
    public partial class DeviceVehicleModel : IEquatable<DeviceVehicleModel>, IValidatableObject
    {
        /// <summary>
        ...
        public DeviceVehicleModel(Guid id = default(Guid), string matchCode = default(string), string registrationPlate = default(string), string type = default(string))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as DeviceVehicleModel);
        }

        /// <summary>
        /// Returns true if DeviceVehicleModel instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceVehicleModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceVehicleModel input)
        {
            if (input == null)
            {
                return false;
