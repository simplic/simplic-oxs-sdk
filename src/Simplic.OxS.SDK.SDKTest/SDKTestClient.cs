...
namespace Simplic.OxS.SDK.SDKTest
{
    ...
    public class SDKTestClient : ISDKTestClient
    {
        ...
        public SDKTestClient(string host, string? authorization = null)
        {
            ...
            {
                _internalClient = new __SDKTestClient(new Configuration
                {
                    BasePath = $"{host}/./test/sdk-test-swagger.json-api/v1",
    ...
    /// </summary>
    public interface ISDKTestClientSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ISDKTestClientAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ISDKTestClient : ISDKTestClientSync, ISDKTestClientAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    internal partial class __SDKTestClient : ISDKTestClient
    {
        private Simplic.OxS.SDK.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="__SDKTestClient"/> class.
        /// </summary>
        /// <returns></returns>
        public __SDKTestClient() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public __SDKTestClient(string basePath)
        {
        ...
        /// <returns></returns>
        public __SDKTestClient(Simplic.OxS.SDK.Configuration configuration)
        {
        ...
        public __SDKTestClient(Simplic.OxS.SDK.ISynchronousClient client, Simplic.OxS.SDK.IAsynchronousClient asyncClient, Simplic.OxS.SDK.IReadableConfiguration configuration)
        {
