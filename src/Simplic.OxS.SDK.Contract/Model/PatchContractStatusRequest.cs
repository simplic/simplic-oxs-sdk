...
{
    /// <summary>
    /// PatchContractStatusRequest
    /// </summary>
    [DataContract(Name = "PatchContractStatusRequest")]
    public partial class PatchContractStatusRequest : IEquatable<PatchContractStatusRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PatchContractStatusRequest {\n");
        ...
        {
            return this.Equals(input as PatchContractStatusRequest);
        }

        /// <summary>
        /// Returns true if PatchContractStatusRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PatchContractStatusRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PatchContractStatusRequest input)
        {
            if (input == null)
            {
                return false;
