...
namespace Simplic.OxS.SDK.Contract
{
    ...
    public partial class ExternalOrderingConstructionSiteModel : IEquatable<ExternalOrderingConstructionSiteModel>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExternalOrderingConstructionSiteModel {\n");
        ...
        {
            return this.Equals(input as ExternalOrderingConstructionSiteModel);
        }

        /// <summary>
        /// Returns true if ExternalOrderingConstructionSiteModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ExternalOrderingConstructionSiteModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExternalOrderingConstructionSiteModel input)
        {
            if (input == null)
            {
                return false;
