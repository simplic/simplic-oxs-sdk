...
namespace Simplic.OxS.SDK.Contract
{
    ...
    /// </summary>
    [DataContract(Name = "OrderItemRequestModel")]
    public partial class OrderItemRequestModel : IEquatable<OrderItemRequestModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderItemRequestModel" /> class.
        /// </summary>
        ...
        /// <param name="articleId">Gets or sets the id of the article.  If set, the article will be resolved and override Simplic.OxS.Contract.Server.Model.OrderItemRequestModel.ArticleName..</param>
        ...
        /// <summary>
        /// Gets or sets the id of the article.  If set, the article will be resolved and override Simplic.OxS.Contract.Server.Model.OrderItemRequestModel.ArticleName.
        /// </summary>
        /// <value>Gets or sets the id of the article.  If set, the article will be resolved and override Simplic.OxS.Contract.Server.Model.OrderItemRequestModel.ArticleName.</value>
        ...
        public QuantityRequest TransportationQuantity { get; set; }
        ...
        public QuantityRequest BookedQuantity { get; set; }
        ...
        /// <summary>
        /// Gets or sets the id of the unit the price refers to.
        /// </summary>
        /// <value>Gets or sets the id of the unit the price refers to.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OrderItemRequestModel {\n");
        ...
        {
            return this.Equals(input as OrderItemRequestModel);
        }

        /// <summary>
        /// Returns true if OrderItemRequestModel instances are equal
        /// </summary>
        /// <param name="input">Instance of OrderItemRequestModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderItemRequestModel input)
        {
            if (input == null)
            {
                return false;
