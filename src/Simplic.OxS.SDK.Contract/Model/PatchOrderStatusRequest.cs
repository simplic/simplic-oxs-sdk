...
namespace Simplic.OxS.SDK.Contract
{
    ...
    /// </summary>
    [DataContract(Name = "PatchOrderStatusRequest")]
    public partial class PatchOrderStatusRequest : IEquatable<PatchOrderStatusRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PatchOrderStatusRequest" /> class.
        /// </summary>
        ...
        public PatchOrderStatusRequest(string name = default(string), string number = default(string), List<string> roles = default(List<string>), int index = default(int), string hexCode = default(string), string resolver = default(string))
        {
            this.Name = name;
            this.Number = number;
            this.Roles = roles;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PatchOrderStatusRequest {\n");
        ...
        {
            return this.Equals(input as PatchOrderStatusRequest);
        }

        /// <summary>
        /// Returns true if PatchOrderStatusRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PatchOrderStatusRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PatchOrderStatusRequest input)
        {
            if (input == null)
            {
                return false;
