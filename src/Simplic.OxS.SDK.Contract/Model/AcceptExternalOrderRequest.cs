...
namespace Simplic.OxS.SDK.Contract
{
    ...
    public partial class AcceptExternalOrderRequest : IEquatable<AcceptExternalOrderRequest>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AcceptExternalOrderRequest {\n");
        ...
        {
            return this.Equals(input as AcceptExternalOrderRequest);
        }

        /// <summary>
        /// Returns true if AcceptExternalOrderRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AcceptExternalOrderRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AcceptExternalOrderRequest input)
        {
            if (input == null)
            {
                return false;
