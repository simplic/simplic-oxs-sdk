...
namespace Simplic.OxS.SDK.Contract
{
    ...
    public partial class QuantityUnitModel : IEquatable<QuantityUnitModel>, IValidatableObject
    {
        ...
        public QuantityUnitModel(Guid guid = default(Guid), int ident = default(int), string name = default(string), string shortName = default(string), int? digits = default(int?))
        {
            this.Guid = guid;
            this.Ident = ident;
            this.Name = name;
