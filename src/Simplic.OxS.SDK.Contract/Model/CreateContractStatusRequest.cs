...
namespace Simplic.OxS.SDK.Contract
{
    ...
    /// </summary>
    [DataContract(Name = "CreateContractStatusRequest")]
    public partial class CreateContractStatusRequest : IEquatable<CreateContractStatusRequest>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CreateContractStatusRequest);
        }

        /// <summary>
        /// Returns true if CreateContractStatusRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateContractStatusRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateContractStatusRequest input)
        {
            if (input == null)
            {
                return false;
