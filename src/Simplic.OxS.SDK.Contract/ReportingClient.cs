...
namespace Simplic.OxS.SDK.Contract
{
    ...
    public class ReportingClient : IReportingClient
    {
        ...
        public new ContractReportModel Get(Guid id, int operationIndex = 0)
        {
            try
            {
        ...
        public new Simplic.OxS.SDK.ApiResponse<ContractReportModel> GetWithHttpInfo(Guid id, int operationIndex = 0)
        {
            try
            {
        ...
        public new System.Threading.Tasks.Task<ContractReportModel> GetAsync(Guid id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            try
            {
        ...
        public new System.Threading.Tasks.Task<Simplic.OxS.SDK.ApiResponse<ContractReportModel>> GetWithHttpInfoAsync(Guid id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            try
            {
