...
namespace Simplic.OxS.SDK.Auth
{
    ...
    public partial class HookDefinitionClient : IHookDefinitionClient
    {
        ...
        /// <returns></returns>
        public HookDefinitionClient(Simplic.OxS.SDK.Auth.Configuration configuration)
        {
        ...
        public HookDefinitionClient(Simplic.OxS.SDK.Auth.ISynchronousClient client, Simplic.OxS.SDK.Auth.IAsynchronousClient asyncClient, Simplic.OxS.SDK.Auth.IReadableConfiguration configuration)
        {
        ...
        {
            Simplic.OxS.SDK.Auth.ApiResponse<HookDefinitionResponse> localVarResponse = GetWithHttpInfo();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of HookDefinitionResponse</returns>
        public Simplic.OxS.SDK.Auth.ApiResponse<HookDefinitionResponse> GetWithHttpInfo(int operationIndex = 0)
        {
        ...
        {
            Simplic.OxS.SDK.Auth.ApiResponse<HookDefinitionResponse> localVarResponse = await GetWithHttpInfoAsync(operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (HookDefinitionResponse)</returns>
        public async System.Threading.Tasks.Task<Simplic.OxS.SDK.Auth.ApiResponse<HookDefinitionResponse>> GetWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
