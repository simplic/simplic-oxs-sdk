...
//: Implementation
    ...
    public class ReportingClient : IReportingClient
    {
        ...
        public TourReportingModel GetByTour(Guid id)
        {
            try
            {
                return _internalClient.GetByTour(id);
            }
        ...
        /// <param name="id">Id of the tour.</param>
        /// <returns>ApiResponse of TourReportingModel</returns>
        public Simplic.OxS.SDK.ApiResponse<TourReportingModel> GetByTourWithHttpInfo(Guid id)
        {
            try
            {
                return _internalClient.GetByTourWithHttpInfo(id);
            }
            catch (ApiException e)
            {
                throw new ApiException(e.ErrorCode, FormatErrorMessage(e.Message, e.ErrorCode), e.ErrorContent, e.Headers);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of TourReportingModel</returns>
        public System.Threading.Tasks.Task<TourReportingModel> GetByTourAsync(Guid id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            try
            {
                return _internalClient.GetByTourAsync(id, cancellationToken: cancellationToken);
            }
            catch (ApiException e)
            {
                throw new ApiException(e.ErrorCode, FormatErrorMessage(e.Message, e.ErrorCode), e.ErrorContent, e.Headers);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (TourReportingModel)</returns>
        public System.Threading.Tasks.Task<Simplic.OxS.SDK.ApiResponse<TourReportingModel>> GetByTourWithHttpInfoAsync(Guid id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            try
            {
                return _internalClient.GetByTourWithHttpInfoAsync(id, cancellationToken: cancellationToken);
            }
            catch (ApiException e)
            {
                throw new ApiException(e.ErrorCode, FormatErrorMessage(e.Message, e.ErrorCode), e.ErrorContent, e.Headers);
