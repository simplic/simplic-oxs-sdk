...
namespace Simplic.OxS.SDK.Logistics
{
    ...
    public partial class ReportingClient : IReportingClient
    {
        ...
        /// <returns></returns>
        public ReportingClient(Simplic.OxS.SDK.Logistics.Configuration configuration)
        {
        ...
        public ReportingClient(Simplic.OxS.SDK.Logistics.ISynchronousClient client, Simplic.OxS.SDK.Logistics.IAsynchronousClient asyncClient, Simplic.OxS.SDK.Logistics.IReadableConfiguration configuration)
        {
        ...
        {
            Simplic.OxS.SDK.Logistics.ApiResponse<TourReportingModel> localVarResponse = GetByTourWithHttpInfo(id);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TourReportingModel</returns>
        public Simplic.OxS.SDK.Logistics.ApiResponse<TourReportingModel> GetByTourWithHttpInfo(Guid id, int operationIndex = 0)
        {
        ...
        {
            Simplic.OxS.SDK.Logistics.ApiResponse<TourReportingModel> localVarResponse = await GetByTourWithHttpInfoAsync(id, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (TourReportingModel)</returns>
        public async System.Threading.Tasks.Task<Simplic.OxS.SDK.Logistics.ApiResponse<TourReportingModel>> GetByTourWithHttpInfoAsync(Guid id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
