...
namespace Simplic.OxS.SDK.Logistics
{
    ...
    public class ReportingClient : IReportingClient
    {
        ...
        public new TourReportingModel GetByTour(Guid id, int operationIndex = 0)
        {
            try
            {
                return _internalClient.GetByTour(id, operationIndex);
            }
        ...
        public new Simplic.OxS.SDK.ApiResponse<TourReportingModel> GetByTourWithHttpInfo(Guid id, int operationIndex = 0)
        {
            try
            {
                return _internalClient.GetByTourWithHttpInfo(id, operationIndex);
            }
            catch (ApiException e)
            {
                throw new ApiException(e.ErrorCode, $"<{(HttpStatusCode)e.ErrorCode}> {e.Message}", e.ErrorContent, e.Headers);
        ...
        public new System.Threading.Tasks.Task<TourReportingModel> GetByTourAsync(Guid id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            try
            {
                return _internalClient.GetByTourAsync(id, operationIndex, cancellationToken);
            }
            catch (ApiException e)
            {
                throw new ApiException(e.ErrorCode, $"<{(HttpStatusCode)e.ErrorCode}> {e.Message}", e.ErrorContent, e.Headers);
        ...
        public new System.Threading.Tasks.Task<Simplic.OxS.SDK.ApiResponse<TourReportingModel>> GetByTourWithHttpInfoAsync(Guid id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            try
            {
                return _internalClient.GetByTourWithHttpInfoAsync(id, operationIndex, cancellationToken);
            }
            catch (ApiException e)
            {
                throw new ApiException(e.ErrorCode, $"<{(HttpStatusCode)e.ErrorCode}> {e.Message}", e.ErrorContent, e.Headers);
