...
//: Implementation
    ...
    public class ShipmentStatusClient : IShipmentStatusClient
    {
        ...
        public ShipmentStatusClient(string host, string? authorization = null)
        {
            ...
            {
                _internalClient = new __ShipmentStatusClient(new Configuration
                {
        ...
        /// <exception cref="Simplic.OxS.SDK.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of List&lt;ShipmentStatusModel&gt;</returns>
        public Simplic.OxS.SDK.ApiResponse<List<ShipmentStatusModel>> GetAllWithHttpInfo()
        {
            try
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;ShipmentStatusModel&gt;</returns>
        public System.Threading.Tasks.Task<List<ShipmentStatusModel>> GetAllAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            try
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;ShipmentStatusModel&gt;)</returns>
        public System.Threading.Tasks.Task<Simplic.OxS.SDK.ApiResponse<List<ShipmentStatusModel>>> GetAllWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            try
            {
        ...
        /// <param name="id">Id of the shipment status.</param>
        /// <returns>ApiResponse of ShipmentStatusModel</returns>
        public Simplic.OxS.SDK.ApiResponse<ShipmentStatusModel> GetWithHttpInfo(Guid id)
        {
            try
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ShipmentStatusModel</returns>
        public System.Threading.Tasks.Task<ShipmentStatusModel> GetAsync(Guid id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            try
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ShipmentStatusModel)</returns>
        public System.Threading.Tasks.Task<Simplic.OxS.SDK.ApiResponse<ShipmentStatusModel>> GetWithHttpInfoAsync(Guid id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            try
            {
...
// ------------------------^ Custom ^------------------------------
    ...
    /// </summary>
    internal interface __IShipmentStatusClientSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    internal interface __IShipmentStatusClientAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    internal interface __IShipmentStatusClient : __IShipmentStatusClientSync, __IShipmentStatusClientAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    internal /*partial*/ class __ShipmentStatusClient : __IShipmentStatusClient
    {
        private Simplic.OxS.SDK.ExceptionFactory _exceptionFactory = (name, response) => null;

        /*
        /// <summary>
        /// Initializes a new instance of the <see cref="__ShipmentStatusClient"/> class.
        /// </summary>
        /// <returns></returns>
        public __ShipmentStatusClient() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public __ShipmentStatusClient(string basePath)
        {
        ...
        */
        ...
        /// <returns></returns>
        public __ShipmentStatusClient(Simplic.OxS.SDK.Configuration configuration)
        {
        ...
        public __ShipmentStatusClient(Simplic.OxS.SDK.ISynchronousClient client, Simplic.OxS.SDK.IAsynchronousClient asyncClient, Simplic.OxS.SDK.IReadableConfiguration configuration)
        {
        ...
        public Simplic.OxS.SDK.ApiResponse<ShipmentStatusModel> PatchWithHttpInfo(Guid id, UpdateShipmentStatusRequest? updateShipmentStatusRequest = default(UpdateShipmentStatusRequest?), int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "ShipmentStatusClient.ShipmentStatusIdPatch";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Patch<ShipmentStatusModel>("/ShipmentStatus/{id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ShipmentStatusIdPatch", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        public async System.Threading.Tasks.Task<Simplic.OxS.SDK.ApiResponse<ShipmentStatusModel>> PatchWithHttpInfoAsync(Guid id, UpdateShipmentStatusRequest? updateShipmentStatusRequest = default(UpdateShipmentStatusRequest?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PatchAsync<ShipmentStatusModel>("/ShipmentStatus/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
