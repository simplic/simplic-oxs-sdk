...
namespace Simplic.OxS.SDK.Logistics
{
    ...
    /// </summary>
    [DataContract(Name = "CreateShipmentStatusRequest")]
    public partial class CreateShipmentStatusRequest : IEquatable<CreateShipmentStatusRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public CreateShipmentStatusRequest(string name = default(string), string number = default(string), List<string> roles = default(List<string>), string hexColor = default(string), int orderNr = default(int), string resolver = default(string))
        {
            this.Name = name;
            this.Number = number;
            this.Roles = roles;
        ...
        {
            return this.Equals(input as CreateShipmentStatusRequest);
        }

        /// <summary>
        /// Returns true if CreateShipmentStatusRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateShipmentStatusRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateShipmentStatusRequest input)
        {
            if (input == null)
            {
                return false;
