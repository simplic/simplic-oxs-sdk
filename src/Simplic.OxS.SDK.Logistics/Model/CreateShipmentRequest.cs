...
namespace Simplic.OxS.SDK.Logistics
{
    ...
    public partial class CreateShipmentRequest : IEquatable<CreateShipmentRequest>, IValidatableObject
    {
        ...
        /// <param name="statusId">Gets or sets the shipment status.     The status might forbid some actions for the user. Or might enable other actions.  .</param>
        ...
        /// <summary>
        /// Gets or sets the shipment status.     The status might forbid some actions for the user. Or might enable other actions.  
        /// </summary>
        /// <value>Gets or sets the shipment status.     The status might forbid some actions for the user. Or might enable other actions.  </value>
