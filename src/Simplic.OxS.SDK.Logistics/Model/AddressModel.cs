...
namespace Simplic.OxS.SDK.Logistics
{
    ...
    public partial class AddressModel : IValidatableObject
    {
        ...
        /// <param name="contactId">Gets or sets the contact guid.</param>
        ...
        /// <param name="isDeleted">Gets or sets whether the address is deleted.</param>
        ...
        /// <param name="matchCode">Gets or sets the match-code of the address</param>
        ...
        /// </summary>
        /// <value>Gets or sets the contact guid.</value>
        ...
        /// </summary>
        /// <value>Gets or sets whether the address is deleted.</value>
        ...
        /// <summary>
        /// Gets or sets the match-code of the address
        /// </summary>
        /// <value>Gets or sets the match-code of the address</value>
    ...
    public class AddressModelJsonConverter : JsonConverter<AddressModel>
    {
        ...
        public override AddressModel Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (isDeleted.IsSet && isDeleted.Value == null)
                throw new ArgumentNullException(nameof(isDeleted), "Property is not nullable for class AddressModel.");

            //2return new AddressModel(additional01, additional02, city, companyName, contactId, country, countryIso, district, federalState, firstName, houseNumber, isDeleted, lastName, latitude, longitude, matchCode, street, zipcode);
            return new AddressModel(additional01, additional02, city, companyName, contactId, country, countryIso, district, federalState, firstName, houseNumber, isDeleted, lastName, latitude, longitude, matchCode, street, zipcode);
        }
        ...
        public void WriteProperties(ref Utf8JsonWriter writer, AddressModel addressModel, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (addressModel.IsDeletedOption.IsSet)
                writer.WriteBoolean("isDeleted", addressModel.IsDeletedOption!.Value);
            ...
            if (addressModel.LatitudeOption.IsSet)
                if (addressModel.LatitudeOption.Value != null)
                {
                    writer.WriteNumber("latitude", addressModel.LatitudeOption!.Value);
                    //var __value = addressModel.LatitudeOption.Value;
            ...
            if (addressModel.LongitudeOption.IsSet)
                if (addressModel.LongitudeOption.Value != null)
                {
                    writer.WriteNumber("longitude", addressModel.LongitudeOption!.Value);
                    //var __value = addressModel.LongitudeOption.Value;
