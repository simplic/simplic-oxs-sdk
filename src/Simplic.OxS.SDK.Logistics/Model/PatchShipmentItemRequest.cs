...
namespace Simplic.OxS.SDK.Logistics
{
    ...
    /// </summary>
    public partial class PatchShipmentItemRequest : IValidatableObject
    {
        ...
        /// </summary>
        [JsonConstructor]
        public PatchShipmentItemRequest()
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="PatchShipmentItemRequest" />
    /// </summary>
    public class PatchShipmentItemRequestJsonConverter : JsonConverter<PatchShipmentItemRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="PatchShipmentItemRequest" />
        /// </summary>
        ...
        public override PatchShipmentItemRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (article.IsSet && article.Value == null)
                throw new ArgumentNullException(nameof(article), "Property is not nullable for class PatchShipmentItemRequest.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class PatchShipmentItemRequest.");

            if (loadingMeters.IsSet && loadingMeters.Value == null)
                throw new ArgumentNullException(nameof(loadingMeters), "Property is not nullable for class PatchShipmentItemRequest.");

            if (quantity.IsSet && quantity.Value == null)
                throw new ArgumentNullException(nameof(quantity), "Property is not nullable for class PatchShipmentItemRequest.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class PatchShipmentItemRequest.");

            if (weight.IsSet && weight.Value == null)
                throw new ArgumentNullException(nameof(weight), "Property is not nullable for class PatchShipmentItemRequest.");

            //2return new PatchShipmentItemRequest(article, billingLines, id, loadigAidId, loadingMeters, quantity, reference, status, text, weight, weightNotes);
            return new PatchShipmentItemRequest(article, billingLines, id, loadigAidId, loadingMeters, quantity, reference, status, text, weight, weightNotes);
        }

        /// <summary>
        /// Serializes a <see cref="PatchShipmentItemRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="patchShipmentItemRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, PatchShipmentItemRequest patchShipmentItemRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(ref writer, patchShipmentItemRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="PatchShipmentItemRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="patchShipmentItemRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(ref Utf8JsonWriter writer, PatchShipmentItemRequest patchShipmentItemRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (patchShipmentItemRequest.ArticleOption.IsSet && patchShipmentItemRequest.Article == null)
                throw new ArgumentNullException(nameof(patchShipmentItemRequest.Article), "Property is required for class PatchShipmentItemRequest.");

            if (patchShipmentItemRequest.QuantityOption.IsSet && patchShipmentItemRequest.Quantity == null)
                throw new ArgumentNullException(nameof(patchShipmentItemRequest.Quantity), "Property is required for class PatchShipmentItemRequest.");

            if (patchShipmentItemRequest.StatusOption.IsSet && patchShipmentItemRequest.Status == null)
                throw new ArgumentNullException(nameof(patchShipmentItemRequest.Status), "Property is required for class PatchShipmentItemRequest.");

            if (patchShipmentItemRequest.WeightOption.IsSet && patchShipmentItemRequest.Weight == null)
                throw new ArgumentNullException(nameof(patchShipmentItemRequest.Weight), "Property is required for class PatchShipmentItemRequest.");

            if (patchShipmentItemRequest.ArticleOption.IsSet)
            {
                writer.WritePropertyName("article");
                JsonSerializer.Serialize(writer, patchShipmentItemRequest.Article, jsonSerializerOptions);
            }
            if (patchShipmentItemRequest.BillingLinesOption.IsSet)
                if (patchShipmentItemRequest.BillingLinesOption.Value != null)
                {
                    writer.WritePropertyName("billingLines");
                    JsonSerializer.Serialize(writer, patchShipmentItemRequest.BillingLines, jsonSerializerOptions);
                }
                else
                    writer.WriteNull("billingLines");
            if (patchShipmentItemRequest.IdOption.IsSet)
                writer.WriteString("id", patchShipmentItemRequest.IdOption!.Value);

            if (patchShipmentItemRequest.LoadigAidIdOption.IsSet)
                if (patchShipmentItemRequest.LoadigAidIdOption.Value != null)
                {
                    writer.WriteString("loadigAidId", patchShipmentItemRequest.LoadigAidIdOption!.Value);
                    //var __value = patchShipmentItemRequest.LoadigAidIdOption.Value;
                    //writer.WriteString("loadigAidId", __value);
                }
                else
                    writer.WriteNull("loadigAidId");

            if (patchShipmentItemRequest.LoadingMetersOption.IsSet)
                writer.WriteNumber("loadingMeters", patchShipmentItemRequest.LoadingMetersOption!.Value);

            if (patchShipmentItemRequest.QuantityOption.IsSet)
            {
                writer.WritePropertyName("quantity");
                JsonSerializer.Serialize(writer, patchShipmentItemRequest.Quantity, jsonSerializerOptions);
            }
            if (patchShipmentItemRequest.ReferenceOption.IsSet)
                if (patchShipmentItemRequest.ReferenceOption.Value != null)
                {
                    writer.WriteString("reference", patchShipmentItemRequest.Reference);
                    //var __value = patchShipmentItemRequest.ReferenceOption.Value;
                    //writer.WriteString("reference", __value);
                }
                else
                    writer.WriteNull("reference");

            if (patchShipmentItemRequest.StatusOption.IsSet)
            {
                writer.WritePropertyName("status");
                JsonSerializer.Serialize(writer, patchShipmentItemRequest.Status, jsonSerializerOptions);
            }
            if (patchShipmentItemRequest.TextOption.IsSet)
                if (patchShipmentItemRequest.TextOption.Value != null)
                {
                    writer.WriteString("text", patchShipmentItemRequest.Text);
                    //var __value = patchShipmentItemRequest.TextOption.Value;
                    //writer.WriteString("text", __value);
                }
                else
                    writer.WriteNull("text");

            if (patchShipmentItemRequest.WeightOption.IsSet)
            {
                writer.WritePropertyName("weight");
                JsonSerializer.Serialize(writer, patchShipmentItemRequest.Weight, jsonSerializerOptions);
            }
            if (patchShipmentItemRequest.WeightNotesOption.IsSet)
                if (patchShipmentItemRequest.WeightNotesOption.Value != null)
                {
                    writer.WritePropertyName("weightNotes");
                    JsonSerializer.Serialize(writer, patchShipmentItemRequest.WeightNotes, jsonSerializerOptions);
                }
                else
