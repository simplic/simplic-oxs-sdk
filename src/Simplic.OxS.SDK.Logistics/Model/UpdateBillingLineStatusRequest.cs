...
namespace Simplic.OxS.SDK.Logistics
{
    ...
    public partial class UpdateBillingLineStatusRequest : IEquatable<UpdateBillingLineStatusRequest>, IValidatableObject
    {
        ...
        public UpdateBillingLineStatusRequest(string name = default(string), string number = default(string), List<string> roles = default(List<string>), string type = default(string), string hexColor = default(string))
        {
            this.Name = name;
            this.Number = number;
            this.Roles = roles;
