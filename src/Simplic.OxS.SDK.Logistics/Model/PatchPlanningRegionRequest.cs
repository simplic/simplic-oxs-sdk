...
namespace Simplic.OxS.SDK.Logistics
{
    ...
    /// </summary>
    [DataContract(Name = "PatchPlanningRegionRequest")]
    public partial class PatchPlanningRegionRequest : IEquatable<PatchPlanningRegionRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public PatchPlanningRegionRequest(string name = default(string), string hexColor = default(string), List<RegionModel> include = default(List<RegionModel>), List<RegionModel> exclude = default(List<RegionModel>), List<string> functions = default(List<string>))
        {
            this.Name = name;
        ...
        /// <summary>
        /// Gets or sets a list of functions for the region.     Currently planned are:  show_loadings,  show_unloading,  show_transits  
        /// </summary>
        /// <value>Gets or sets a list of functions for the region.     Currently planned are:  show_loadings,  show_unloading,  show_transits  </value>
        ...
        {
            return this.Equals(input as PatchPlanningRegionRequest);
        }

        /// <summary>
        /// Returns true if PatchPlanningRegionRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PatchPlanningRegionRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PatchPlanningRegionRequest input)
        {
            if (input == null)
            {
                return false;
