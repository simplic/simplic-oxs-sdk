...
namespace Simplic.OxS.SDK.Logistics
{
    ...
    /// </summary>
    [DataContract(Name = "CreateTourActionRequest")]
    public partial class CreateTourActionRequest : IEquatable<CreateTourActionRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public CreateTourActionRequest(Guid id = default(Guid), int orderId = default(int), DateTime? dateTime = default(DateTime?), DateTime? actualDateTime = default(DateTime?), DateTime? calculatedDateTime = default(DateTime?), string mirroredTourNumber = default(string), string type = default(string), Guid? entityId = default(Guid?), Guid? resourceId = default(Guid?), Guid? addressId = default(Guid?), List<Guid> mirroredTourTags = default(List<Guid>), Guid? mirroredTourStatusId = default(Guid?), List<LoadingSlotModel> cleaningSlots = default(List<LoadingSlotModel>), List<LoadingSlotModel> usedLoadingSlots = default(List<LoadingSlotModel>))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as CreateTourActionRequest);
        }

        /// <summary>
        /// Returns true if CreateTourActionRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateTourActionRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateTourActionRequest input)
        {
            if (input == null)
            {
                return false;
