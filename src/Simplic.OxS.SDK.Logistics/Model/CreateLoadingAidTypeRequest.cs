...
namespace Simplic.OxS.SDK.Logistics.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateLoadingAidTypeRequest")]
    public partial class CreateLoadingAidTypeRequest : IEquatable<CreateLoadingAidTypeRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public CreateLoadingAidTypeRequest(int number = default(int), string displayName = default(string), double weight = default(double), string shortText = default(string), int width = default(int), int length = default(int), double storagePosition = default(double))
        {
            this.Number = number;
        ...
        {
            return this.Equals(input as CreateLoadingAidTypeRequest);
        }

        /// <summary>
        /// Returns true if CreateLoadingAidTypeRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateLoadingAidTypeRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateLoadingAidTypeRequest input)
        {
            if (input == null)
            {
                return false;
