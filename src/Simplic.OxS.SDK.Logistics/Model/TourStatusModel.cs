...
namespace Simplic.OxS.SDK.Logistics
{
    ...
    public partial class TourStatusModel : IEquatable<TourStatusModel>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as TourStatusModel);
        }

        /// <summary>
        /// Returns true if TourStatusModel instances are equal
        /// </summary>
        /// <param name="input">Instance of TourStatusModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TourStatusModel input)
        {
            if (input == null)
            {
                return false;
