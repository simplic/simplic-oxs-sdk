...
namespace Simplic.OxS.SDK.Logistics
{
    ...
    /// </summary>
    [DataContract(Name = "BillingLineCostCenterAssignmentRequest")]
    public partial class BillingLineCostCenterAssignmentRequest : IEquatable<BillingLineCostCenterAssignmentRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BillingLineCostCenterAssignmentRequest" /> class.
        /// </summary>
        ...
        public BillingLineCostCenterAssignmentRequest(Guid id = default(Guid), Guid? costCenterId = default(Guid?), double? percentage = default(double?), bool remove = default(bool))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BillingLineCostCenterAssignmentRequest {\n");
        ...
        {
            return this.Equals(input as BillingLineCostCenterAssignmentRequest);
        }

        /// <summary>
        /// Returns true if BillingLineCostCenterAssignmentRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of BillingLineCostCenterAssignmentRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BillingLineCostCenterAssignmentRequest input)
        {
            if (input == null)
            {
                return false;
