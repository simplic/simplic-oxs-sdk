...
namespace Simplic.OxS.SDK.Logistics
{
    ...
    /// </summary>
    public partial class ShipmentStatusModel : IValidatableObject
    {
        ...
        //[JsonConstructor]
        public ShipmentStatusModel(Option<string> hexColor = default, Option<Guid> id = default, Option<bool> isDeleted = default, Option<string> name = default, Option<string> number = default, Option<int> orderNr = default, Option<string> resolver = default, Option<List<string>> roles = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShipmentStatusModel {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="ShipmentStatusModel" />
    /// </summary>
    public class ShipmentStatusModelJsonConverter : JsonConverter<ShipmentStatusModel>
    {
        /// <summary>
        /// Deserializes json to <see cref="ShipmentStatusModel" />
        /// </summary>
        ...
        public override ShipmentStatusModel Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class ShipmentStatusModel.");

            if (isDeleted.IsSet && isDeleted.Value == null)
                throw new ArgumentNullException(nameof(isDeleted), "Property is not nullable for class ShipmentStatusModel.");

            if (orderNr.IsSet && orderNr.Value == null)
                throw new ArgumentNullException(nameof(orderNr), "Property is not nullable for class ShipmentStatusModel.");

            //2return new ShipmentStatusModel(hexColor, id, isDeleted, name, number, orderNr, resolver, roles);
            return new ShipmentStatusModel(hexColor, id, isDeleted, name, number, orderNr, resolver, roles);
        }

        /// <summary>
        /// Serializes a <see cref="ShipmentStatusModel" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="shipmentStatusModel"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ShipmentStatusModel shipmentStatusModel, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(ref writer, shipmentStatusModel, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ShipmentStatusModel" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="shipmentStatusModel"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(ref Utf8JsonWriter writer, ShipmentStatusModel shipmentStatusModel, JsonSerializerOptions jsonSerializerOptions)
        {
            if (shipmentStatusModel.HexColorOption.IsSet)
                if (shipmentStatusModel.HexColorOption.Value != null)
                {
                    writer.WriteString("hexColor", shipmentStatusModel.HexColor);
                    //var __value = shipmentStatusModel.HexColorOption.Value;
                    //writer.WriteString("hexColor", __value);
                }
                else
                    writer.WriteNull("hexColor");

            if (shipmentStatusModel.IdOption.IsSet)
                writer.WriteString("id", shipmentStatusModel.IdOption!.Value);

            if (shipmentStatusModel.IsDeletedOption.IsSet)
                writer.WriteBoolean("isDeleted", shipmentStatusModel.IsDeletedOption!.Value);

            if (shipmentStatusModel.NameOption.IsSet)
                if (shipmentStatusModel.NameOption.Value != null)
                {
                    writer.WriteString("name", shipmentStatusModel.Name);
                    //var __value = shipmentStatusModel.NameOption.Value;
                    //writer.WriteString("name", __value);
                }
                else
                    writer.WriteNull("name");

            if (shipmentStatusModel.NumberOption.IsSet)
                if (shipmentStatusModel.NumberOption.Value != null)
                {
                    writer.WriteString("number", shipmentStatusModel.Number);
                    //var __value = shipmentStatusModel.NumberOption.Value;
                    //writer.WriteString("number", __value);
                }
                else
                    writer.WriteNull("number");

            if (shipmentStatusModel.OrderNrOption.IsSet)
                writer.WriteNumber("orderNr", shipmentStatusModel.OrderNrOption!.Value);

            if (shipmentStatusModel.ResolverOption.IsSet)
                if (shipmentStatusModel.ResolverOption.Value != null)
                {
                    writer.WriteString("resolver", shipmentStatusModel.Resolver);
                    //var __value = shipmentStatusModel.ResolverOption.Value;
                    //writer.WriteString("resolver", __value);
                }
                else
                    writer.WriteNull("resolver");

            if (shipmentStatusModel.RolesOption.IsSet)
                if (shipmentStatusModel.RolesOption.Value != null)
                {
                    writer.WritePropertyName("roles");
                    JsonSerializer.Serialize(writer, shipmentStatusModel.Roles, jsonSerializerOptions);
                }
                else
