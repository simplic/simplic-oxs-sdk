...
namespace Simplic.OxS.SDK.Logistics.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BillingLinePricingModel")]
    public partial class BillingLinePricingModel : IEquatable<BillingLinePricingModel>, IValidatableObject
    {
        /// <summary>
        ...
        public BillingLinePricingModel(Guid id = default(Guid), string name = default(string))
        {
            this.Id = id;
            this.Name = name;
        }
        ...
        {
            return this.Equals(input as BillingLinePricingModel);
        }

        /// <summary>
        /// Returns true if BillingLinePricingModel instances are equal
        /// </summary>
        /// <param name="input">Instance of BillingLinePricingModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BillingLinePricingModel input)
        {
            if (input == null)
            {
                return false;
