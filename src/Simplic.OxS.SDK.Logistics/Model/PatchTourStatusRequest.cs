...
namespace Simplic.OxS.SDK.Logistics
{
    ...
    /// </summary>
    public partial class PatchTourStatusRequest : IValidatableObject
    {
        ...
        //[JsonConstructor]
        public PatchTourStatusRequest(Option<string> hexColor = default, Option<string> name = default, Option<string> number = default, Option<int> orderNr = default, Option<string> resolver = default, Option<List<string>> roles = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="PatchTourStatusRequest" />
    /// </summary>
    public class PatchTourStatusRequestJsonConverter : JsonConverter<PatchTourStatusRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="PatchTourStatusRequest" />
        /// </summary>
        ...
        public override PatchTourStatusRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            //2return new PatchTourStatusRequest(hexColor, name, number, orderNr, resolver, roles);
            return new PatchTourStatusRequest(hexColor, name, number, orderNr, resolver, roles);
        }

        /// <summary>
        /// Serializes a <see cref="PatchTourStatusRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="patchTourStatusRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, PatchTourStatusRequest patchTourStatusRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(ref writer, patchTourStatusRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="PatchTourStatusRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="patchTourStatusRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(ref Utf8JsonWriter writer, PatchTourStatusRequest patchTourStatusRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (patchTourStatusRequest.HexColorOption.IsSet)
                if (patchTourStatusRequest.HexColorOption.Value != null)
                {
                    writer.WriteString("hexColor", patchTourStatusRequest.HexColor);
                    //var __value = patchTourStatusRequest.HexColorOption.Value;
                    //writer.WriteString("hexColor", __value);
                }
                else
                    writer.WriteNull("hexColor");

            if (patchTourStatusRequest.NameOption.IsSet)
                if (patchTourStatusRequest.NameOption.Value != null)
                {
                    writer.WriteString("name", patchTourStatusRequest.Name);
                    //var __value = patchTourStatusRequest.NameOption.Value;
                    //writer.WriteString("name", __value);
                }
                else
                    writer.WriteNull("name");

            if (patchTourStatusRequest.NumberOption.IsSet)
                if (patchTourStatusRequest.NumberOption.Value != null)
                {
                    writer.WriteString("number", patchTourStatusRequest.Number);
                    //var __value = patchTourStatusRequest.NumberOption.Value;
                    //writer.WriteString("number", __value);
                }
                else
                    writer.WriteNull("number");

            if (patchTourStatusRequest.OrderNrOption.IsSet)
                if (patchTourStatusRequest.OrderNrOption.Value != null)
                {
                    writer.WriteNumber("orderNr", patchTourStatusRequest.OrderNrOption!.Value);
                    //var __value = patchTourStatusRequest.OrderNrOption.Value;
                    //writer.WriteString("orderNr", __value);
                }
                else
                    writer.WriteNull("orderNr");

            if (patchTourStatusRequest.ResolverOption.IsSet)
                if (patchTourStatusRequest.ResolverOption.Value != null)
                {
                    writer.WriteString("resolver", patchTourStatusRequest.Resolver);
                    //var __value = patchTourStatusRequest.ResolverOption.Value;
                    //writer.WriteString("resolver", __value);
                }
                else
                    writer.WriteNull("resolver");

            if (patchTourStatusRequest.RolesOption.IsSet)
                if (patchTourStatusRequest.RolesOption.Value != null)
                {
                    writer.WritePropertyName("roles");
                    JsonSerializer.Serialize(writer, patchTourStatusRequest.Roles, jsonSerializerOptions);
                }
                else
