...
namespace Simplic.OxS.SDK.Logistics
{
    ...
    /// </summary>
    [DataContract(Name = "PlanningRegionModel")]
    public partial class PlanningRegionModel : IEquatable<PlanningRegionModel>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as PlanningRegionModel);
        }

        /// <summary>
        /// Returns true if PlanningRegionModel instances are equal
        /// </summary>
        /// <param name="input">Instance of PlanningRegionModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PlanningRegionModel input)
        {
            if (input == null)
            {
                return false;
