...
namespace Simplic.OxS.SDK.Logistics
{
    ...
    /// </summary>
    public partial class PatchShipmentRequest : IValidatableObject
    {
        ...
        //[JsonConstructor]
        public PatchShipmentRequest(Option<DateTime> actualDeliveryEnd = default, Option<DateTime> actualDeliveryStart = default, Option<DateTime> actualLoadEnd = default, Option<DateTime> actualLoadStart = default, Option<Dictionary<string, Object>> addon = default, Option<DateTime> calculatedDeliveryEnd = default, Option<DateTime> calculatedDeliveryStart = default, Option<DateTime> calculatedLoadEnd = default, Option<DateTime> calculatedLoadStart = default, Option<Guid> carrierAddressId = default, Option<Guid> carrierPersonalAccountId = default, Option<Guid> constructionSiteId = default, Option<Guid> customerAddressId = default, Option<Guid> customerPersonalAccountId = default, Option<Guid> deliveryAddressId = default, Option<DateTime> deliveryEnd = default, Option<string> deliveryNumber = default, Option<DateTime> deliveryStart = default, Option<LoadingDateTimeType> deliveryTimeType = default, Option<ShipmentTelematicWorkflowModel> deliveryWorkflow = default, Option<List<ShipmentDocumentModel>> documents = default, Option<Guid> freightPayerAddressId = default, Option<Guid> freightPayerPersonalAccountId = default, Option<Guid> invoiceRecipientAddressId = default, Option<Guid> invoiceRecipientPersonalAccountId = default, Option<bool> isDeleted = default, Option<bool> isTemplate = default, Option<List<PatchShipmentItemRequest>> items = default, Option<Guid> loadAddressId = default, Option<DateTime> loadEnd = default, Option<string> loadNumber = default, Option<DateTime> loadStart = default, Option<ShipmentTelematicWorkflowModel> loadWorkflow = default, Option<LoadingDateTimeType> loadingTimeType = default, Option<string> notes = default, Option<DateTime> orderDate = default, Option<DateTime> plannedDeliveryEnd = default, Option<DateTime> plannedDeliveryStart = default, Option<DateTime> plannedLoadEnd = default, Option<DateTime> plannedLoadStart = default, Option<Guid> recipientAddressId = default, Option<string> referenceNumber = default, Option<Guid> senderAddressId = default, Option<string> shipmentNumber = default, Option<Guid> statusId = default, Option<Guid> supplierAddressId = default, Option<Guid> supplierPersonalAccountId = default, Option<List<ShipmentTagModel>> tags = default, Option<string> templateName = default, Option<ShipmentTransportOrderModel> transportOrder = default)
        {
        ...
        [JsonIgnore]
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        //[JsonConverter(typeof(OptionJsonConverter<List<PatchShipmentItemRequest>>))]
        public Option<List<PatchShipmentItemRequest>> ItemsOption { get; private set; }
        ...
        public List<PatchShipmentItemRequest>? Items { get { return this. ItemsOption; } set { this.ItemsOption = new Option<List<PatchShipmentItemRequest>>(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="PatchShipmentRequest" />
    /// </summary>
    public class PatchShipmentRequestJsonConverter : JsonConverter<PatchShipmentRequest>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="PatchShipmentRequest" />
        /// </summary>
        ...
        public override PatchShipmentRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<PatchShipmentItemRequest>> items = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "items":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                items = new Option<List<PatchShipmentItemRequest>>(JsonSerializer.Deserialize<List<PatchShipmentItemRequest>>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "loadAddressId":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
            ...
            if (deliveryTimeType.IsSet && deliveryTimeType.Value == null)
                throw new ArgumentNullException(nameof(deliveryTimeType), "Property is not nullable for class PatchShipmentRequest.");

            if (deliveryWorkflow.IsSet && deliveryWorkflow.Value == null)
                throw new ArgumentNullException(nameof(deliveryWorkflow), "Property is not nullable for class PatchShipmentRequest.");

            if (isDeleted.IsSet && isDeleted.Value == null)
                throw new ArgumentNullException(nameof(isDeleted), "Property is not nullable for class PatchShipmentRequest.");

            if (isTemplate.IsSet && isTemplate.Value == null)
                throw new ArgumentNullException(nameof(isTemplate), "Property is not nullable for class PatchShipmentRequest.");

            if (loadWorkflow.IsSet && loadWorkflow.Value == null)
                throw new ArgumentNullException(nameof(loadWorkflow), "Property is not nullable for class PatchShipmentRequest.");

            if (loadingTimeType.IsSet && loadingTimeType.Value == null)
                throw new ArgumentNullException(nameof(loadingTimeType), "Property is not nullable for class PatchShipmentRequest.");

            if (transportOrder.IsSet && transportOrder.Value == null)
                throw new ArgumentNullException(nameof(transportOrder), "Property is not nullable for class PatchShipmentRequest.");

            //2return new PatchShipmentRequest(actualDeliveryEnd, actualDeliveryStart, actualLoadEnd, actualLoadStart, addon, calculatedDeliveryEnd, calculatedDeliveryStart, calculatedLoadEnd, calculatedLoadStart, carrierAddressId, carrierPersonalAccountId, constructionSiteId, customerAddressId, customerPersonalAccountId, deliveryAddressId, deliveryEnd, deliveryNumber, deliveryStart, deliveryTimeType, deliveryWorkflow, documents, freightPayerAddressId, freightPayerPersonalAccountId, invoiceRecipientAddressId, invoiceRecipientPersonalAccountId, isDeleted, isTemplate, items, loadAddressId, loadEnd, loadNumber, loadStart, loadWorkflow, loadingTimeType, notes, orderDate, plannedDeliveryEnd, plannedDeliveryStart, plannedLoadEnd, plannedLoadStart, recipientAddressId, referenceNumber, senderAddressId, shipmentNumber, statusId, supplierAddressId, supplierPersonalAccountId, tags, templateName, transportOrder);
            return new PatchShipmentRequest(actualDeliveryEnd, actualDeliveryStart, actualLoadEnd, actualLoadStart, addon, calculatedDeliveryEnd, calculatedDeliveryStart, calculatedLoadEnd, calculatedLoadStart, carrierAddressId, carrierPersonalAccountId, constructionSiteId, customerAddressId, customerPersonalAccountId, deliveryAddressId, deliveryEnd, deliveryNumber, deliveryStart, deliveryTimeType, deliveryWorkflow, documents, freightPayerAddressId, freightPayerPersonalAccountId, invoiceRecipientAddressId, invoiceRecipientPersonalAccountId, isDeleted, isTemplate, items, loadAddressId, loadEnd, loadNumber, loadStart, loadWorkflow, loadingTimeType, notes, orderDate, plannedDeliveryEnd, plannedDeliveryStart, plannedLoadEnd, plannedLoadStart, recipientAddressId, referenceNumber, senderAddressId, shipmentNumber, statusId, supplierAddressId, supplierPersonalAccountId, tags, templateName, transportOrder);
        }

        /// <summary>
        /// Serializes a <see cref="PatchShipmentRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="patchShipmentRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, PatchShipmentRequest patchShipmentRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(ref writer, patchShipmentRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="PatchShipmentRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="patchShipmentRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(ref Utf8JsonWriter writer, PatchShipmentRequest patchShipmentRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (patchShipmentRequest.DeliveryWorkflowOption.IsSet && patchShipmentRequest.DeliveryWorkflow == null)
                throw new ArgumentNullException(nameof(patchShipmentRequest.DeliveryWorkflow), "Property is required for class PatchShipmentRequest.");

            if (patchShipmentRequest.LoadWorkflowOption.IsSet && patchShipmentRequest.LoadWorkflow == null)
                throw new ArgumentNullException(nameof(patchShipmentRequest.LoadWorkflow), "Property is required for class PatchShipmentRequest.");

            if (patchShipmentRequest.TransportOrderOption.IsSet && patchShipmentRequest.TransportOrder == null)
                throw new ArgumentNullException(nameof(patchShipmentRequest.TransportOrder), "Property is required for class PatchShipmentRequest.");

            if (patchShipmentRequest.ActualDeliveryEndOption.IsSet)
                if (patchShipmentRequest.ActualDeliveryEndOption.Value != null)
                {
                    writer.WriteString("actualDeliveryEnd", patchShipmentRequest.ActualDeliveryEndOption!.Value.ToString(ActualDeliveryEndFormat));
                    //var __value = patchShipmentRequest.ActualDeliveryEndOption.Value;
                    //writer.WriteString("actualDeliveryEnd", __value);
                }
                else
                    writer.WriteNull("actualDeliveryEnd");

            if (patchShipmentRequest.ActualDeliveryStartOption.IsSet)
                if (patchShipmentRequest.ActualDeliveryStartOption.Value != null)
                {
                    writer.WriteString("actualDeliveryStart", patchShipmentRequest.ActualDeliveryStartOption!.Value.ToString(ActualDeliveryStartFormat));
                    //var __value = patchShipmentRequest.ActualDeliveryStartOption.Value;
                    //writer.WriteString("actualDeliveryStart", __value);
                }
                else
                    writer.WriteNull("actualDeliveryStart");

            if (patchShipmentRequest.ActualLoadEndOption.IsSet)
                if (patchShipmentRequest.ActualLoadEndOption.Value != null)
                {
                    writer.WriteString("actualLoadEnd", patchShipmentRequest.ActualLoadEndOption!.Value.ToString(ActualLoadEndFormat));
                    //var __value = patchShipmentRequest.ActualLoadEndOption.Value;
                    //writer.WriteString("actualLoadEnd", __value);
                }
                else
                    writer.WriteNull("actualLoadEnd");

            if (patchShipmentRequest.ActualLoadStartOption.IsSet)
                if (patchShipmentRequest.ActualLoadStartOption.Value != null)
                {
                    writer.WriteString("actualLoadStart", patchShipmentRequest.ActualLoadStartOption!.Value.ToString(ActualLoadStartFormat));
                    //var __value = patchShipmentRequest.ActualLoadStartOption.Value;
                    //writer.WriteString("actualLoadStart", __value);
                }
                else
                    writer.WriteNull("actualLoadStart");

            if (patchShipmentRequest.AddonOption.IsSet)
                if (patchShipmentRequest.AddonOption.Value != null)
                {
                    writer.WritePropertyName("addon");
                    JsonSerializer.Serialize(writer, patchShipmentRequest.Addon, jsonSerializerOptions);
                }
                else
                    writer.WriteNull("addon");
            if (patchShipmentRequest.CalculatedDeliveryEndOption.IsSet)
                if (patchShipmentRequest.CalculatedDeliveryEndOption.Value != null)
                {
                    writer.WriteString("calculatedDeliveryEnd", patchShipmentRequest.CalculatedDeliveryEndOption!.Value.ToString(CalculatedDeliveryEndFormat));
                    //var __value = patchShipmentRequest.CalculatedDeliveryEndOption.Value;
                    //writer.WriteString("calculatedDeliveryEnd", __value);
                }
                else
                    writer.WriteNull("calculatedDeliveryEnd");

            if (patchShipmentRequest.CalculatedDeliveryStartOption.IsSet)
                if (patchShipmentRequest.CalculatedDeliveryStartOption.Value != null)
                {
                    writer.WriteString("calculatedDeliveryStart", patchShipmentRequest.CalculatedDeliveryStartOption!.Value.ToString(CalculatedDeliveryStartFormat));
                    //var __value = patchShipmentRequest.CalculatedDeliveryStartOption.Value;
                    //writer.WriteString("calculatedDeliveryStart", __value);
                }
                else
                    writer.WriteNull("calculatedDeliveryStart");

            if (patchShipmentRequest.CalculatedLoadEndOption.IsSet)
                if (patchShipmentRequest.CalculatedLoadEndOption.Value != null)
                {
                    writer.WriteString("calculatedLoadEnd", patchShipmentRequest.CalculatedLoadEndOption!.Value.ToString(CalculatedLoadEndFormat));
                    //var __value = patchShipmentRequest.CalculatedLoadEndOption.Value;
                    //writer.WriteString("calculatedLoadEnd", __value);
                }
                else
                    writer.WriteNull("calculatedLoadEnd");

            if (patchShipmentRequest.CalculatedLoadStartOption.IsSet)
                if (patchShipmentRequest.CalculatedLoadStartOption.Value != null)
                {
                    writer.WriteString("calculatedLoadStart", patchShipmentRequest.CalculatedLoadStartOption!.Value.ToString(CalculatedLoadStartFormat));
                    //var __value = patchShipmentRequest.CalculatedLoadStartOption.Value;
                    //writer.WriteString("calculatedLoadStart", __value);
                }
                else
                    writer.WriteNull("calculatedLoadStart");

            if (patchShipmentRequest.CarrierAddressIdOption.IsSet)
                if (patchShipmentRequest.CarrierAddressIdOption.Value != null)
                {
                    writer.WriteString("carrierAddressId", patchShipmentRequest.CarrierAddressIdOption!.Value);
                    //var __value = patchShipmentRequest.CarrierAddressIdOption.Value;
                    //writer.WriteString("carrierAddressId", __value);
                }
                else
                    writer.WriteNull("carrierAddressId");

            if (patchShipmentRequest.CarrierPersonalAccountIdOption.IsSet)
                if (patchShipmentRequest.CarrierPersonalAccountIdOption.Value != null)
                {
                    writer.WriteString("carrierPersonalAccountId", patchShipmentRequest.CarrierPersonalAccountIdOption!.Value);
                    //var __value = patchShipmentRequest.CarrierPersonalAccountIdOption.Value;
                    //writer.WriteString("carrierPersonalAccountId", __value);
                }
                else
                    writer.WriteNull("carrierPersonalAccountId");

            if (patchShipmentRequest.ConstructionSiteIdOption.IsSet)
                if (patchShipmentRequest.ConstructionSiteIdOption.Value != null)
                {
                    writer.WriteString("constructionSiteId", patchShipmentRequest.ConstructionSiteIdOption!.Value);
                    //var __value = patchShipmentRequest.ConstructionSiteIdOption.Value;
                    //writer.WriteString("constructionSiteId", __value);
                }
                else
                    writer.WriteNull("constructionSiteId");

            if (patchShipmentRequest.CustomerAddressIdOption.IsSet)
                if (patchShipmentRequest.CustomerAddressIdOption.Value != null)
                {
                    writer.WriteString("customerAddressId", patchShipmentRequest.CustomerAddressIdOption!.Value);
                    //var __value = patchShipmentRequest.CustomerAddressIdOption.Value;
                    //writer.WriteString("customerAddressId", __value);
                }
                else
                    writer.WriteNull("customerAddressId");

            if (patchShipmentRequest.CustomerPersonalAccountIdOption.IsSet)
                if (patchShipmentRequest.CustomerPersonalAccountIdOption.Value != null)
                {
                    writer.WriteString("customerPersonalAccountId", patchShipmentRequest.CustomerPersonalAccountIdOption!.Value);
                    //var __value = patchShipmentRequest.CustomerPersonalAccountIdOption.Value;
                    //writer.WriteString("customerPersonalAccountId", __value);
                }
                else
                    writer.WriteNull("customerPersonalAccountId");

            if (patchShipmentRequest.DeliveryAddressIdOption.IsSet)
                if (patchShipmentRequest.DeliveryAddressIdOption.Value != null)
                {
                    writer.WriteString("deliveryAddressId", patchShipmentRequest.DeliveryAddressIdOption!.Value);
                    //var __value = patchShipmentRequest.DeliveryAddressIdOption.Value;
                    //writer.WriteString("deliveryAddressId", __value);
                }
                else
                    writer.WriteNull("deliveryAddressId");

            if (patchShipmentRequest.DeliveryEndOption.IsSet)
                if (patchShipmentRequest.DeliveryEndOption.Value != null)
                {
                    writer.WriteString("deliveryEnd", patchShipmentRequest.DeliveryEndOption!.Value.ToString(DeliveryEndFormat));
                    //var __value = patchShipmentRequest.DeliveryEndOption.Value;
                    //writer.WriteString("deliveryEnd", __value);
                }
                else
                    writer.WriteNull("deliveryEnd");

            if (patchShipmentRequest.DeliveryNumberOption.IsSet)
                if (patchShipmentRequest.DeliveryNumberOption.Value != null)
                {
                    writer.WriteString("deliveryNumber", patchShipmentRequest.DeliveryNumber);
                    //var __value = patchShipmentRequest.DeliveryNumberOption.Value;
                    //writer.WriteString("deliveryNumber", __value);
                }
                else
                    writer.WriteNull("deliveryNumber");

            if (patchShipmentRequest.DeliveryStartOption.IsSet)
                if (patchShipmentRequest.DeliveryStartOption.Value != null)
                {
                    writer.WriteString("deliveryStart", patchShipmentRequest.DeliveryStartOption!.Value.ToString(DeliveryStartFormat));
                    //var __value = patchShipmentRequest.DeliveryStartOption.Value;
                    //writer.WriteString("deliveryStart", __value);
                }
                else
                    writer.WriteNull("deliveryStart");

            if (patchShipmentRequest.DeliveryTimeTypeOption.IsSet)
            {
                var deliveryTimeTypeRawValue = LoadingDateTimeTypeValueConverter.ToJsonValue(patchShipmentRequest.DeliveryTimeType!.Value);
                writer.WriteNumber("deliveryTimeType", deliveryTimeTypeRawValue);
            }
            if (patchShipmentRequest.DeliveryWorkflowOption.IsSet)
            {
                writer.WritePropertyName("deliveryWorkflow");
                JsonSerializer.Serialize(writer, patchShipmentRequest.DeliveryWorkflow, jsonSerializerOptions);
            }
            if (patchShipmentRequest.DocumentsOption.IsSet)
                if (patchShipmentRequest.DocumentsOption.Value != null)
                {
                    writer.WritePropertyName("documents");
                    JsonSerializer.Serialize(writer, patchShipmentRequest.Documents, jsonSerializerOptions);
                }
                else
                    writer.WriteNull("documents");
            if (patchShipmentRequest.FreightPayerAddressIdOption.IsSet)
                if (patchShipmentRequest.FreightPayerAddressIdOption.Value != null)
                {
                    writer.WriteString("freightPayerAddressId", patchShipmentRequest.FreightPayerAddressIdOption!.Value);
                    //var __value = patchShipmentRequest.FreightPayerAddressIdOption.Value;
                    //writer.WriteString("freightPayerAddressId", __value);
                }
                else
                    writer.WriteNull("freightPayerAddressId");

            if (patchShipmentRequest.FreightPayerPersonalAccountIdOption.IsSet)
                if (patchShipmentRequest.FreightPayerPersonalAccountIdOption.Value != null)
                {
                    writer.WriteString("freightPayerPersonalAccountId", patchShipmentRequest.FreightPayerPersonalAccountIdOption!.Value);
                    //var __value = patchShipmentRequest.FreightPayerPersonalAccountIdOption.Value;
                    //writer.WriteString("freightPayerPersonalAccountId", __value);
                }
                else
                    writer.WriteNull("freightPayerPersonalAccountId");

            if (patchShipmentRequest.InvoiceRecipientAddressIdOption.IsSet)
                if (patchShipmentRequest.InvoiceRecipientAddressIdOption.Value != null)
                {
                    writer.WriteString("invoiceRecipientAddressId", patchShipmentRequest.InvoiceRecipientAddressIdOption!.Value);
                    //var __value = patchShipmentRequest.InvoiceRecipientAddressIdOption.Value;
                    //writer.WriteString("invoiceRecipientAddressId", __value);
                }
                else
                    writer.WriteNull("invoiceRecipientAddressId");

            if (patchShipmentRequest.InvoiceRecipientPersonalAccountIdOption.IsSet)
                if (patchShipmentRequest.InvoiceRecipientPersonalAccountIdOption.Value != null)
                {
                    writer.WriteString("invoiceRecipientPersonalAccountId", patchShipmentRequest.InvoiceRecipientPersonalAccountIdOption!.Value);
                    //var __value = patchShipmentRequest.InvoiceRecipientPersonalAccountIdOption.Value;
                    //writer.WriteString("invoiceRecipientPersonalAccountId", __value);
                }
                else
                    writer.WriteNull("invoiceRecipientPersonalAccountId");

            if (patchShipmentRequest.IsDeletedOption.IsSet)
                writer.WriteBoolean("isDeleted", patchShipmentRequest.IsDeletedOption!.Value);

            if (patchShipmentRequest.IsTemplateOption.IsSet)
                writer.WriteBoolean("isTemplate", patchShipmentRequest.IsTemplateOption!.Value);

            if (patchShipmentRequest.ItemsOption.IsSet)
                if (patchShipmentRequest.ItemsOption.Value != null)
                {
                    writer.WritePropertyName("items");
                    JsonSerializer.Serialize(writer, patchShipmentRequest.Items, jsonSerializerOptions);
                }
                else
                    writer.WriteNull("items");
            if (patchShipmentRequest.LoadAddressIdOption.IsSet)
                if (patchShipmentRequest.LoadAddressIdOption.Value != null)
                {
                    writer.WriteString("loadAddressId", patchShipmentRequest.LoadAddressIdOption!.Value);
                    //var __value = patchShipmentRequest.LoadAddressIdOption.Value;
                    //writer.WriteString("loadAddressId", __value);
                }
                else
                    writer.WriteNull("loadAddressId");

            if (patchShipmentRequest.LoadEndOption.IsSet)
                if (patchShipmentRequest.LoadEndOption.Value != null)
                {
                    writer.WriteString("loadEnd", patchShipmentRequest.LoadEndOption!.Value.ToString(LoadEndFormat));
                    //var __value = patchShipmentRequest.LoadEndOption.Value;
                    //writer.WriteString("loadEnd", __value);
                }
                else
                    writer.WriteNull("loadEnd");

            if (patchShipmentRequest.LoadNumberOption.IsSet)
                if (patchShipmentRequest.LoadNumberOption.Value != null)
                {
                    writer.WriteString("loadNumber", patchShipmentRequest.LoadNumber);
                    //var __value = patchShipmentRequest.LoadNumberOption.Value;
                    //writer.WriteString("loadNumber", __value);
                }
                else
                    writer.WriteNull("loadNumber");

            if (patchShipmentRequest.LoadStartOption.IsSet)
                if (patchShipmentRequest.LoadStartOption.Value != null)
                {
                    writer.WriteString("loadStart", patchShipmentRequest.LoadStartOption!.Value.ToString(LoadStartFormat));
                    //var __value = patchShipmentRequest.LoadStartOption.Value;
                    //writer.WriteString("loadStart", __value);
                }
                else
                    writer.WriteNull("loadStart");

            if (patchShipmentRequest.LoadWorkflowOption.IsSet)
            {
                writer.WritePropertyName("loadWorkflow");
                JsonSerializer.Serialize(writer, patchShipmentRequest.LoadWorkflow, jsonSerializerOptions);
            }
            if (patchShipmentRequest.LoadingTimeTypeOption.IsSet)
            {
                var loadingTimeTypeRawValue = LoadingDateTimeTypeValueConverter.ToJsonValue(patchShipmentRequest.LoadingTimeType!.Value);
                writer.WriteNumber("loadingTimeType", loadingTimeTypeRawValue);
            }
            if (patchShipmentRequest.NotesOption.IsSet)
                if (patchShipmentRequest.NotesOption.Value != null)
                {
                    writer.WriteString("notes", patchShipmentRequest.Notes);
                    //var __value = patchShipmentRequest.NotesOption.Value;
                    //writer.WriteString("notes", __value);
                }
                else
                    writer.WriteNull("notes");

            if (patchShipmentRequest.OrderDateOption.IsSet)
                if (patchShipmentRequest.OrderDateOption.Value != null)
                {
                    writer.WriteString("orderDate", patchShipmentRequest.OrderDateOption!.Value.ToString(OrderDateFormat));
                    //var __value = patchShipmentRequest.OrderDateOption.Value;
                    //writer.WriteString("orderDate", __value);
                }
                else
                    writer.WriteNull("orderDate");

            if (patchShipmentRequest.PlannedDeliveryEndOption.IsSet)
                if (patchShipmentRequest.PlannedDeliveryEndOption.Value != null)
                {
                    writer.WriteString("plannedDeliveryEnd", patchShipmentRequest.PlannedDeliveryEndOption!.Value.ToString(PlannedDeliveryEndFormat));
                    //var __value = patchShipmentRequest.PlannedDeliveryEndOption.Value;
                    //writer.WriteString("plannedDeliveryEnd", __value);
                }
                else
                    writer.WriteNull("plannedDeliveryEnd");

            if (patchShipmentRequest.PlannedDeliveryStartOption.IsSet)
                if (patchShipmentRequest.PlannedDeliveryStartOption.Value != null)
                {
                    writer.WriteString("plannedDeliveryStart", patchShipmentRequest.PlannedDeliveryStartOption!.Value.ToString(PlannedDeliveryStartFormat));
                    //var __value = patchShipmentRequest.PlannedDeliveryStartOption.Value;
                    //writer.WriteString("plannedDeliveryStart", __value);
                }
                else
                    writer.WriteNull("plannedDeliveryStart");

            if (patchShipmentRequest.PlannedLoadEndOption.IsSet)
                if (patchShipmentRequest.PlannedLoadEndOption.Value != null)
                {
                    writer.WriteString("plannedLoadEnd", patchShipmentRequest.PlannedLoadEndOption!.Value.ToString(PlannedLoadEndFormat));
                    //var __value = patchShipmentRequest.PlannedLoadEndOption.Value;
                    //writer.WriteString("plannedLoadEnd", __value);
                }
                else
                    writer.WriteNull("plannedLoadEnd");

            if (patchShipmentRequest.PlannedLoadStartOption.IsSet)
                if (patchShipmentRequest.PlannedLoadStartOption.Value != null)
                {
                    writer.WriteString("plannedLoadStart", patchShipmentRequest.PlannedLoadStartOption!.Value.ToString(PlannedLoadStartFormat));
                    //var __value = patchShipmentRequest.PlannedLoadStartOption.Value;
                    //writer.WriteString("plannedLoadStart", __value);
                }
                else
                    writer.WriteNull("plannedLoadStart");

            if (patchShipmentRequest.RecipientAddressIdOption.IsSet)
                if (patchShipmentRequest.RecipientAddressIdOption.Value != null)
                {
                    writer.WriteString("recipientAddressId", patchShipmentRequest.RecipientAddressIdOption!.Value);
                    //var __value = patchShipmentRequest.RecipientAddressIdOption.Value;
                    //writer.WriteString("recipientAddressId", __value);
                }
                else
                    writer.WriteNull("recipientAddressId");

            if (patchShipmentRequest.ReferenceNumberOption.IsSet)
                if (patchShipmentRequest.ReferenceNumberOption.Value != null)
                {
                    writer.WriteString("referenceNumber", patchShipmentRequest.ReferenceNumber);
                    //var __value = patchShipmentRequest.ReferenceNumberOption.Value;
                    //writer.WriteString("referenceNumber", __value);
                }
                else
                    writer.WriteNull("referenceNumber");

            if (patchShipmentRequest.SenderAddressIdOption.IsSet)
                if (patchShipmentRequest.SenderAddressIdOption.Value != null)
                {
                    writer.WriteString("senderAddressId", patchShipmentRequest.SenderAddressIdOption!.Value);
                    //var __value = patchShipmentRequest.SenderAddressIdOption.Value;
                    //writer.WriteString("senderAddressId", __value);
                }
                else
                    writer.WriteNull("senderAddressId");

            if (patchShipmentRequest.ShipmentNumberOption.IsSet)
                if (patchShipmentRequest.ShipmentNumberOption.Value != null)
                {
                    writer.WriteString("shipmentNumber", patchShipmentRequest.ShipmentNumber);
                    //var __value = patchShipmentRequest.ShipmentNumberOption.Value;
                    //writer.WriteString("shipmentNumber", __value);
                }
                else
                    writer.WriteNull("shipmentNumber");

            if (patchShipmentRequest.StatusIdOption.IsSet)
                if (patchShipmentRequest.StatusIdOption.Value != null)
                {
                    writer.WriteString("statusId", patchShipmentRequest.StatusIdOption!.Value);
                    //var __value = patchShipmentRequest.StatusIdOption.Value;
                    //writer.WriteString("statusId", __value);
                }
                else
                    writer.WriteNull("statusId");

            if (patchShipmentRequest.SupplierAddressIdOption.IsSet)
                if (patchShipmentRequest.SupplierAddressIdOption.Value != null)
                {
                    writer.WriteString("supplierAddressId", patchShipmentRequest.SupplierAddressIdOption!.Value);
                    //var __value = patchShipmentRequest.SupplierAddressIdOption.Value;
                    //writer.WriteString("supplierAddressId", __value);
                }
                else
                    writer.WriteNull("supplierAddressId");

            if (patchShipmentRequest.SupplierPersonalAccountIdOption.IsSet)
                if (patchShipmentRequest.SupplierPersonalAccountIdOption.Value != null)
                {
                    writer.WriteString("supplierPersonalAccountId", patchShipmentRequest.SupplierPersonalAccountIdOption!.Value);
                    //var __value = patchShipmentRequest.SupplierPersonalAccountIdOption.Value;
                    //writer.WriteString("supplierPersonalAccountId", __value);
                }
                else
                    writer.WriteNull("supplierPersonalAccountId");

            if (patchShipmentRequest.TagsOption.IsSet)
                if (patchShipmentRequest.TagsOption.Value != null)
                {
                    writer.WritePropertyName("tags");
                    JsonSerializer.Serialize(writer, patchShipmentRequest.Tags, jsonSerializerOptions);
                }
                else
                    writer.WriteNull("tags");
            if (patchShipmentRequest.TemplateNameOption.IsSet)
                if (patchShipmentRequest.TemplateNameOption.Value != null)
                {
                    writer.WriteString("templateName", patchShipmentRequest.TemplateName);
                    //var __value = patchShipmentRequest.TemplateNameOption.Value;
                    //writer.WriteString("templateName", __value);
                }
                else
                    writer.WriteNull("templateName");

            if (patchShipmentRequest.TransportOrderOption.IsSet)
            {
                writer.WritePropertyName("transportOrder");
                JsonSerializer.Serialize(writer, patchShipmentRequest.TransportOrder, jsonSerializerOptions);
            }
        }
    }
}
