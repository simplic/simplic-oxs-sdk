...
namespace Simplic.OxS.SDK.Logistics
{
    ...
    /// </summary>
    [DataContract(Name = "BillingLineAddressModel")]
    public partial class BillingLineAddressModel : IEquatable<BillingLineAddressModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BillingLineAddressModel" /> class.
        /// </summary>
        ...
        /// <param name="federalState">Gets or sets the federal state..</param>
        ...
        public BillingLineAddressModel(Guid id = default(Guid), string number = default(string), string name = default(string), string street = default(string), string zipcode = default(string), string district = default(string), string federalState = default(string), string country = default(string), string countryIso = default(string), string city = default(string), double? latitude = default(double?), double? longitude = default(double?))
        {
            this.Id = id;
            this.Number = number;
            this.Name = name;
        ...
        /// <summary>
        /// Gets or sets the federal state.
        /// </summary>
        /// <value>Gets or sets the federal state.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BillingLineAddressModel {\n");
        ...
        {
            return this.Equals(input as BillingLineAddressModel);
        }

        /// <summary>
        /// Returns true if BillingLineAddressModel instances are equal
        /// </summary>
        /// <param name="input">Instance of BillingLineAddressModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BillingLineAddressModel input)
        {
            if (input == null)
            {
                return false;
