...
namespace Simplic.OxS.SDK.Logistics
{
    ...
    /// </summary>
    public partial class PatchTourTagRequest : IValidatableObject
    {
        ...
        //[JsonConstructor]
        public PatchTourTagRequest(Option<List<string>> functions = default, Option<string> groupName = default, Option<string> hexColor = default, Option<string> internalName = default, Option<string> name = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="PatchTourTagRequest" />
    /// </summary>
    public class PatchTourTagRequestJsonConverter : JsonConverter<PatchTourTagRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="PatchTourTagRequest" />
        /// </summary>
        ...
        public override PatchTourTagRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            //2return new PatchTourTagRequest(functions, groupName, hexColor, internalName, name);
            return new PatchTourTagRequest(functions, groupName, hexColor, internalName, name);
        }

        /// <summary>
        /// Serializes a <see cref="PatchTourTagRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="patchTourTagRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, PatchTourTagRequest patchTourTagRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(ref writer, patchTourTagRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="PatchTourTagRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="patchTourTagRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(ref Utf8JsonWriter writer, PatchTourTagRequest patchTourTagRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (patchTourTagRequest.FunctionsOption.IsSet)
                if (patchTourTagRequest.FunctionsOption.Value != null)
                {
                    writer.WritePropertyName("functions");
                    JsonSerializer.Serialize(writer, patchTourTagRequest.Functions, jsonSerializerOptions);
                }
                else
                    writer.WriteNull("functions");
            if (patchTourTagRequest.GroupNameOption.IsSet)
                if (patchTourTagRequest.GroupNameOption.Value != null)
                {
                    writer.WriteString("groupName", patchTourTagRequest.GroupName);
                    //var __value = patchTourTagRequest.GroupNameOption.Value;
                    //writer.WriteString("groupName", __value);
                }
                else
                    writer.WriteNull("groupName");

            if (patchTourTagRequest.HexColorOption.IsSet)
                if (patchTourTagRequest.HexColorOption.Value != null)
                {
                    writer.WriteString("hexColor", patchTourTagRequest.HexColor);
                    //var __value = patchTourTagRequest.HexColorOption.Value;
                    //writer.WriteString("hexColor", __value);
                }
                else
                    writer.WriteNull("hexColor");

            if (patchTourTagRequest.InternalNameOption.IsSet)
                if (patchTourTagRequest.InternalNameOption.Value != null)
                {
                    writer.WriteString("internalName", patchTourTagRequest.InternalName);
                    //var __value = patchTourTagRequest.InternalNameOption.Value;
                    //writer.WriteString("internalName", __value);
                }
                else
                    writer.WriteNull("internalName");

            if (patchTourTagRequest.NameOption.IsSet)
                if (patchTourTagRequest.NameOption.Value != null)
                {
                    writer.WriteString("name", patchTourTagRequest.Name);
                    //var __value = patchTourTagRequest.NameOption.Value;
