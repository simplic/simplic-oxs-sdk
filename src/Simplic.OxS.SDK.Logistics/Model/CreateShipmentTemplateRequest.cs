...
namespace Simplic.OxS.SDK.Logistics
{
    ...
    /// </summary>
    [DataContract(Name = "CreateShipmentTemplateRequest")]
    public partial class CreateShipmentTemplateRequest : IEquatable<CreateShipmentTemplateRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateShipmentTemplateRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateShipmentTemplateRequest {\n");
        ...
        {
            return this.Equals(input as CreateShipmentTemplateRequest);
        }

        /// <summary>
        /// Returns true if CreateShipmentTemplateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateShipmentTemplateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateShipmentTemplateRequest input)
        {
            if (input == null)
            {
                return false;
