...
namespace Simplic.OxS.SDK.Logistics
{
    ...
    /// </summary>
    public partial class TransportOrderStatusModel : IValidatableObject
    {
        ...
        /// </summary>
        [JsonConstructor]
        public TransportOrderStatusModel()
        {
        ...
        //[JsonConstructor]
        public TransportOrderStatusModel(Option<string> hexColor = default, Option<Guid> id = default, Option<bool> isDeleted = default, Option<string> name = default, Option<string> number = default, Option<int> orderNr = default, Option<string> resolver = default, Option<List<string>> roles = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="TransportOrderStatusModel" />
    /// </summary>
    public class TransportOrderStatusModelJsonConverter : JsonConverter<TransportOrderStatusModel>
    {
        /// <summary>
        /// Deserializes json to <see cref="TransportOrderStatusModel" />
        /// </summary>
        ...
        public override TransportOrderStatusModel Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class TransportOrderStatusModel.");

            if (isDeleted.IsSet && isDeleted.Value == null)
                throw new ArgumentNullException(nameof(isDeleted), "Property is not nullable for class TransportOrderStatusModel.");

            if (orderNr.IsSet && orderNr.Value == null)
                throw new ArgumentNullException(nameof(orderNr), "Property is not nullable for class TransportOrderStatusModel.");

            //2return new TransportOrderStatusModel(hexColor, id, isDeleted, name, number, orderNr, resolver, roles);
            return new TransportOrderStatusModel(hexColor, id, isDeleted, name, number, orderNr, resolver, roles);
        }

        /// <summary>
        /// Serializes a <see cref="TransportOrderStatusModel" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="transportOrderStatusModel"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, TransportOrderStatusModel transportOrderStatusModel, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(ref writer, transportOrderStatusModel, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="TransportOrderStatusModel" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="transportOrderStatusModel"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(ref Utf8JsonWriter writer, TransportOrderStatusModel transportOrderStatusModel, JsonSerializerOptions jsonSerializerOptions)
        {
            if (transportOrderStatusModel.HexColorOption.IsSet)
                if (transportOrderStatusModel.HexColorOption.Value != null)
                {
                    writer.WriteString("hexColor", transportOrderStatusModel.HexColor);
                    //var __value = transportOrderStatusModel.HexColorOption.Value;
                    //writer.WriteString("hexColor", __value);
                }
                else
                    writer.WriteNull("hexColor");

            if (transportOrderStatusModel.IdOption.IsSet)
                writer.WriteString("id", transportOrderStatusModel.IdOption!.Value);

            if (transportOrderStatusModel.IsDeletedOption.IsSet)
                writer.WriteBoolean("isDeleted", transportOrderStatusModel.IsDeletedOption!.Value);

            if (transportOrderStatusModel.NameOption.IsSet)
                if (transportOrderStatusModel.NameOption.Value != null)
                {
                    writer.WriteString("name", transportOrderStatusModel.Name);
                    //var __value = transportOrderStatusModel.NameOption.Value;
                    //writer.WriteString("name", __value);
                }
                else
                    writer.WriteNull("name");

            if (transportOrderStatusModel.NumberOption.IsSet)
                if (transportOrderStatusModel.NumberOption.Value != null)
                {
                    writer.WriteString("number", transportOrderStatusModel.Number);
                    //var __value = transportOrderStatusModel.NumberOption.Value;
                    //writer.WriteString("number", __value);
                }
                else
                    writer.WriteNull("number");

            if (transportOrderStatusModel.OrderNrOption.IsSet)
                writer.WriteNumber("orderNr", transportOrderStatusModel.OrderNrOption!.Value);

            if (transportOrderStatusModel.ResolverOption.IsSet)
                if (transportOrderStatusModel.ResolverOption.Value != null)
                {
                    writer.WriteString("resolver", transportOrderStatusModel.Resolver);
                    //var __value = transportOrderStatusModel.ResolverOption.Value;
                    //writer.WriteString("resolver", __value);
                }
                else
                    writer.WriteNull("resolver");

            if (transportOrderStatusModel.RolesOption.IsSet)
                if (transportOrderStatusModel.RolesOption.Value != null)
                {
                    writer.WritePropertyName("roles");
                    JsonSerializer.Serialize(writer, transportOrderStatusModel.Roles, jsonSerializerOptions);
                }
                else
