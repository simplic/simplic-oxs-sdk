...
namespace Simplic.OxS.SDK.Logistics
{
    ...
    /// </summary>
    [DataContract(Name = "ShipmentTemplateModel")]
    public partial class ShipmentTemplateModel : IEquatable<ShipmentTemplateModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShipmentTemplateModel" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShipmentTemplateModel {\n");
        ...
        {
            return this.Equals(input as ShipmentTemplateModel);
        }

        /// <summary>
        /// Returns true if ShipmentTemplateModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ShipmentTemplateModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShipmentTemplateModel input)
        {
            if (input == null)
            {
                return false;
