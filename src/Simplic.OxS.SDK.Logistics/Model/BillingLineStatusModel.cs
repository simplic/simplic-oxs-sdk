...
namespace Simplic.OxS.SDK.Logistics
{
    ...
    /// </summary>
    public partial class BillingLineStatusModel : IValidatableObject
    {
        ...
        //[JsonConstructor]
        public BillingLineStatusModel(Option<string> hexColor = default, Option<Guid> id = default, Option<string> name = default, Option<string> number = default, Option<List<string>> roles = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="BillingLineStatusModel" />
    /// </summary>
    public class BillingLineStatusModelJsonConverter : JsonConverter<BillingLineStatusModel>
    {
        /// <summary>
        /// Deserializes json to <see cref="BillingLineStatusModel" />
        /// </summary>
        ...
        public override BillingLineStatusModel Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class BillingLineStatusModel.");

            //2return new BillingLineStatusModel(hexColor, id, name, number, roles);
            return new BillingLineStatusModel(hexColor, id, name, number, roles);
        }

        /// <summary>
        /// Serializes a <see cref="BillingLineStatusModel" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="billingLineStatusModel"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, BillingLineStatusModel billingLineStatusModel, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(ref writer, billingLineStatusModel, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="BillingLineStatusModel" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="billingLineStatusModel"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(ref Utf8JsonWriter writer, BillingLineStatusModel billingLineStatusModel, JsonSerializerOptions jsonSerializerOptions)
        {
            if (billingLineStatusModel.HexColorOption.IsSet)
                if (billingLineStatusModel.HexColorOption.Value != null)
                {
                    writer.WriteString("hexColor", billingLineStatusModel.HexColor);
                    //var __value = billingLineStatusModel.HexColorOption.Value;
                    //writer.WriteString("hexColor", __value);
                }
                else
                    writer.WriteNull("hexColor");

            if (billingLineStatusModel.IdOption.IsSet)
                writer.WriteString("id", billingLineStatusModel.IdOption!.Value);

            if (billingLineStatusModel.NameOption.IsSet)
                if (billingLineStatusModel.NameOption.Value != null)
                {
                    writer.WriteString("name", billingLineStatusModel.Name);
                    //var __value = billingLineStatusModel.NameOption.Value;
                    //writer.WriteString("name", __value);
                }
                else
                    writer.WriteNull("name");

            if (billingLineStatusModel.NumberOption.IsSet)
                if (billingLineStatusModel.NumberOption.Value != null)
                {
                    writer.WriteString("number", billingLineStatusModel.Number);
                    //var __value = billingLineStatusModel.NumberOption.Value;
                    //writer.WriteString("number", __value);
                }
                else
                    writer.WriteNull("number");

            if (billingLineStatusModel.RolesOption.IsSet)
                if (billingLineStatusModel.RolesOption.Value != null)
                {
                    writer.WritePropertyName("roles");
                    JsonSerializer.Serialize(writer, billingLineStatusModel.Roles, jsonSerializerOptions);
                }
                else
