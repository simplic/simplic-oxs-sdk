...
namespace Simplic.OxS.SDK.Logistics
{
    ...
    public partial class UpdateResourceRequest : IValidatableObject
    {
        ...
        //[JsonConstructor]
        public UpdateResourceRequest(Option<string> displayName = default, Option<bool> isLoadable = default, Option<List<LoadingSlotModel>> loadingSlots = default, Option<ResourceLocationModel> location = default, Option<string> matchCode = default, Option<string> notes = default, Option<string> planningOrderKey = default, Option<string> type = default, Option<DateTime> usableUntil = default)
        {
    ...
    public class UpdateResourceRequestJsonConverter : JsonConverter<UpdateResourceRequest>
    {
        ...
        public override UpdateResourceRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (isLoadable.IsSet && isLoadable.Value == null)
                throw new ArgumentNullException(nameof(isLoadable), "Property is not nullable for class UpdateResourceRequest.");

            if (location.IsSet && location.Value == null)
                throw new ArgumentNullException(nameof(location), "Property is not nullable for class UpdateResourceRequest.");

            //2return new UpdateResourceRequest(displayName, isLoadable, loadingSlots, location, matchCode, notes, planningOrderKey, type, usableUntil);
            return new UpdateResourceRequest(displayName, isLoadable, loadingSlots, location, matchCode, notes, planningOrderKey, type, usableUntil);
        }
        ...
        public override void Write(Utf8JsonWriter writer, UpdateResourceRequest updateResourceRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(ref writer, updateResourceRequest, jsonSerializerOptions);
        ...
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(ref Utf8JsonWriter writer, UpdateResourceRequest updateResourceRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (updateResourceRequest.LocationOption.IsSet && updateResourceRequest.Location == null)
                throw new ArgumentNullException(nameof(updateResourceRequest.Location), "Property is required for class UpdateResourceRequest.");

            if (updateResourceRequest.DisplayNameOption.IsSet)
                if (updateResourceRequest.DisplayNameOption.Value != null)
                {
                    writer.WriteString("displayName", updateResourceRequest.DisplayName);
                    //var __value = updateResourceRequest.DisplayNameOption.Value;
                    //writer.WriteString("displayName", __value);
                }
                else
                    writer.WriteNull("displayName");

            if (updateResourceRequest.IsLoadableOption.IsSet)
                writer.WriteBoolean("isLoadable", updateResourceRequest.IsLoadableOption!.Value);

            if (updateResourceRequest.LoadingSlotsOption.IsSet)
                if (updateResourceRequest.LoadingSlotsOption.Value != null)
                {
                    writer.WritePropertyName("loadingSlots");
                    JsonSerializer.Serialize(writer, updateResourceRequest.LoadingSlots, jsonSerializerOptions);
                }
                else
                    writer.WriteNull("loadingSlots");
            if (updateResourceRequest.LocationOption.IsSet)
            {
                writer.WritePropertyName("location");
                JsonSerializer.Serialize(writer, updateResourceRequest.Location, jsonSerializerOptions);
            }
            if (updateResourceRequest.MatchCodeOption.IsSet)
                if (updateResourceRequest.MatchCodeOption.Value != null)
                {
                    writer.WriteString("matchCode", updateResourceRequest.MatchCode);
                    //var __value = updateResourceRequest.MatchCodeOption.Value;
                    //writer.WriteString("matchCode", __value);
                }
                else
                    writer.WriteNull("matchCode");

            if (updateResourceRequest.NotesOption.IsSet)
                if (updateResourceRequest.NotesOption.Value != null)
                {
                    writer.WriteString("notes", updateResourceRequest.Notes);
                    //var __value = updateResourceRequest.NotesOption.Value;
                    //writer.WriteString("notes", __value);
                }
                else
                    writer.WriteNull("notes");

            if (updateResourceRequest.PlanningOrderKeyOption.IsSet)
                if (updateResourceRequest.PlanningOrderKeyOption.Value != null)
                {
                    writer.WriteString("planningOrderKey", updateResourceRequest.PlanningOrderKey);
                    //var __value = updateResourceRequest.PlanningOrderKeyOption.Value;
                    //writer.WriteString("planningOrderKey", __value);
                }
                else
                    writer.WriteNull("planningOrderKey");

            if (updateResourceRequest.TypeOption.IsSet)
                if (updateResourceRequest.TypeOption.Value != null)
                {
                    writer.WriteString("type", updateResourceRequest.Type);
                    //var __value = updateResourceRequest.TypeOption.Value;
                    //writer.WriteString("type", __value);
                }
                else
                    writer.WriteNull("type");

            if (updateResourceRequest.UsableUntilOption.IsSet)
                if (updateResourceRequest.UsableUntilOption.Value != null)
                {
                    writer.WriteString("usableUntil", updateResourceRequest.UsableUntilOption!.Value.ToString(UsableUntilFormat));
                    //var __value = updateResourceRequest.UsableUntilOption.Value;
