...
namespace Simplic.OxS.SDK.Logistics
{
    ...
    public partial class UpdateResourceRequest : IEquatable<UpdateResourceRequest>, IValidatableObject
    {
        ...
        protected UpdateResourceRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateResourceRequest" /> class.
        /// </summary>
        ...
        public UpdateResourceRequest(string type = default(string), string matchCode = default(string), string displayName = default(string), List<LoadingSlotModel> loadingSlots = default(List<LoadingSlotModel>), ResourceLocationModel location = default(ResourceLocationModel), bool isLoadable = default(bool), string planningOrderKey = default(string), DateTime? usableUntil = default(DateTime?), string notes = default(string))
        {
            ...
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for UpdateResourceRequest and cannot be null");
            }
            this.Type = type;
            // to ensure "matchCode" is required (not null)
            if (matchCode == null)
            {
                throw new ArgumentNullException("matchCode is a required property for UpdateResourceRequest and cannot be null");
            }
