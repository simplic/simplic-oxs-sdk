...
namespace Simplic.OxS.SDK.Logistics
{
    ...
    public partial class UpdateShipmentStatusRequest : IValidatableObject
    {
        ...
        //[JsonConstructor]
        public UpdateShipmentStatusRequest(Option<string> hexColor = default, Option<string> name = default, Option<string> number = default, Option<int> orderNr = default, Option<string> resolver = default, Option<List<string>> roles = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="UpdateShipmentStatusRequest" />
    /// </summary>
    public class UpdateShipmentStatusRequestJsonConverter : JsonConverter<UpdateShipmentStatusRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="UpdateShipmentStatusRequest" />
        /// </summary>
        ...
        public override UpdateShipmentStatusRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (orderNr.IsSet && orderNr.Value == null)
                throw new ArgumentNullException(nameof(orderNr), "Property is not nullable for class UpdateShipmentStatusRequest.");

            //2return new UpdateShipmentStatusRequest(hexColor, name, number, orderNr, resolver, roles);
            return new UpdateShipmentStatusRequest(hexColor, name, number, orderNr, resolver, roles);
        }

        /// <summary>
        /// Serializes a <see cref="UpdateShipmentStatusRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="updateShipmentStatusRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, UpdateShipmentStatusRequest updateShipmentStatusRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(ref writer, updateShipmentStatusRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="UpdateShipmentStatusRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="updateShipmentStatusRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(ref Utf8JsonWriter writer, UpdateShipmentStatusRequest updateShipmentStatusRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (updateShipmentStatusRequest.HexColorOption.IsSet)
                if (updateShipmentStatusRequest.HexColorOption.Value != null)
                {
                    writer.WriteString("hexColor", updateShipmentStatusRequest.HexColor);
                    //var __value = updateShipmentStatusRequest.HexColorOption.Value;
                    //writer.WriteString("hexColor", __value);
                }
                else
                    writer.WriteNull("hexColor");

            if (updateShipmentStatusRequest.NameOption.IsSet)
                if (updateShipmentStatusRequest.NameOption.Value != null)
                {
                    writer.WriteString("name", updateShipmentStatusRequest.Name);
                    //var __value = updateShipmentStatusRequest.NameOption.Value;
                    //writer.WriteString("name", __value);
                }
                else
                    writer.WriteNull("name");

            if (updateShipmentStatusRequest.NumberOption.IsSet)
                if (updateShipmentStatusRequest.NumberOption.Value != null)
                {
                    writer.WriteString("number", updateShipmentStatusRequest.Number);
                    //var __value = updateShipmentStatusRequest.NumberOption.Value;
                    //writer.WriteString("number", __value);
                }
                else
                    writer.WriteNull("number");

            if (updateShipmentStatusRequest.OrderNrOption.IsSet)
                writer.WriteNumber("orderNr", updateShipmentStatusRequest.OrderNrOption!.Value);

            if (updateShipmentStatusRequest.ResolverOption.IsSet)
                if (updateShipmentStatusRequest.ResolverOption.Value != null)
                {
                    writer.WriteString("resolver", updateShipmentStatusRequest.Resolver);
                    //var __value = updateShipmentStatusRequest.ResolverOption.Value;
                    //writer.WriteString("resolver", __value);
                }
                else
                    writer.WriteNull("resolver");

            if (updateShipmentStatusRequest.RolesOption.IsSet)
                if (updateShipmentStatusRequest.RolesOption.Value != null)
                {
                    writer.WritePropertyName("roles");
                    JsonSerializer.Serialize(writer, updateShipmentStatusRequest.Roles, jsonSerializerOptions);
                }
                else
