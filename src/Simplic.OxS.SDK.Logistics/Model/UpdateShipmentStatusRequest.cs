...
namespace Simplic.OxS.SDK.Logistics.Model
{
    ...
    public partial class UpdateShipmentStatusRequest : IEquatable<UpdateShipmentStatusRequest>, IValidatableObject
    {
        ...
        public UpdateShipmentStatusRequest(string name = default(string), string number = default(string), List<string> roles = default(List<string>), string hexColor = default(string), int orderNr = default(int), string resolver = default(string))
        {
            this.Name = name;
            this.Number = number;
            this.Roles = roles;
