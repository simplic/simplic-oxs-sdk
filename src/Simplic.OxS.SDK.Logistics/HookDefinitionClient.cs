...
namespace Simplic.OxS.SDK.Logistics
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class HookDefinitionClient : IHookDefinitionClient
    {
        ...
        /// </summary>
        /// <returns></returns>
        public HookDefinitionClient() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public HookDefinitionClient(string basePath)
        {
        ...
        /// <returns></returns>
        public HookDefinitionClient(Simplic.OxS.SDK.Logistics.Configuration configuration)
        {
        ...
        public HookDefinitionClient(Simplic.OxS.SDK.Logistics.ISynchronousClient client, Simplic.OxS.SDK.Logistics.IAsynchronousClient asyncClient, Simplic.OxS.SDK.Logistics.IReadableConfiguration configuration)
        {
        ...
        {
            Simplic.OxS.SDK.Logistics.ApiResponse<HookDefinitionResponse> localVarResponse = GetWithHttpInfo();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of HookDefinitionResponse</returns>
        public Simplic.OxS.SDK.Logistics.ApiResponse<HookDefinitionResponse> GetWithHttpInfo(int operationIndex = 0)
        {
        ...
        {
            Simplic.OxS.SDK.Logistics.ApiResponse<HookDefinitionResponse> localVarResponse = await GetWithHttpInfoAsync(operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (HookDefinitionResponse)</returns>
        public async System.Threading.Tasks.Task<Simplic.OxS.SDK.Logistics.ApiResponse<HookDefinitionResponse>> GetWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
