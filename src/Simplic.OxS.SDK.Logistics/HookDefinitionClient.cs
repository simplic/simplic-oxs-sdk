...
namespace Simplic.OxS.SDK.Logistics
{
    ...
    public class HookDefinitionClient : IHookDefinitionClient
    {
        ...
        public HookDefinitionClient(string host, string? authorization = null)
        {
            ...
            {
                _internalClient = new __HookDefinitionClient(new Configuration
                {
        ...
        public new HookDefinitionResponse Get(int operationIndex = 0)
        {
            try
            {
        ...
        public new Simplic.OxS.SDK.ApiResponse<HookDefinitionResponse> GetWithHttpInfo(int operationIndex = 0)
        {
            try
            {
        ...
        public new System.Threading.Tasks.Task<HookDefinitionResponse> GetAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            try
            {
        ...
        public new System.Threading.Tasks.Task<Simplic.OxS.SDK.ApiResponse<HookDefinitionResponse>> GetWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            try
            {
    ...
    /// </summary>
    public interface IHookDefinitionClientSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IHookDefinitionClientAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IHookDefinitionClient : IHookDefinitionClientSync, IHookDefinitionClientAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    internal partial class __HookDefinitionClient : IHookDefinitionClient
    {
        private Simplic.OxS.SDK.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="__HookDefinitionClient"/> class.
        /// </summary>
        /// <returns></returns>
        public __HookDefinitionClient() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public __HookDefinitionClient(string basePath)
        {
        ...
        /// <returns></returns>
        public __HookDefinitionClient(Simplic.OxS.SDK.Configuration configuration)
        {
        ...
        public __HookDefinitionClient(Simplic.OxS.SDK.ISynchronousClient client, Simplic.OxS.SDK.IAsynchronousClient asyncClient, Simplic.OxS.SDK.IReadableConfiguration configuration)
        {
