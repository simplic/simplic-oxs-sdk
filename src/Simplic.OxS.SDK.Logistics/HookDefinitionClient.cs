...
//: Implementation
    ...
    public class HookDefinitionClient : IHookDefinitionClient
    {
        ...
        /// <exception cref="Simplic.OxS.SDK.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of HookDefinitionResponse</returns>
        public Simplic.OxS.SDK.ApiResponse<HookDefinitionResponse> GetWithHttpInfo()
        {
            try
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of HookDefinitionResponse</returns>
        public System.Threading.Tasks.Task<HookDefinitionResponse> GetAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            try
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (HookDefinitionResponse)</returns>
        public System.Threading.Tasks.Task<Simplic.OxS.SDK.ApiResponse<HookDefinitionResponse>> GetWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            try
            {
...
// ------------------------^ Custom ^------------------------------
    ...
    /// </summary>
    internal interface __IHookDefinitionClientSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    internal interface __IHookDefinitionClientAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    internal interface __IHookDefinitionClient : __IHookDefinitionClientSync, __IHookDefinitionClientAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    internal /*partial*/ class __HookDefinitionClient : __IHookDefinitionClient
    {
        private Simplic.OxS.SDK.ExceptionFactory _exceptionFactory = (name, response) => null;
