...
namespace Simplic.OxS.SDK.Logistics
{
    ...
    public class TourCalculationClient : ITourCalculationClient
    {
        ...
        public System.Threading.Tasks.Task<CalculateRouteResponse> CalculateRoutesAsync(CalculateRouteRequest? calculateRouteRequest = default(CalculateRouteRequest?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            try
            {
        ...
        public System.Threading.Tasks.Task<Simplic.OxS.SDK.ApiResponse<CalculateRouteResponse>> CalculateRoutesWithHttpInfoAsync(CalculateRouteRequest? calculateRouteRequest = default(CalculateRouteRequest?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            try
            {
