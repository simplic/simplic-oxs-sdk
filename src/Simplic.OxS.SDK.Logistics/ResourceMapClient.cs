...
//: Implementation
    ...
    /// Client to interact with the API endpoints of the logistics service.
    /// </summary>
    public class ResourceMapClient : IResourceMapClient
    {
        private __ResourceMapClient _internalClient;
        private Simplic.OxS.SDK.ExceptionFactory _exceptionFactory = (name, response) => null;

        public ResourceMapClient(string host, string? authorization = null)
        {
            if (authorization != null)
            {
                _internalClient = new __ResourceMapClient(new Configuration
                {
        ...
        public ResourceMapClient(Environment env, string? authorization = null)
            : this(
...
// ------------------------^ Custom ^------------------------------
    ...
    internal interface __IResourceMapClientSync : IApiAccessor
    {
        ...
        /// <returns>List&lt;ResourceMapResponse&gt;</returns>
        List<ResourceMapResponse> GetByLocation(double? longitude = default(double?), double? latitude = default(double?), double? maxDistanceMeter = default(double?), double? minDistanceMeter = default(double?), string? group = default(string?), int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of List&lt;ResourceMapResponse&gt;</returns>
        ApiResponse<List<ResourceMapResponse>> GetByLocationWithHttpInfo(double? longitude = default(double?), double? latitude = default(double?), double? maxDistanceMeter = default(double?), double? minDistanceMeter = default(double?), string? group = default(string?), int operationIndex = 0);
    ...
    internal interface __IResourceMapClientAsync : IApiAccessor
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;ResourceMapResponse&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<ResourceMapResponse>>> GetByLocationWithHttpInfoAsync(double? longitude = default(double?), double? latitude = default(double?), double? maxDistanceMeter = default(double?), double? minDistanceMeter = default(double?), string? group = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    internal /*partial*/ class __ResourceMapClient : __IResourceMapClient
    {
        ...
        /// </summary>
        /// <returns></returns>
        public __ResourceMapClient() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public __ResourceMapClient(string basePath)
        {
        ...
        */
        ...
        /// <returns></returns>
        public __ResourceMapClient(Simplic.OxS.SDK.Configuration configuration)
        {
        ...
        public __ResourceMapClient(Simplic.OxS.SDK.ISynchronousClient client, Simplic.OxS.SDK.IAsynchronousClient asyncClient, Simplic.OxS.SDK.IReadableConfiguration configuration)
        {
        ...
        {
            Simplic.OxS.SDK.ApiResponse<List<ResourceMapResponse>> localVarResponse = GetByLocationWithHttpInfo(longitude, latitude, maxDistanceMeter, minDistanceMeter, group);
        ...
        public Simplic.OxS.SDK.ApiResponse<List<ResourceMapResponse>> GetByLocationWithHttpInfo(double? longitude = default(double?), double? latitude = default(double?), double? maxDistanceMeter = default(double?), double? minDistanceMeter = default(double?), string? group = default(string?), int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "ResourceMapClient.ResourceMapGetByLocationGet";
            ...
            var localVarResponse = this.Client.Get<List<ResourceMapResponse>>("/ResourceMap/get-by-location", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ResourceMapGetByLocationGet", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        {
            Simplic.OxS.SDK.ApiResponse<List<ResourceMapResponse>> localVarResponse = await GetByLocationWithHttpInfoAsync(longitude, latitude, maxDistanceMeter, minDistanceMeter, group, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;ResourceMapResponse&gt;)</returns>
        public async System.Threading.Tasks.Task<Simplic.OxS.SDK.ApiResponse<List<ResourceMapResponse>>> GetByLocationWithHttpInfoAsync(double? longitude = default(double?), double? latitude = default(double?), double? maxDistanceMeter = default(double?), double? minDistanceMeter = default(double?), string? group = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<List<ResourceMapResponse>>("/ResourceMap/get-by-location", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
