...
namespace Simplic.OxS.SDK.Logistics
{
    ...
    /// </summary>
    public class InternalLoadingAidTypeClient : IInternalLoadingAidTypeClient
    {
        private __InternalLoadingAidTypeClient _internalClient;
        private Simplic.OxS.SDK.ExceptionFactory _exceptionFactory = (name, response) => null;

        public InternalLoadingAidTypeClient(string host, string? authorization = null)
        {
            if (authorization != null)
            {
                _internalClient = new __InternalLoadingAidTypeClient(new Configuration
                {
        ...
        public InternalLoadingAidTypeClient(Environment env, string? authorization = null)
            : this(
    ...
    public interface IInternalLoadingAidTypeClientSync : IApiAccessor
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>LoadingAidTypeResponse</returns>
        LoadingAidTypeResponse GetById(Guid? id = default(Guid?), int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of LoadingAidTypeResponse</returns>
        ApiResponse<LoadingAidTypeResponse> GetByIdWithHttpInfo(Guid? id = default(Guid?), int operationIndex = 0);
    ...
    public interface IInternalLoadingAidTypeClientAsync : IApiAccessor
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of LoadingAidTypeResponse</returns>
        System.Threading.Tasks.Task<LoadingAidTypeResponse> GetByIdAsync(Guid? id = default(Guid?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (LoadingAidTypeResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<LoadingAidTypeResponse>> GetByIdWithHttpInfoAsync(Guid? id = default(Guid?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    internal partial class __InternalLoadingAidTypeClient : IInternalLoadingAidTypeClient
    {
        ...
        /// </summary>
        /// <returns></returns>
        public __InternalLoadingAidTypeClient() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public __InternalLoadingAidTypeClient(string basePath)
        {
        ...
        /// <returns></returns>
        public __InternalLoadingAidTypeClient(Simplic.OxS.SDK.Configuration configuration)
        {
        ...
        public __InternalLoadingAidTypeClient(Simplic.OxS.SDK.ISynchronousClient client, Simplic.OxS.SDK.IAsynchronousClient asyncClient, Simplic.OxS.SDK.IReadableConfiguration configuration)
        {
        ...
        public LoadingAidTypeResponse GetById(Guid? id = default(Guid?), int operationIndex = 0)
        {
            Simplic.OxS.SDK.ApiResponse<LoadingAidTypeResponse> localVarResponse = GetByIdWithHttpInfo(id);
        ...
        public Simplic.OxS.SDK.ApiResponse<LoadingAidTypeResponse> GetByIdWithHttpInfo(Guid? id = default(Guid?), int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "InternalLoadingAidTypeClient.InternalInternalLoadingAidTypeGetByIdGet";
            ...
            var localVarResponse = this.Client.Get<LoadingAidTypeResponse>("/internal/InternalLoadingAidType/get-by-id", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("InternalInternalLoadingAidTypeGetByIdGet", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of LoadingAidTypeResponse</returns>
        public async System.Threading.Tasks.Task<LoadingAidTypeResponse> GetByIdAsync(Guid? id = default(Guid?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Simplic.OxS.SDK.ApiResponse<LoadingAidTypeResponse> localVarResponse = await GetByIdWithHttpInfoAsync(id, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (LoadingAidTypeResponse)</returns>
        public async System.Threading.Tasks.Task<Simplic.OxS.SDK.ApiResponse<LoadingAidTypeResponse>> GetByIdWithHttpInfoAsync(Guid? id = default(Guid?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<LoadingAidTypeResponse>("/internal/InternalLoadingAidType/get-by-id", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
