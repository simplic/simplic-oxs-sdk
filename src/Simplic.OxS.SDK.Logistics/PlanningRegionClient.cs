...
namespace Simplic.OxS.SDK.Logistics
{
    ...
    public class PlanningRegionClient : IPlanningRegionClient
    {
        ...
        public System.Threading.Tasks.Task<List<PlanningRegionModel>> GetAllAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            try
            {
        ...
        public System.Threading.Tasks.Task<Simplic.OxS.SDK.ApiResponse<List<PlanningRegionModel>>> GetAllWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            try
            {
        ...
        public System.Threading.Tasks.Task<PlanningRegionModel> GetAsync(Guid id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            try
            {
        ...
        public System.Threading.Tasks.Task<Simplic.OxS.SDK.ApiResponse<PlanningRegionModel>> GetWithHttpInfoAsync(Guid id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            try
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of PlanningRegionModel</returns>
        public System.Threading.Tasks.Task<PlanningRegionModel> PatchAsync(Guid id, PatchPlanningRegionRequest? patchPlanningRegionRequest = default(PatchPlanningRegionRequest?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            try
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of PlanningRegionModel</returns>
        public System.Threading.Tasks.Task<PlanningRegionModel> PostAsync(CreatePlanningRegionRequest? createPlanningRegionRequest = default(CreatePlanningRegionRequest?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            try
            {
