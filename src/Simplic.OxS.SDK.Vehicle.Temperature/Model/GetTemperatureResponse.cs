...
namespace Simplic.OxS.SDK.Vehicle.Temperature
{
    ...
    /// </summary>
    [DataContract(Name = "GetTemperatureResponse")]
    public partial class GetTemperatureResponse : IEquatable<GetTemperatureResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public GetTemperatureResponse(double? temperature = default(double?), DateTime? dateTime = default(DateTime?), Vehicle vehicle = default(Vehicle), Sensor sensor = default(Sensor), Location location = default(Location), string state = default(string))
        {
        ...
        {
            return this.Equals(input as GetTemperatureResponse);
        }

        /// <summary>
        /// Returns true if GetTemperatureResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetTemperatureResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetTemperatureResponse input)
        {
            if (input == null)
            {
                return false;
