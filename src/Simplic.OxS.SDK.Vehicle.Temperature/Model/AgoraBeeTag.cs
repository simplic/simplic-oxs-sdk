...
namespace Simplic.OxS.SDK.Vehicle.Temperature
{
    ...
    public partial class AgoraBeeTag : IEquatable<AgoraBeeTag>, IValidatableObject
    {
        ...
        public AgoraBeeTag(long tagId = default(long), int rfr = default(int), string status = default(string), int statusId = default(int), Object temperature = default(Object))
        {
            this.TagId = tagId;
            this.Rfr = rfr;
            this.Status = status;
