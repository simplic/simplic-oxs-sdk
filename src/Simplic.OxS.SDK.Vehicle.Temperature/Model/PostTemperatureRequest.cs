...
namespace Simplic.OxS.SDK.Vehicle.Temperature
{
    ...
    public partial class PostTemperatureRequest : IEquatable<PostTemperatureRequest>, IValidatableObject
    {
        ...
        public PostTemperatureRequest(int? temperature = default(int?), DateTime? dateTime = default(DateTime?), Guid vehicleId = default(Guid), string sensorId = default(string), int? statusId = default(int?), Location location = default(Location))
        {
