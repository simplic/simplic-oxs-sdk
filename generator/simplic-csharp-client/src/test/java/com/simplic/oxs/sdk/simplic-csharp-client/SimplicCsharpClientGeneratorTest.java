 ...
 * 1) Set a break point in SimplicCsharpClientGenerator.java in the postProcessOperationsWithModels() method.
 * 2) To launch this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
public class SimplicCsharpClientGeneratorTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
              .setGeneratorName("simplic-csharp-client") // use this codegen library
              ...
              .setOutputDir("out/simplic-csharp-client"); // output directory
